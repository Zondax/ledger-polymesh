...
__Z_INLINE parser_error_t _readMethod_balances_deposit_block_reward_reserve_balance(
    parser_context_t* c, pd_balances_deposit_block_reward_reserve_balance_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->value))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_multisig_create_or_approve_proposal_as_identity(
    parser_context_t* c, pd_multisig_create_or_approve_proposal_as_identity_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_multisig_create_or_approve_proposal_as_key(
...
__Z_INLINE parser_error_t _readMethod_multisig_accept_multisig_signer_as_identity(
...
__Z_INLINE parser_error_t _readMethod_multisig_remove_multisig_signers_via_creator(
...
__Z_INLINE parser_error_t _readMethod_multisig_change_all_signers_and_sigs_required(
    parser_context_t* c, pd_multisig_change_all_signers_and_sigs_required_t* m)
{
    CHECK_ERROR(_readVecSignatory(c, &m->signers))
    CHECK_ERROR(_readu64(c, &m->sigs_required))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_contracts_call(
    parser_context_t* c, pd_contracts_call_t* m)
{
    CHECK_ERROR(_readLookupSource(c, &m->dest))
    CHECK_ERROR(_readCompactBalanceOf(c, &m->value))
...
__Z_INLINE parser_error_t _readMethod_committeemembership_set_active_members_limit(
...
__Z_INLINE parser_error_t _readMethod_pips_propose(
    parser_context_t* c, pd_pips_propose_t* m)
{
    CHECK_ERROR(_readProposal(c, &m->proposal))
    CHECK_ERROR(_readBalanceOf(c, &m->deposit))
...
__Z_INLINE parser_error_t _readMethod_pips_vote(
    parser_context_t* c, pd_pips_vote_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_pips_snapshot(
    parser_context_t* c, pd_pips_snapshot_t* m)
{
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_technicalcommittee_set_release_coordinator(
...
__Z_INLINE parser_error_t _readMethod_technicalcommitteemembership_set_active_members_limit(
    parser_context_t* c, pd_technicalcommitteemembership_set_active_members_limit_t* m)
{
    CHECK_ERROR(_readMemberCount(c, &m->limit))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_technicalcommitteemembership_disable_member(
...
__Z_INLINE parser_error_t _readMethod_technicalcommitteemembership_remove_member(
...
__Z_INLINE parser_error_t _readMethod_technicalcommitteemembership_reset_members(
...
__Z_INLINE parser_error_t _readMethod_technicalcommitteemembership_abdicate_membership(
    parser_context_t* c, pd_technicalcommitteemembership_abdicate_membership_t* m)
{
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_upgradecommitteemembership_set_active_members_limit(
    parser_context_t* c, pd_upgradecommitteemembership_set_active_members_limit_t* m)
{
    CHECK_ERROR(_readMemberCount(c, &m->limit))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_upgradecommitteemembership_abdicate_membership(
    parser_context_t* c, pd_upgradecommitteemembership_abdicate_membership_t* m)
{
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_asset_accept_primary_issuance_agent_transfer(
...
__Z_INLINE parser_error_t _readMethod_asset_freeze(
    parser_context_t* c, pd_asset_freeze_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_asset_unfreeze(
    parser_context_t* c, pd_asset_unfreeze_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_asset_issue(
    parser_context_t* c, pd_asset_issue_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_asset_redeem(
    parser_context_t* c, pd_asset_redeem_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
    CHECK_ERROR(_readBalance(c, &m->value))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_dividend_new(
    parser_context_t* c, pd_dividend_new_t* m)
{
    CHECK_ERROR(_readBalance(c, &m->amount))
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_dividend_cancel(
    parser_context_t* c, pd_dividend_cancel_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_dividend_claim(
    parser_context_t* c, pd_dividend_claim_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
    CHECK_ERROR(_readu32(c, &m->dividend_id))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_identity_change_cdd_requirement_for_mk_rotation(
    parser_context_t* c, pd_identity_change_cdd_requirement_for_mk_rotation_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_identity_add_secondary_keys_with_authorization(
    parser_context_t* c, pd_identity_add_secondary_keys_with_authorization_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_bridge_freeze(
    parser_context_t* c, pd_bridge_freeze_t* m)
{
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_bridge_unfreeze(
    parser_context_t* c, pd_bridge_unfreeze_t* m)
{
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_bridge_freeze_txs(
    parser_context_t* c, pd_bridge_freeze_txs_t* m)
{
    CHECK_ERROR(_readVecBridgeTx(c, &m->bridge_txs))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_add_compliance_requirement(
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_remove_compliance_requirement(
    parser_context_t* c, pd_compliancemanager_remove_compliance_requirement_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_replace_asset_compliance(
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_add_default_trusted_claim_issuer(
    parser_context_t* c, pd_compliancemanager_add_default_trusted_claim_issuer_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_remove_default_trusted_claim_issuer(
    parser_context_t* c, pd_compliancemanager_remove_default_trusted_claim_issuer_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_compliancemanager_change_compliance_requirement(
    parser_context_t* c, pd_compliancemanager_change_compliance_requirement_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_voting_add_ballot(
    parser_context_t* c, pd_voting_add_ballot_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
...
__Z_INLINE parser_error_t _readMethod_voting_vote(
    parser_context_t* c, pd_voting_vote_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->ticker))
    CHECK_ERROR(_readBytes(c, &m->ballot_name))
...
__Z_INLINE parser_error_t _readMethod_sto_invest(
    parser_context_t* c, pd_sto_invest_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_sto_stop(
    parser_context_t* c, pd_sto_stop_t* m)
{
    CHECK_ERROR(_readTicker(c, &m->offering_asset))
    CHECK_ERROR(_readu64(c, &m->fundraiser_id))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_cddserviceproviders_set_active_members_limit(
...
__Z_INLINE parser_error_t _readMethod_utility_relay_tx(
    parser_context_t* c, pd_utility_relay_tx_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_corporateaction_set_default_withholding_tax(
    ...
    pd_MethodBasic_t* method)
{
    ...
    case 1025: /* module 4 call 1 */
        CHECK_ERROR(_readMethod_balances_transfer_with_memo(c, &method->balances_transfer_with_memo))
        break;
    case 1026: /* module 4 call 2 */
        CHECK_ERROR(_readMethod_balances_deposit_block_reward_reserve_balance(c, &method->balances_deposit_block_reward_reserve_balance))
        break;
    ...
    case 1029: /* module 4 call 5 */
        CHECK_ERROR(_readMethod_balances_burn_account_balance(c, &method->balances_burn_account_balance))
        break;
    ...
    case 1804: /* module 7 call 12 */
        CHECK_ERROR(_readMethod_staking_add_permissioned_validator(c, &method->staking_add_permissioned_validator))
        break;
    case 1805: /* module 7 call 13 */
        CHECK_ERROR(_readMethod_staking_remove_permissioned_validator(c, &method->staking_remove_permissioned_validator))
        break;
    case 1806: /* module 7 call 14 */
        CHECK_ERROR(_readMethod_staking_validate_cdd_expiry_nominators(c, &method->staking_validate_cdd_expiry_nominators))
        break;
    case 1807: /* module 7 call 15 */
        CHECK_ERROR(_readMethod_staking_set_commission_cap(c, &method->staking_set_commission_cap))
        break;
    case 1808: /* module 7 call 16 */
        CHECK_ERROR(_readMethod_staking_set_min_bond_threshold(c, &method->staking_set_min_bond_threshold))
        break;
    ...
    case 1821: /* module 7 call 29 */
        CHECK_ERROR(_readMethod_staking_payout_stakers_by_system(c, &method->staking_payout_stakers_by_system))
        break;
    case 1822: /* module 7 call 30 */
        CHECK_ERROR(_readMethod_staking_change_slashing_allowed_for(c, &method->staking_change_slashing_allowed_for))
        break;
    ...
    case 3073: /* module 12 call 1 */
        CHECK_ERROR(_readMethod_imonline_set_slashing_params(c, &method->imonline_set_slashing_params))
        break;
    ...
    case 4352: /* module 17 call 0 */
        CHECK_ERROR(_readMethod_multisig_create_multisig(c, &method->multisig_create_multisig))
        break;
    case 4357: /* module 17 call 5 */
        CHECK_ERROR(_readMethod_multisig_approve_as_identity(c, &method->multisig_approve_as_identity))
        break;
    case 4358: /* module 17 call 6 */
        CHECK_ERROR(_readMethod_multisig_approve_as_key(c, &method->multisig_approve_as_key))
        break;
    case 4359: /* module 17 call 7 */
        CHECK_ERROR(_readMethod_multisig_reject_as_identity(c, &method->multisig_reject_as_identity))
        break;
    case 4360: /* module 17 call 8 */
        CHECK_ERROR(_readMethod_multisig_reject_as_key(c, &method->multisig_reject_as_key))
        break;
    case 4361: /* module 17 call 9 */
        CHECK_ERROR(_readMethod_multisig_accept_multisig_signer_as_identity(c, &method->multisig_accept_multisig_signer_as_identity))
        break;
    case 4362: /* module 17 call 10 */
        CHECK_ERROR(_readMethod_multisig_accept_multisig_signer_as_key(c, &method->multisig_accept_multisig_signer_as_key))
        break;
    case 4363: /* module 17 call 11 */
        CHECK_ERROR(_readMethod_multisig_add_multisig_signer(c, &method->multisig_add_multisig_signer))
        break;
    case 4364: /* module 17 call 12 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signer(c, &method->multisig_remove_multisig_signer))
        break;
    case 4365: /* module 17 call 13 */
        CHECK_ERROR(_readMethod_multisig_add_multisig_signers_via_creator(c, &method->multisig_add_multisig_signers_via_creator))
        break;
    case 4366: /* module 17 call 14 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signers_via_creator(c, &method->multisig_remove_multisig_signers_via_creator))
        break;
    case 4367: /* module 17 call 15 */
        CHECK_ERROR(_readMethod_multisig_change_sigs_required(c, &method->multisig_change_sigs_required))
        break;
    case 4368: /* module 17 call 16 */
        CHECK_ERROR(_readMethod_multisig_change_all_signers_and_sigs_required(c, &method->multisig_change_all_signers_and_sigs_required))
        break;
    case 4369: /* module 17 call 17 */
        CHECK_ERROR(_readMethod_multisig_make_multisig_signer(c, &method->multisig_make_multisig_signer))
        break;
    case 4370: /* module 17 call 18 */
        CHECK_ERROR(_readMethod_multisig_make_multisig_primary(c, &method->multisig_make_multisig_primary))
        break;
    case 4864: /* module 19 call 0 */
        CHECK_ERROR(_readMethod_contracts_update_schedule(c, &method->contracts_update_schedule))
        break;
    ...
    case 4867: /* module 19 call 3 */
        CHECK_ERROR(_readMethod_contracts_instantiate(c, &method->contracts_instantiate))
        break;
    case 4868: /* module 19 call 4 */
        CHECK_ERROR(_readMethod_contracts_freeze_instantiation(c, &method->contracts_freeze_instantiation))
        break;
    case 4869: /* module 19 call 5 */
        CHECK_ERROR(_readMethod_contracts_unfreeze_instantiation(c, &method->contracts_unfreeze_instantiation))
        break;
    case 4870: /* module 19 call 6 */
        CHECK_ERROR(_readMethod_contracts_transfer_template_ownership(c, &method->contracts_transfer_template_ownership))
        break;
    case 4871: /* module 19 call 7 */
        CHECK_ERROR(_readMethod_contracts_change_template_fees(c, &method->contracts_change_template_fees))
        break;
    case 4872: /* module 19 call 8 */
        CHECK_ERROR(_readMethod_contracts_change_template_meta_url(c, &method->contracts_change_template_meta_url))
        break;
    case 5120: /* module 20 call 0 */
        CHECK_ERROR(_readMethod_treasury_disbursement(c, &method->treasury_disbursement))
        break;
    case 5121: /* module 20 call 1 */
        CHECK_ERROR(_readMethod_treasury_reimbursement(c, &method->treasury_reimbursement))
        break;
    case 5376: /* module 21 call 0 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_vote_threshold(c, &method->polymeshcommittee_set_vote_threshold))
        break;
    case 5377: /* module 21 call 1 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_release_coordinator(c, &method->polymeshcommittee_set_release_coordinator))
        break;
    case 5378: /* module 21 call 2 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_expires_after(c, &method->polymeshcommittee_set_expires_after))
        break;
    case 5379: /* module 21 call 3 */
        CHECK_ERROR(_readMethod_polymeshcommittee_close(c, &method->polymeshcommittee_close))
        break;
    case 5381: /* module 21 call 5 */
        CHECK_ERROR(_readMethod_polymeshcommittee_vote(c, &method->polymeshcommittee_vote))
        break;
    case 5632: /* module 22 call 0 */
        CHECK_ERROR(_readMethod_committeemembership_set_active_members_limit(c, &method->committeemembership_set_active_members_limit))
        break;
    case 5633: /* module 22 call 1 */
        CHECK_ERROR(_readMethod_committeemembership_disable_member(c, &method->committeemembership_disable_member))
        break;
    case 5634: /* module 22 call 2 */
        CHECK_ERROR(_readMethod_committeemembership_add_member(c, &method->committeemembership_add_member))
        break;
    case 5635: /* module 22 call 3 */
        CHECK_ERROR(_readMethod_committeemembership_remove_member(c, &method->committeemembership_remove_member))
        break;
    case 5636: /* module 22 call 4 */
        CHECK_ERROR(_readMethod_committeemembership_swap_member(c, &method->committeemembership_swap_member))
        break;
    case 5637: /* module 22 call 5 */
        CHECK_ERROR(_readMethod_committeemembership_reset_members(c, &method->committeemembership_reset_members))
        break;
    case 5638: /* module 22 call 6 */
        CHECK_ERROR(_readMethod_committeemembership_abdicate_membership(c, &method->committeemembership_abdicate_membership))
        break;
    case 5888: /* module 23 call 0 */
        CHECK_ERROR(_readMethod_pips_set_prune_historical_pips(c, &method->pips_set_prune_historical_pips))
        break;
    case 5889: /* module 23 call 1 */
        CHECK_ERROR(_readMethod_pips_set_min_proposal_deposit(c, &method->pips_set_min_proposal_deposit))
        break;
    case 5890: /* module 23 call 2 */
        CHECK_ERROR(_readMethod_pips_set_default_enactment_period(c, &method->pips_set_default_enactment_period))
        break;
    case 5891: /* module 23 call 3 */
        CHECK_ERROR(_readMethod_pips_set_pending_pip_expiry(c, &method->pips_set_pending_pip_expiry))
        break;
    case 5892: /* module 23 call 4 */
        CHECK_ERROR(_readMethod_pips_set_max_pip_skip_count(c, &method->pips_set_max_pip_skip_count))
        break;
    case 5893: /* module 23 call 5 */
        CHECK_ERROR(_readMethod_pips_set_active_pip_limit(c, &method->pips_set_active_pip_limit))
        break;
    case 5895: /* module 23 call 7 */
        CHECK_ERROR(_readMethod_pips_vote(c, &method->pips_vote))
        break;
    case 5896: /* module 23 call 8 */
        CHECK_ERROR(_readMethod_pips_approve_committee_proposal(c, &method->pips_approve_committee_proposal))
        break;
    case 5897: /* module 23 call 9 */
        CHECK_ERROR(_readMethod_pips_reject_proposal(c, &method->pips_reject_proposal))
        break;
    case 5898: /* module 23 call 10 */
        CHECK_ERROR(_readMethod_pips_prune_proposal(c, &method->pips_prune_proposal))
        break;
    case 5899: /* module 23 call 11 */
        CHECK_ERROR(_readMethod_pips_reschedule_execution(c, &method->pips_reschedule_execution))
        break;
    case 5900: /* module 23 call 12 */
        CHECK_ERROR(_readMethod_pips_clear_snapshot(c, &method->pips_clear_snapshot))
        break;
    case 5901: /* module 23 call 13 */
        CHECK_ERROR(_readMethod_pips_snapshot(c, &method->pips_snapshot))
        break;
    case 5902: /* module 23 call 14 */
        CHECK_ERROR(_readMethod_pips_enact_snapshot_results(c, &method->pips_enact_snapshot_results))
        break;
    case 5903: /* module 23 call 15 */
        CHECK_ERROR(_readMethod_pips_execute_scheduled_pip(c, &method->pips_execute_scheduled_pip))
        break;
    case 5904: /* module 23 call 16 */
        CHECK_ERROR(_readMethod_pips_expire_scheduled_pip(c, &method->pips_expire_scheduled_pip))
        break;
    case 6144: /* module 24 call 0 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_vote_threshold(c, &method->technicalcommittee_set_vote_threshold))
        break;
    case 6145: /* module 24 call 1 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_release_coordinator(c, &method->technicalcommittee_set_release_coordinator))
        break;
    case 6146: /* module 24 call 2 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_expires_after(c, &method->technicalcommittee_set_expires_after))
        break;
    ...
    case 6400: /* module 25 call 0 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_set_active_members_limit(c, &method->technicalcommitteemembership_set_active_members_limit))
        break;
    case 6401: /* module 25 call 1 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_disable_member(c, &method->technicalcommitteemembership_disable_member))
        break;
    case 6402: /* module 25 call 2 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_add_member(c, &method->technicalcommitteemembership_add_member))
        break;
    case 6403: /* module 25 call 3 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_remove_member(c, &method->technicalcommitteemembership_remove_member))
        break;
    case 6404: /* module 25 call 4 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_swap_member(c, &method->technicalcommitteemembership_swap_member))
        break;
    case 6405: /* module 25 call 5 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_reset_members(c, &method->technicalcommitteemembership_reset_members))
        break;
    case 6406: /* module 25 call 6 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_abdicate_membership(c, &method->technicalcommitteemembership_abdicate_membership))
        break;
    case 6656: /* module 26 call 0 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_vote_threshold(c, &method->upgradecommittee_set_vote_threshold))
        break;
    case 6657: /* module 26 call 1 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_release_coordinator(c, &method->upgradecommittee_set_release_coordinator))
        break;
    case 6658: /* module 26 call 2 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_expires_after(c, &method->upgradecommittee_set_expires_after))
        break;
    case 6659: /* module 26 call 3 */
        CHECK_ERROR(_readMethod_upgradecommittee_close(c, &method->upgradecommittee_close))
        break;
    case 6661: /* module 26 call 5 */
        CHECK_ERROR(_readMethod_upgradecommittee_vote(c, &method->upgradecommittee_vote))
        break;
    case 6912: /* module 27 call 0 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_set_active_members_limit(c, &method->upgradecommitteemembership_set_active_members_limit))
        break;
    case 6913: /* module 27 call 1 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_disable_member(c, &method->upgradecommitteemembership_disable_member))
        break;
    case 6914: /* module 27 call 2 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_add_member(c, &method->upgradecommitteemembership_add_member))
        break;
    case 6915: /* module 27 call 3 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_remove_member(c, &method->upgradecommitteemembership_remove_member))
        break;
    case 6916: /* module 27 call 4 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_swap_member(c, &method->upgradecommitteemembership_swap_member))
        break;
    case 6917: /* module 27 call 5 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_reset_members(c, &method->upgradecommitteemembership_reset_members))
        break;
    case 6918: /* module 27 call 6 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_abdicate_membership(c, &method->upgradecommitteemembership_abdicate_membership))
        break;
    case 7168: /* module 28 call 0 */
        CHECK_ERROR(_readMethod_asset_register_ticker(c, &method->asset_register_ticker))
        break;
    case 7169: /* module 28 call 1 */
        CHECK_ERROR(_readMethod_asset_accept_ticker_transfer(c, &method->asset_accept_ticker_transfer))
        break;
    case 7170: /* module 28 call 2 */
        CHECK_ERROR(_readMethod_asset_accept_primary_issuance_agent_transfer(c, &method->asset_accept_primary_issuance_agent_transfer))
        break;
    case 7171: /* module 28 call 3 */
        CHECK_ERROR(_readMethod_asset_accept_asset_ownership_transfer(c, &method->asset_accept_asset_ownership_transfer))
        break;
    ...
    case 7178: /* module 28 call 10 */
        CHECK_ERROR(_readMethod_asset_make_divisible(c, &method->asset_make_divisible))
        break;
    case 7179: /* module 28 call 11 */
        CHECK_ERROR(_readMethod_asset_add_documents(c, &method->asset_add_documents))
        break;
    case 7180: /* module 28 call 12 */
        CHECK_ERROR(_readMethod_asset_remove_documents(c, &method->asset_remove_documents))
        break;
    case 7181: /* module 28 call 13 */
        CHECK_ERROR(_readMethod_asset_set_funding_round(c, &method->asset_set_funding_round))
        break;
    case 7182: /* module 28 call 14 */
        CHECK_ERROR(_readMethod_asset_update_identifiers(c, &method->asset_update_identifiers))
        break;
    case 7183: /* module 28 call 15 */
        CHECK_ERROR(_readMethod_asset_add_extension(c, &method->asset_add_extension))
        break;
    case 7184: /* module 28 call 16 */
        CHECK_ERROR(_readMethod_asset_archive_extension(c, &method->asset_archive_extension))
        break;
    case 7185: /* module 28 call 17 */
        CHECK_ERROR(_readMethod_asset_unarchive_extension(c, &method->asset_unarchive_extension))
        break;
    case 7186: /* module 28 call 18 */
        CHECK_ERROR(_readMethod_asset_remove_primary_issuance_agent(c, &method->asset_remove_primary_issuance_agent))
        break;
    case 7187: /* module 28 call 19 */
        CHECK_ERROR(_readMethod_asset_remove_smart_extension(c, &method->asset_remove_smart_extension))
        break;
    case 7188: /* module 28 call 20 */
        CHECK_ERROR(_readMethod_asset_claim_classic_ticker(c, &method->asset_claim_classic_ticker))
        break;
    case 7189: /* module 28 call 21 */
        CHECK_ERROR(_readMethod_asset_reserve_classic_ticker(c, &method->asset_reserve_classic_ticker))
        break;
    ...
    case 7427: /* module 29 call 3 */
        CHECK_ERROR(_readMethod_dividend_claim_unclaimed(c, &method->dividend_claim_unclaimed))
        break;
    case 7680: /* module 30 call 0 */
        CHECK_ERROR(_readMethod_identity_register_did(c, &method->identity_register_did))
        break;
    case 7681: /* module 30 call 1 */
        CHECK_ERROR(_readMethod_identity_cdd_register_did(c, &method->identity_cdd_register_did))
        break;
    case 7682: /* module 30 call 2 */
        CHECK_ERROR(_readMethod_identity_mock_cdd_register_did(c, &method->identity_mock_cdd_register_did))
        break;
    case 7683: /* module 30 call 3 */
        CHECK_ERROR(_readMethod_identity_invalidate_cdd_claims(c, &method->identity_invalidate_cdd_claims))
        break;
    case 7684: /* module 30 call 4 */
        CHECK_ERROR(_readMethod_identity_remove_secondary_keys(c, &method->identity_remove_secondary_keys))
        break;
    case 7685: /* module 30 call 5 */
        CHECK_ERROR(_readMethod_identity_accept_primary_key(c, &method->identity_accept_primary_key))
        break;
    case 7686: /* module 30 call 6 */
        CHECK_ERROR(_readMethod_identity_change_cdd_requirement_for_mk_rotation(c, &method->identity_change_cdd_requirement_for_mk_rotation))
        break;
    case 7687: /* module 30 call 7 */
        CHECK_ERROR(_readMethod_identity_join_identity_as_key(c, &method->identity_join_identity_as_key))
        break;
    case 7688: /* module 30 call 8 */
        CHECK_ERROR(_readMethod_identity_join_identity_as_identity(c, &method->identity_join_identity_as_identity))
        break;
    case 7689: /* module 30 call 9 */
        CHECK_ERROR(_readMethod_identity_leave_identity_as_key(c, &method->identity_leave_identity_as_key))
        break;
    case 7690: /* module 30 call 10 */
        CHECK_ERROR(_readMethod_identity_leave_identity_as_identity(c, &method->identity_leave_identity_as_identity))
        break;
    ...
    case 7693: /* module 30 call 13 */
        CHECK_ERROR(_readMethod_identity_revoke_claim(c, &method->identity_revoke_claim))
        break;
    case 7694: /* module 30 call 14 */
        CHECK_ERROR(_readMethod_identity_set_permission_to_signer(c, &method->identity_set_permission_to_signer))
        break;
    case 7695: /* module 30 call 15 */
        CHECK_ERROR(_readMethod_identity_legacy_set_permission_to_signer(c, &method->identity_legacy_set_permission_to_signer))
        break;
    case 7696: /* module 30 call 16 */
        CHECK_ERROR(_readMethod_identity_freeze_secondary_keys(c, &method->identity_freeze_secondary_keys))
        break;
    case 7697: /* module 30 call 17 */
        CHECK_ERROR(_readMethod_identity_unfreeze_secondary_keys(c, &method->identity_unfreeze_secondary_keys))
        break;
    case 7698: /* module 30 call 18 */
        CHECK_ERROR(_readMethod_identity_get_my_did(c, &method->identity_get_my_did))
        break;
    case 7699: /* module 30 call 19 */
        CHECK_ERROR(_readMethod_identity_get_cdd_of(c, &method->identity_get_cdd_of))
        break;
    case 7700: /* module 30 call 20 */
        CHECK_ERROR(_readMethod_identity_add_authorization(c, &method->identity_add_authorization))
        break;
    case 7701: /* module 30 call 21 */
        CHECK_ERROR(_readMethod_identity_remove_authorization(c, &method->identity_remove_authorization))
        break;
    case 7702: /* module 30 call 22 */
        CHECK_ERROR(_readMethod_identity_accept_authorization(c, &method->identity_accept_authorization))
        break;
    case 7703: /* module 30 call 23 */
        CHECK_ERROR(_readMethod_identity_add_secondary_keys_with_authorization(c, &method->identity_add_secondary_keys_with_authorization))
        break;
    case 7704: /* module 30 call 24 */
        CHECK_ERROR(_readMethod_identity_revoke_offchain_authorization(c, &method->identity_revoke_offchain_authorization))
        break;
    case 7705: /* module 30 call 25 */
        CHECK_ERROR(_readMethod_identity_add_investor_uniqueness_claim(c, &method->identity_add_investor_uniqueness_claim))
        break;
    case 7706: /* module 30 call 26 */
        CHECK_ERROR(_readMethod_identity_gc_add_cdd_claim(c, &method->identity_gc_add_cdd_claim))
        break;
    case 7707: /* module 30 call 27 */
        CHECK_ERROR(_readMethod_identity_gc_revoke_cdd_claim(c, &method->identity_gc_revoke_cdd_claim))
        break;
    case 7936: /* module 31 call 0 */
        CHECK_ERROR(_readMethod_bridge_change_controller(c, &method->bridge_change_controller))
        break;
    case 7937: /* module 31 call 1 */
        CHECK_ERROR(_readMethod_bridge_change_admin(c, &method->bridge_change_admin))
        break;
    case 7938: /* module 31 call 2 */
        CHECK_ERROR(_readMethod_bridge_change_timelock(c, &method->bridge_change_timelock))
        break;
    ...
    case 7941: /* module 31 call 5 */
        CHECK_ERROR(_readMethod_bridge_change_bridge_limit(c, &method->bridge_change_bridge_limit))
        break;
    case 7942: /* module 31 call 6 */
        CHECK_ERROR(_readMethod_bridge_change_bridge_exempted(c, &method->bridge_change_bridge_exempted))
        break;
    case 7943: /* module 31 call 7 */
        CHECK_ERROR(_readMethod_bridge_force_handle_bridge_tx(c, &method->bridge_force_handle_bridge_tx))
        break;
    case 7944: /* module 31 call 8 */
        CHECK_ERROR(_readMethod_bridge_batch_propose_bridge_tx(c, &method->bridge_batch_propose_bridge_tx))
        break;
    case 7945: /* module 31 call 9 */
        CHECK_ERROR(_readMethod_bridge_propose_bridge_tx(c, &method->bridge_propose_bridge_tx))
        break;
    case 7946: /* module 31 call 10 */
        CHECK_ERROR(_readMethod_bridge_handle_bridge_tx(c, &method->bridge_handle_bridge_tx))
        break;
    ...
    case 7948: /* module 31 call 12 */
        CHECK_ERROR(_readMethod_bridge_unfreeze_txs(c, &method->bridge_unfreeze_txs))
        break;
    case 7949: /* module 31 call 13 */
        CHECK_ERROR(_readMethod_bridge_handle_scheduled_bridge_tx(c, &method->bridge_handle_scheduled_bridge_tx))
        break;
    case 8192: /* module 32 call 0 */
        CHECK_ERROR(_readMethod_compliancemanager_add_compliance_requirement(c, &method->compliancemanager_add_compliance_requirement))
        break;
    case 8193: /* module 32 call 1 */
        CHECK_ERROR(_readMethod_compliancemanager_remove_compliance_requirement(c, &method->compliancemanager_remove_compliance_requirement))
        break;
    case 8194: /* module 32 call 2 */
        CHECK_ERROR(_readMethod_compliancemanager_replace_asset_compliance(c, &method->compliancemanager_replace_asset_compliance))
        break;
    case 8195: /* module 32 call 3 */
        CHECK_ERROR(_readMethod_compliancemanager_reset_asset_compliance(c, &method->compliancemanager_reset_asset_compliance))
        break;
    case 8196: /* module 32 call 4 */
        CHECK_ERROR(_readMethod_compliancemanager_pause_asset_compliance(c, &method->compliancemanager_pause_asset_compliance))
        break;
    case 8197: /* module 32 call 5 */
        CHECK_ERROR(_readMethod_compliancemanager_resume_asset_compliance(c, &method->compliancemanager_resume_asset_compliance))
        break;
    case 8198: /* module 32 call 6 */
        CHECK_ERROR(_readMethod_compliancemanager_add_default_trusted_claim_issuer(c, &method->compliancemanager_add_default_trusted_claim_issuer))
        break;
    case 8199: /* module 32 call 7 */
        CHECK_ERROR(_readMethod_compliancemanager_remove_default_trusted_claim_issuer(c, &method->compliancemanager_remove_default_trusted_claim_issuer))
        break;
    case 8200: /* module 32 call 8 */
        CHECK_ERROR(_readMethod_compliancemanager_change_compliance_requirement(c, &method->compliancemanager_change_compliance_requirement))
        break;
    ...
    case 8450: /* module 33 call 2 */
        CHECK_ERROR(_readMethod_voting_cancel_ballot(c, &method->voting_cancel_ballot))
        break;
    case 8704: /* module 34 call 0 */
        CHECK_ERROR(_readMethod_stocapped_launch_sto(c, &method->stocapped_launch_sto))
        break;
    case 8705: /* module 34 call 1 */
        CHECK_ERROR(_readMethod_stocapped_buy_tokens(c, &method->stocapped_buy_tokens))
        break;
    case 8706: /* module 34 call 2 */
        CHECK_ERROR(_readMethod_stocapped_pause_sto(c, &method->stocapped_pause_sto))
        break;
    case 8707: /* module 34 call 3 */
        CHECK_ERROR(_readMethod_stocapped_unpause_sto(c, &method->stocapped_unpause_sto))
        break;
    case 8960: /* module 35 call 0 */
        CHECK_ERROR(_readMethod_exemption_modify_exemption_list(c, &method->exemption_modify_exemption_list))
        break;
    case 9216: /* module 36 call 0 */
        CHECK_ERROR(_readMethod_settlement_create_venue(c, &method->settlement_create_venue))
        break;
    case 9217: /* module 36 call 1 */
        CHECK_ERROR(_readMethod_settlement_update_venue(c, &method->settlement_update_venue))
        break;
    case 9218: /* module 36 call 2 */
        CHECK_ERROR(_readMethod_settlement_add_instruction(c, &method->settlement_add_instruction))
        break;
    case 9219: /* module 36 call 3 */
        CHECK_ERROR(_readMethod_settlement_add_and_affirm_instruction(c, &method->settlement_add_and_affirm_instruction))
        break;
    case 9220: /* module 36 call 4 */
        CHECK_ERROR(_readMethod_settlement_affirm_instruction(c, &method->settlement_affirm_instruction))
        break;
    case 9221: /* module 36 call 5 */
        CHECK_ERROR(_readMethod_settlement_withdraw_affirmation(c, &method->settlement_withdraw_affirmation))
        break;
    case 9222: /* module 36 call 6 */
        CHECK_ERROR(_readMethod_settlement_reject_instruction(c, &method->settlement_reject_instruction))
        break;
    case 9223: /* module 36 call 7 */
        CHECK_ERROR(_readMethod_settlement_affirm_with_receipts(c, &method->settlement_affirm_with_receipts))
        break;
    case 9224: /* module 36 call 8 */
        CHECK_ERROR(_readMethod_settlement_claim_receipt(c, &method->settlement_claim_receipt))
        break;
    case 9225: /* module 36 call 9 */
        CHECK_ERROR(_readMethod_settlement_unclaim_receipt(c, &method->settlement_unclaim_receipt))
        break;
    case 9226: /* module 36 call 10 */
        CHECK_ERROR(_readMethod_settlement_set_venue_filtering(c, &method->settlement_set_venue_filtering))
        break;
    case 9227: /* module 36 call 11 */
        CHECK_ERROR(_readMethod_settlement_allow_venues(c, &method->settlement_allow_venues))
        break;
    case 9228: /* module 36 call 12 */
        CHECK_ERROR(_readMethod_settlement_disallow_venues(c, &method->settlement_disallow_venues))
        break;
    case 9229: /* module 36 call 13 */
        CHECK_ERROR(_readMethod_settlement_execute_scheduled_instruction(c, &method->settlement_execute_scheduled_instruction))
        break;
    case 9472: /* module 37 call 0 */
        CHECK_ERROR(_readMethod_sto_create_fundraiser(c, &method->sto_create_fundraiser))
        break;
    case 9473: /* module 37 call 1 */
        CHECK_ERROR(_readMethod_sto_invest(c, &method->sto_invest))
        break;
    case 9474: /* module 37 call 2 */
        CHECK_ERROR(_readMethod_sto_freeze_fundraiser(c, &method->sto_freeze_fundraiser))
        break;
    case 9475: /* module 37 call 3 */
        CHECK_ERROR(_readMethod_sto_unfreeze_fundraiser(c, &method->sto_unfreeze_fundraiser))
        break;
    case 9476: /* module 37 call 4 */
        CHECK_ERROR(_readMethod_sto_modify_fundraiser_window(c, &method->sto_modify_fundraiser_window))
        break;
    case 9477: /* module 37 call 5 */
        CHECK_ERROR(_readMethod_sto_stop(c, &method->sto_stop))
        break;
    case 9728: /* module 38 call 0 */
        CHECK_ERROR(_readMethod_cddserviceproviders_set_active_members_limit(c, &method->cddserviceproviders_set_active_members_limit))
        break;
    case 9729: /* module 38 call 1 */
        CHECK_ERROR(_readMethod_cddserviceproviders_disable_member(c, &method->cddserviceproviders_disable_member))
        break;
    case 9730: /* module 38 call 2 */
        CHECK_ERROR(_readMethod_cddserviceproviders_add_member(c, &method->cddserviceproviders_add_member))
        break;
    case 9731: /* module 38 call 3 */
        CHECK_ERROR(_readMethod_cddserviceproviders_remove_member(c, &method->cddserviceproviders_remove_member))
        break;
    case 9732: /* module 38 call 4 */
        CHECK_ERROR(_readMethod_cddserviceproviders_swap_member(c, &method->cddserviceproviders_swap_member))
        break;
    case 9733: /* module 38 call 5 */
        CHECK_ERROR(_readMethod_cddserviceproviders_reset_members(c, &method->cddserviceproviders_reset_members))
        break;
    case 9734: /* module 38 call 6 */
        CHECK_ERROR(_readMethod_cddserviceproviders_abdicate_membership(c, &method->cddserviceproviders_abdicate_membership))
        break;
    case 10240: /* module 40 call 0 */
        CHECK_ERROR(_readMethod_protocolfee_change_coefficient(c, &method->protocolfee_change_coefficient))
        break;
    case 10241: /* module 40 call 1 */
        CHECK_ERROR(_readMethod_protocolfee_change_base_fee(c, &method->protocolfee_change_base_fee))
        break;
    case 10496: /* module 41 call 0 */
        CHECK_ERROR(_readMethod_utility_batch(c, &method->utility_batch))
        break;
    case 10497: /* module 41 call 1 */
        CHECK_ERROR(_readMethod_utility_batch_atomic(c, &method->utility_batch_atomic))
        break;
    case 10498: /* module 41 call 2 */
        CHECK_ERROR(_readMethod_utility_batch_optimistic(c, &method->utility_batch_optimistic))
        break;
    case 10499: /* module 41 call 3 */
        CHECK_ERROR(_readMethod_utility_relay_tx(c, &method->utility_relay_tx))
        break;
    case 10752: /* module 42 call 0 */
        CHECK_ERROR(_readMethod_portfolio_create_portfolio(c, &method->portfolio_create_portfolio))
        break;
    case 10753: /* module 42 call 1 */
        CHECK_ERROR(_readMethod_portfolio_delete_portfolio(c, &method->portfolio_delete_portfolio))
        break;
    case 10754: /* module 42 call 2 */
        CHECK_ERROR(_readMethod_portfolio_move_portfolio_funds(c, &method->portfolio_move_portfolio_funds))
        break;
    case 10755: /* module 42 call 3 */
        CHECK_ERROR(_readMethod_portfolio_rename_portfolio(c, &method->portfolio_rename_portfolio))
        break;
    case 11008: /* module 43 call 0 */
        CHECK_ERROR(_readMethod_confidential_add_range_proof(c, &method->confidential_add_range_proof))
        break;
    case 11009: /* module 43 call 1 */
        CHECK_ERROR(_readMethod_confidential_add_verify_range_proof(c, &method->confidential_add_verify_range_proof))
        break;
    ...
    case 11776: /* module 46 call 0 */
        CHECK_ERROR(_readMethod_corporateaction_set_max_details_length(c, &method->corporateaction_set_max_details_length))
        break;
    case 11777: /* module 46 call 1 */
        CHECK_ERROR(_readMethod_corporateaction_reset_caa(c, &method->corporateaction_reset_caa))
        break;
    case 11778: /* module 46 call 2 */
        CHECK_ERROR(_readMethod_corporateaction_set_default_targets(c, &method->corporateaction_set_default_targets))
        break;
    case 11779: /* module 46 call 3 */
        CHECK_ERROR(_readMethod_corporateaction_set_default_withholding_tax(c, &method->corporateaction_set_default_withholding_tax))
        break;
    case 11780: /* module 46 call 4 */
        CHECK_ERROR(_readMethod_corporateaction_set_did_withholding_tax(c, &method->corporateaction_set_did_withholding_tax))
        break;
    case 11781: /* module 46 call 5 */
        CHECK_ERROR(_readMethod_corporateaction_initiate_corporate_action(c, &method->corporateaction_initiate_corporate_action))
        break;
    case 11782: /* module 46 call 6 */
        CHECK_ERROR(_readMethod_corporateaction_link_ca_doc(c, &method->corporateaction_link_ca_doc))
        break;
    case 11783: /* module 46 call 7 */
        CHECK_ERROR(_readMethod_corporateaction_remove_ca(c, &method->corporateaction_remove_ca))
        break;
    case 11784: /* module 46 call 8 */
        CHECK_ERROR(_readMethod_corporateaction_change_record_date(c, &method->corporateaction_change_record_date))
        break;
    case 12032: /* module 47 call 0 */
        CHECK_ERROR(_readMethod_corporateballot_attach_ballot(c, &method->corporateballot_attach_ballot))
        break;
    case 12033: /* module 47 call 1 */
        CHECK_ERROR(_readMethod_corporateballot_vote(c, &method->corporateballot_vote))
        break;
    case 12034: /* module 47 call 2 */
        CHECK_ERROR(_readMethod_corporateballot_change_end(c, &method->corporateballot_change_end))
        break;
    case 12035: /* module 47 call 3 */
        CHECK_ERROR(_readMethod_corporateballot_change_meta(c, &method->corporateballot_change_meta))
        break;
    case 12036: /* module 47 call 4 */
        CHECK_ERROR(_readMethod_corporateballot_change_rcv(c, &method->corporateballot_change_rcv))
        break;
    case 12037: /* module 47 call 5 */
        CHECK_ERROR(_readMethod_corporateballot_remove_ballot(c, &method->corporateballot_remove_ballot))
        break;
    case 12288: /* module 48 call 0 */
        CHECK_ERROR(_readMethod_capitaldistribution_distribute(c, &method->capitaldistribution_distribute))
        break;
    case 12289: /* module 48 call 1 */
        CHECK_ERROR(_readMethod_capitaldistribution_claim(c, &method->capitaldistribution_claim))
        break;
    case 12290: /* module 48 call 2 */
        CHECK_ERROR(_readMethod_capitaldistribution_push_benefit(c, &method->capitaldistribution_push_benefit))
        break;
    case 12291: /* module 48 call 3 */
        CHECK_ERROR(_readMethod_capitaldistribution_reclaim(c, &method->capitaldistribution_reclaim))
        break;
    case 12292: /* module 48 call 4 */
        CHECK_ERROR(_readMethod_capitaldistribution_remove_distribution(c, &method->capitaldistribution_remove_distribution))
        break;
    case 12544: /* module 49 call 0 */
        CHECK_ERROR(_readMethod_checkpoint_create_checkpoint(c, &method->checkpoint_create_checkpoint))
        break;
    case 12545: /* module 49 call 1 */
        CHECK_ERROR(_readMethod_checkpoint_set_schedules_max_complexity(c, &method->checkpoint_set_schedules_max_complexity))
        break;
    case 12546: /* module 49 call 2 */
        CHECK_ERROR(_readMethod_checkpoint_create_schedule(c, &method->checkpoint_create_schedule))
        break;
    case 12547: /* module 49 call 3 */
        CHECK_ERROR(_readMethod_checkpoint_remove_schedule(c, &method->checkpoint_remove_schedule))
        break;
    default:
    ...
    pd_Method_t* method)
{
    ...
    case 1024: /* module 4 call 0 */
        ...
        break;
    case 1025: /* module 4 call 1 */
        CHECK_ERROR(_readMethod_balances_transfer_with_memo(c, &method->basic.balances_transfer_with_memo))
        break;
    case 1026: /* module 4 call 2 */
        CHECK_ERROR(_readMethod_balances_deposit_block_reward_reserve_balance(c, &method->basic.balances_deposit_block_reward_reserve_balance))
        break;
    case 1027: /* module 4 call 3 */
    ...
    case 1028: /* module 4 call 4 */
        ...
        break;
    case 1029: /* module 4 call 5 */
        CHECK_ERROR(_readMethod_balances_burn_account_balance(c, &method->basic.balances_burn_account_balance))
        break;
    case 1536: /* module 6 call 0 */
    ...
    case 1803: /* module 7 call 11 */
        ...
        break;
    case 1804: /* module 7 call 12 */
        CHECK_ERROR(_readMethod_staking_add_permissioned_validator(c, &method->basic.staking_add_permissioned_validator))
        break;
    case 1805: /* module 7 call 13 */
        CHECK_ERROR(_readMethod_staking_remove_permissioned_validator(c, &method->basic.staking_remove_permissioned_validator))
        break;
    case 1806: /* module 7 call 14 */
        CHECK_ERROR(_readMethod_staking_validate_cdd_expiry_nominators(c, &method->basic.staking_validate_cdd_expiry_nominators))
        break;
    case 1807: /* module 7 call 15 */
        CHECK_ERROR(_readMethod_staking_set_commission_cap(c, &method->basic.staking_set_commission_cap))
        break;
    case 1808: /* module 7 call 16 */
        CHECK_ERROR(_readMethod_staking_set_min_bond_threshold(c, &method->basic.staking_set_min_bond_threshold))
        break;
    case 1809: /* module 7 call 17 */
    ...
    case 1820: /* module 7 call 28 */
        ...
        break;
    case 1821: /* module 7 call 29 */
        CHECK_ERROR(_readMethod_staking_payout_stakers_by_system(c, &method->basic.staking_payout_stakers_by_system))
        break;
    case 1822: /* module 7 call 30 */
        CHECK_ERROR(_readMethod_staking_change_slashing_allowed_for(c, &method->basic.staking_change_slashing_allowed_for))
        break;
    case 2304: /* module 9 call 0 */
    ...
    case 3072: /* module 12 call 0 */
        ...
        break;
    case 3073: /* module 12 call 1 */
        CHECK_ERROR(_readMethod_imonline_set_slashing_params(c, &method->basic.imonline_set_slashing_params))
        break;
    case 4096: /* module 16 call 0 */
    ...
    case 4099: /* module 16 call 3 */
        ...
        break;
    case 4352: /* module 17 call 0 */
        CHECK_ERROR(_readMethod_multisig_create_multisig(c, &method->basic.multisig_create_multisig))
        break;
    case 4353: /* module 17 call 1 */
        CHECK_ERROR(_readMethod_multisig_create_or_approve_proposal_as_identity(c, &method->nested.multisig_create_or_approve_proposal_as_identity))
        break;
    case 4354: /* module 17 call 2 */
        CHECK_ERROR(_readMethod_multisig_create_or_approve_proposal_as_key(c, &method->nested.multisig_create_or_approve_proposal_as_key))
        break;
    case 4355: /* module 17 call 3 */
        CHECK_ERROR(_readMethod_multisig_create_proposal_as_identity(c, &method->nested.multisig_create_proposal_as_identity))
        break;
    case 4356: /* module 17 call 4 */
        CHECK_ERROR(_readMethod_multisig_create_proposal_as_key(c, &method->nested.multisig_create_proposal_as_key))
        break;
    case 4357: /* module 17 call 5 */
        CHECK_ERROR(_readMethod_multisig_approve_as_identity(c, &method->basic.multisig_approve_as_identity))
        break;
    case 4358: /* module 17 call 6 */
        CHECK_ERROR(_readMethod_multisig_approve_as_key(c, &method->basic.multisig_approve_as_key))
        break;
    case 4359: /* module 17 call 7 */
        CHECK_ERROR(_readMethod_multisig_reject_as_identity(c, &method->basic.multisig_reject_as_identity))
        break;
    case 4360: /* module 17 call 8 */
        CHECK_ERROR(_readMethod_multisig_reject_as_key(c, &method->basic.multisig_reject_as_key))
        break;
    case 4361: /* module 17 call 9 */
        CHECK_ERROR(_readMethod_multisig_accept_multisig_signer_as_identity(c, &method->basic.multisig_accept_multisig_signer_as_identity))
        break;
    case 4362: /* module 17 call 10 */
        CHECK_ERROR(_readMethod_multisig_accept_multisig_signer_as_key(c, &method->basic.multisig_accept_multisig_signer_as_key))
        break;
    case 4363: /* module 17 call 11 */
        CHECK_ERROR(_readMethod_multisig_add_multisig_signer(c, &method->basic.multisig_add_multisig_signer))
        break;
    case 4364: /* module 17 call 12 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signer(c, &method->basic.multisig_remove_multisig_signer))
        break;
    case 4365: /* module 17 call 13 */
        CHECK_ERROR(_readMethod_multisig_add_multisig_signers_via_creator(c, &method->basic.multisig_add_multisig_signers_via_creator))
        break;
    case 4366: /* module 17 call 14 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signers_via_creator(c, &method->basic.multisig_remove_multisig_signers_via_creator))
        break;
    case 4367: /* module 17 call 15 */
        CHECK_ERROR(_readMethod_multisig_change_sigs_required(c, &method->basic.multisig_change_sigs_required))
        break;
    case 4368: /* module 17 call 16 */
        CHECK_ERROR(_readMethod_multisig_change_all_signers_and_sigs_required(c, &method->basic.multisig_change_all_signers_and_sigs_required))
        break;
    case 4369: /* module 17 call 17 */
        CHECK_ERROR(_readMethod_multisig_make_multisig_signer(c, &method->basic.multisig_make_multisig_signer))
        break;
    case 4370: /* module 17 call 18 */
        CHECK_ERROR(_readMethod_multisig_make_multisig_primary(c, &method->basic.multisig_make_multisig_primary))
        break;
    case 4864: /* module 19 call 0 */
        CHECK_ERROR(_readMethod_contracts_update_schedule(c, &method->basic.contracts_update_schedule))
        break;
    case 4865: /* module 19 call 1 */
        CHECK_ERROR(_readMethod_contracts_put_code(c, &method->basic.contracts_put_code))
        break;
    case 4866: /* module 19 call 2 */
        CHECK_ERROR(_readMethod_contracts_call(c, &method->basic.contracts_call))
        break;
    case 4867: /* module 19 call 3 */
        CHECK_ERROR(_readMethod_contracts_instantiate(c, &method->basic.contracts_instantiate))
        break;
    case 4868: /* module 19 call 4 */
        CHECK_ERROR(_readMethod_contracts_freeze_instantiation(c, &method->basic.contracts_freeze_instantiation))
        break;
    case 4869: /* module 19 call 5 */
        CHECK_ERROR(_readMethod_contracts_unfreeze_instantiation(c, &method->basic.contracts_unfreeze_instantiation))
        break;
    case 4870: /* module 19 call 6 */
        CHECK_ERROR(_readMethod_contracts_transfer_template_ownership(c, &method->basic.contracts_transfer_template_ownership))
        break;
    case 4871: /* module 19 call 7 */
        CHECK_ERROR(_readMethod_contracts_change_template_fees(c, &method->basic.contracts_change_template_fees))
        break;
    case 4872: /* module 19 call 8 */
        CHECK_ERROR(_readMethod_contracts_change_template_meta_url(c, &method->basic.contracts_change_template_meta_url))
        break;
    case 5120: /* module 20 call 0 */
        CHECK_ERROR(_readMethod_treasury_disbursement(c, &method->basic.treasury_disbursement))
        break;
    case 5121: /* module 20 call 1 */
        CHECK_ERROR(_readMethod_treasury_reimbursement(c, &method->basic.treasury_reimbursement))
        break;
    case 5376: /* module 21 call 0 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_vote_threshold(c, &method->basic.polymeshcommittee_set_vote_threshold))
        break;
    case 5377: /* module 21 call 1 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_release_coordinator(c, &method->basic.polymeshcommittee_set_release_coordinator))
        break;
    case 5378: /* module 21 call 2 */
        CHECK_ERROR(_readMethod_polymeshcommittee_set_expires_after(c, &method->basic.polymeshcommittee_set_expires_after))
        break;
    case 5379: /* module 21 call 3 */
        CHECK_ERROR(_readMethod_polymeshcommittee_close(c, &method->basic.polymeshcommittee_close))
        break;
    case 5380: /* module 21 call 4 */
        CHECK_ERROR(_readMethod_polymeshcommittee_vote_or_propose(c, &method->nested.polymeshcommittee_vote_or_propose))
        break;
    case 5381: /* module 21 call 5 */
        CHECK_ERROR(_readMethod_polymeshcommittee_vote(c, &method->basic.polymeshcommittee_vote))
        break;
    case 5632: /* module 22 call 0 */
        CHECK_ERROR(_readMethod_committeemembership_set_active_members_limit(c, &method->basic.committeemembership_set_active_members_limit))
        break;
    case 5633: /* module 22 call 1 */
        CHECK_ERROR(_readMethod_committeemembership_disable_member(c, &method->basic.committeemembership_disable_member))
        break;
    case 5634: /* module 22 call 2 */
        CHECK_ERROR(_readMethod_committeemembership_add_member(c, &method->basic.committeemembership_add_member))
        break;
    case 5635: /* module 22 call 3 */
        CHECK_ERROR(_readMethod_committeemembership_remove_member(c, &method->basic.committeemembership_remove_member))
        break;
    case 5636: /* module 22 call 4 */
        CHECK_ERROR(_readMethod_committeemembership_swap_member(c, &method->basic.committeemembership_swap_member))
        break;
    case 5637: /* module 22 call 5 */
        CHECK_ERROR(_readMethod_committeemembership_reset_members(c, &method->basic.committeemembership_reset_members))
        break;
    case 5638: /* module 22 call 6 */
        CHECK_ERROR(_readMethod_committeemembership_abdicate_membership(c, &method->basic.committeemembership_abdicate_membership))
        break;
    case 5888: /* module 23 call 0 */
        CHECK_ERROR(_readMethod_pips_set_prune_historical_pips(c, &method->basic.pips_set_prune_historical_pips))
        break;
    case 5889: /* module 23 call 1 */
        CHECK_ERROR(_readMethod_pips_set_min_proposal_deposit(c, &method->basic.pips_set_min_proposal_deposit))
        break;
    case 5890: /* module 23 call 2 */
        CHECK_ERROR(_readMethod_pips_set_default_enactment_period(c, &method->basic.pips_set_default_enactment_period))
        break;
    case 5891: /* module 23 call 3 */
        CHECK_ERROR(_readMethod_pips_set_pending_pip_expiry(c, &method->basic.pips_set_pending_pip_expiry))
        break;
    case 5892: /* module 23 call 4 */
        CHECK_ERROR(_readMethod_pips_set_max_pip_skip_count(c, &method->basic.pips_set_max_pip_skip_count))
        break;
    case 5893: /* module 23 call 5 */
        CHECK_ERROR(_readMethod_pips_set_active_pip_limit(c, &method->basic.pips_set_active_pip_limit))
        break;
    ...
    case 5895: /* module 23 call 7 */
        ...
        break;
    case 5896: /* module 23 call 8 */
        CHECK_ERROR(_readMethod_pips_approve_committee_proposal(c, &method->basic.pips_approve_committee_proposal))
        break;
    case 5897: /* module 23 call 9 */
        CHECK_ERROR(_readMethod_pips_reject_proposal(c, &method->basic.pips_reject_proposal))
        break;
    case 5898: /* module 23 call 10 */
        CHECK_ERROR(_readMethod_pips_prune_proposal(c, &method->basic.pips_prune_proposal))
        break;
    case 5899: /* module 23 call 11 */
        CHECK_ERROR(_readMethod_pips_reschedule_execution(c, &method->basic.pips_reschedule_execution))
        break;
    case 5900: /* module 23 call 12 */
        CHECK_ERROR(_readMethod_pips_clear_snapshot(c, &method->basic.pips_clear_snapshot))
        break;
    case 5901: /* module 23 call 13 */
        CHECK_ERROR(_readMethod_pips_snapshot(c, &method->basic.pips_snapshot))
        break;
    case 5902: /* module 23 call 14 */
        CHECK_ERROR(_readMethod_pips_enact_snapshot_results(c, &method->basic.pips_enact_snapshot_results))
        break;
    case 5903: /* module 23 call 15 */
        CHECK_ERROR(_readMethod_pips_execute_scheduled_pip(c, &method->basic.pips_execute_scheduled_pip))
        break;
    case 5904: /* module 23 call 16 */
        CHECK_ERROR(_readMethod_pips_expire_scheduled_pip(c, &method->basic.pips_expire_scheduled_pip))
        break;
    case 6144: /* module 24 call 0 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_vote_threshold(c, &method->basic.technicalcommittee_set_vote_threshold))
        break;
    case 6145: /* module 24 call 1 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_release_coordinator(c, &method->basic.technicalcommittee_set_release_coordinator))
        break;
    case 6146: /* module 24 call 2 */
        CHECK_ERROR(_readMethod_technicalcommittee_set_expires_after(c, &method->basic.technicalcommittee_set_expires_after))
        break;
    case 6147: /* module 24 call 3 */
        CHECK_ERROR(_readMethod_technicalcommittee_close(c, &method->basic.technicalcommittee_close))
        break;
    case 6148: /* module 24 call 4 */
        CHECK_ERROR(_readMethod_technicalcommittee_vote_or_propose(c, &method->nested.technicalcommittee_vote_or_propose))
        break;
    case 6149: /* module 24 call 5 */
        CHECK_ERROR(_readMethod_technicalcommittee_vote(c, &method->basic.technicalcommittee_vote))
        break;
    case 6400: /* module 25 call 0 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_set_active_members_limit(c, &method->basic.technicalcommitteemembership_set_active_members_limit))
        break;
    case 6401: /* module 25 call 1 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_disable_member(c, &method->basic.technicalcommitteemembership_disable_member))
        break;
    case 6402: /* module 25 call 2 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_add_member(c, &method->basic.technicalcommitteemembership_add_member))
        break;
    case 6403: /* module 25 call 3 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_remove_member(c, &method->basic.technicalcommitteemembership_remove_member))
        break;
    case 6404: /* module 25 call 4 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_swap_member(c, &method->basic.technicalcommitteemembership_swap_member))
        break;
    case 6405: /* module 25 call 5 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_reset_members(c, &method->basic.technicalcommitteemembership_reset_members))
        break;
    case 6406: /* module 25 call 6 */
        CHECK_ERROR(_readMethod_technicalcommitteemembership_abdicate_membership(c, &method->basic.technicalcommitteemembership_abdicate_membership))
        break;
    case 6656: /* module 26 call 0 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_vote_threshold(c, &method->basic.upgradecommittee_set_vote_threshold))
        break;
    case 6657: /* module 26 call 1 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_release_coordinator(c, &method->basic.upgradecommittee_set_release_coordinator))
        break;
    case 6658: /* module 26 call 2 */
        CHECK_ERROR(_readMethod_upgradecommittee_set_expires_after(c, &method->basic.upgradecommittee_set_expires_after))
        break;
    case 6659: /* module 26 call 3 */
        CHECK_ERROR(_readMethod_upgradecommittee_close(c, &method->basic.upgradecommittee_close))
        break;
    case 6660: /* module 26 call 4 */
        CHECK_ERROR(_readMethod_upgradecommittee_vote_or_propose(c, &method->nested.upgradecommittee_vote_or_propose))
        break;
    case 6661: /* module 26 call 5 */
        CHECK_ERROR(_readMethod_upgradecommittee_vote(c, &method->basic.upgradecommittee_vote))
        break;
    case 6912: /* module 27 call 0 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_set_active_members_limit(c, &method->basic.upgradecommitteemembership_set_active_members_limit))
        break;
    case 6913: /* module 27 call 1 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_disable_member(c, &method->basic.upgradecommitteemembership_disable_member))
        break;
    case 6914: /* module 27 call 2 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_add_member(c, &method->basic.upgradecommitteemembership_add_member))
        break;
    case 6915: /* module 27 call 3 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_remove_member(c, &method->basic.upgradecommitteemembership_remove_member))
        break;
    case 6916: /* module 27 call 4 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_swap_member(c, &method->basic.upgradecommitteemembership_swap_member))
        break;
    case 6917: /* module 27 call 5 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_reset_members(c, &method->basic.upgradecommitteemembership_reset_members))
        break;
    case 6918: /* module 27 call 6 */
        CHECK_ERROR(_readMethod_upgradecommitteemembership_abdicate_membership(c, &method->basic.upgradecommitteemembership_abdicate_membership))
        break;
    case 7168: /* module 28 call 0 */
        CHECK_ERROR(_readMethod_asset_register_ticker(c, &method->basic.asset_register_ticker))
        break;
    case 7169: /* module 28 call 1 */
        CHECK_ERROR(_readMethod_asset_accept_ticker_transfer(c, &method->basic.asset_accept_ticker_transfer))
        break;
    case 7170: /* module 28 call 2 */
        CHECK_ERROR(_readMethod_asset_accept_primary_issuance_agent_transfer(c, &method->basic.asset_accept_primary_issuance_agent_transfer))
        break;
    case 7171: /* module 28 call 3 */
        CHECK_ERROR(_readMethod_asset_accept_asset_ownership_transfer(c, &method->basic.asset_accept_asset_ownership_transfer))
        break;
    case 7172: /* module 28 call 4 */
        CHECK_ERROR(_readMethod_asset_create_asset(c, &method->basic.asset_create_asset))
        break;
    case 7173: /* module 28 call 5 */
    ...
    case 7174: /* module 28 call 6 */
        ...
        break;
    case 7175: /* module 28 call 7 */
        CHECK_ERROR(_readMethod_asset_rename_asset(c, &method->basic.asset_rename_asset))
        break;
    case 7176: /* module 28 call 8 */
    ...
    case 7177: /* module 28 call 9 */
        ...
        break;
    case 7178: /* module 28 call 10 */
        CHECK_ERROR(_readMethod_asset_make_divisible(c, &method->basic.asset_make_divisible))
        break;
    case 7179: /* module 28 call 11 */
        CHECK_ERROR(_readMethod_asset_add_documents(c, &method->basic.asset_add_documents))
        break;
    case 7180: /* module 28 call 12 */
        CHECK_ERROR(_readMethod_asset_remove_documents(c, &method->basic.asset_remove_documents))
        break;
    case 7181: /* module 28 call 13 */
        CHECK_ERROR(_readMethod_asset_set_funding_round(c, &method->basic.asset_set_funding_round))
        break;
    case 7182: /* module 28 call 14 */
        CHECK_ERROR(_readMethod_asset_update_identifiers(c, &method->basic.asset_update_identifiers))
        break;
    case 7183: /* module 28 call 15 */
        CHECK_ERROR(_readMethod_asset_add_extension(c, &method->basic.asset_add_extension))
        break;
    case 7184: /* module 28 call 16 */
        CHECK_ERROR(_readMethod_asset_archive_extension(c, &method->basic.asset_archive_extension))
        break;
    case 7185: /* module 28 call 17 */
        CHECK_ERROR(_readMethod_asset_unarchive_extension(c, &method->basic.asset_unarchive_extension))
        break;
    case 7186: /* module 28 call 18 */
        CHECK_ERROR(_readMethod_asset_remove_primary_issuance_agent(c, &method->basic.asset_remove_primary_issuance_agent))
        break;
    case 7187: /* module 28 call 19 */
        CHECK_ERROR(_readMethod_asset_remove_smart_extension(c, &method->basic.asset_remove_smart_extension))
        break;
    case 7188: /* module 28 call 20 */
        CHECK_ERROR(_readMethod_asset_claim_classic_ticker(c, &method->basic.asset_claim_classic_ticker))
        break;
    case 7189: /* module 28 call 21 */
        CHECK_ERROR(_readMethod_asset_reserve_classic_ticker(c, &method->basic.asset_reserve_classic_ticker))
        break;
    case 7424: /* module 29 call 0 */
    ...
    case 7426: /* module 29 call 2 */
        ...
        break;
    case 7427: /* module 29 call 3 */
        CHECK_ERROR(_readMethod_dividend_claim_unclaimed(c, &method->basic.dividend_claim_unclaimed))
        break;
    case 7680: /* module 30 call 0 */
        CHECK_ERROR(_readMethod_identity_register_did(c, &method->basic.identity_register_did))
        break;
    case 7681: /* module 30 call 1 */
        CHECK_ERROR(_readMethod_identity_cdd_register_did(c, &method->basic.identity_cdd_register_did))
        break;
    case 7682: /* module 30 call 2 */
        CHECK_ERROR(_readMethod_identity_mock_cdd_register_did(c, &method->basic.identity_mock_cdd_register_did))
        break;
    case 7683: /* module 30 call 3 */
        CHECK_ERROR(_readMethod_identity_invalidate_cdd_claims(c, &method->basic.identity_invalidate_cdd_claims))
        break;
    case 7684: /* module 30 call 4 */
        CHECK_ERROR(_readMethod_identity_remove_secondary_keys(c, &method->basic.identity_remove_secondary_keys))
        break;
    case 7685: /* module 30 call 5 */
        CHECK_ERROR(_readMethod_identity_accept_primary_key(c, &method->basic.identity_accept_primary_key))
        break;
    case 7686: /* module 30 call 6 */
        CHECK_ERROR(_readMethod_identity_change_cdd_requirement_for_mk_rotation(c, &method->basic.identity_change_cdd_requirement_for_mk_rotation))
        break;
    case 7687: /* module 30 call 7 */
        CHECK_ERROR(_readMethod_identity_join_identity_as_key(c, &method->basic.identity_join_identity_as_key))
        break;
    case 7688: /* module 30 call 8 */
        CHECK_ERROR(_readMethod_identity_join_identity_as_identity(c, &method->basic.identity_join_identity_as_identity))
        break;
    case 7689: /* module 30 call 9 */
        CHECK_ERROR(_readMethod_identity_leave_identity_as_key(c, &method->basic.identity_leave_identity_as_key))
        break;
    case 7690: /* module 30 call 10 */
        CHECK_ERROR(_readMethod_identity_leave_identity_as_identity(c, &method->basic.identity_leave_identity_as_identity))
        break;
    case 7691: /* module 30 call 11 */
        CHECK_ERROR(_readMethod_identity_add_claim(c, &method->basic.identity_add_claim))
        break;
    case 7692: /* module 30 call 12 */
        CHECK_ERROR(_readMethod_identity_forwarded_call(c, &method->nested.identity_forwarded_call))
        break;
    case 7693: /* module 30 call 13 */
        CHECK_ERROR(_readMethod_identity_revoke_claim(c, &method->basic.identity_revoke_claim))
        break;
    case 7694: /* module 30 call 14 */
        CHECK_ERROR(_readMethod_identity_set_permission_to_signer(c, &method->basic.identity_set_permission_to_signer))
        break;
    case 7695: /* module 30 call 15 */
        CHECK_ERROR(_readMethod_identity_legacy_set_permission_to_signer(c, &method->basic.identity_legacy_set_permission_to_signer))
        break;
    case 7696: /* module 30 call 16 */
        CHECK_ERROR(_readMethod_identity_freeze_secondary_keys(c, &method->basic.identity_freeze_secondary_keys))
        break;
    case 7697: /* module 30 call 17 */
        CHECK_ERROR(_readMethod_identity_unfreeze_secondary_keys(c, &method->basic.identity_unfreeze_secondary_keys))
        break;
    case 7698: /* module 30 call 18 */
        CHECK_ERROR(_readMethod_identity_get_my_did(c, &method->basic.identity_get_my_did))
        break;
    case 7699: /* module 30 call 19 */
        CHECK_ERROR(_readMethod_identity_get_cdd_of(c, &method->basic.identity_get_cdd_of))
        break;
    case 7700: /* module 30 call 20 */
        CHECK_ERROR(_readMethod_identity_add_authorization(c, &method->basic.identity_add_authorization))
        break;
    case 7701: /* module 30 call 21 */
        CHECK_ERROR(_readMethod_identity_remove_authorization(c, &method->basic.identity_remove_authorization))
        break;
    case 7702: /* module 30 call 22 */
        CHECK_ERROR(_readMethod_identity_accept_authorization(c, &method->basic.identity_accept_authorization))
        break;
    case 7703: /* module 30 call 23 */
        CHECK_ERROR(_readMethod_identity_add_secondary_keys_with_authorization(c, &method->basic.identity_add_secondary_keys_with_authorization))
        break;
    case 7704: /* module 30 call 24 */
        CHECK_ERROR(_readMethod_identity_revoke_offchain_authorization(c, &method->basic.identity_revoke_offchain_authorization))
        break;
    case 7705: /* module 30 call 25 */
        CHECK_ERROR(_readMethod_identity_add_investor_uniqueness_claim(c, &method->basic.identity_add_investor_uniqueness_claim))
        break;
    case 7706: /* module 30 call 26 */
        CHECK_ERROR(_readMethod_identity_gc_add_cdd_claim(c, &method->basic.identity_gc_add_cdd_claim))
        break;
    case 7707: /* module 30 call 27 */
        CHECK_ERROR(_readMethod_identity_gc_revoke_cdd_claim(c, &method->basic.identity_gc_revoke_cdd_claim))
        break;
    case 7936: /* module 31 call 0 */
        CHECK_ERROR(_readMethod_bridge_change_controller(c, &method->basic.bridge_change_controller))
        break;
    case 7937: /* module 31 call 1 */
        CHECK_ERROR(_readMethod_bridge_change_admin(c, &method->basic.bridge_change_admin))
        break;
    case 7938: /* module 31 call 2 */
        CHECK_ERROR(_readMethod_bridge_change_timelock(c, &method->basic.bridge_change_timelock))
        break;
    case 7939: /* module 31 call 3 */
    ...
    case 7940: /* module 31 call 4 */
        ...
        break;
    case 7941: /* module 31 call 5 */
        CHECK_ERROR(_readMethod_bridge_change_bridge_limit(c, &method->basic.bridge_change_bridge_limit))
        break;
    case 7942: /* module 31 call 6 */
        CHECK_ERROR(_readMethod_bridge_change_bridge_exempted(c, &method->basic.bridge_change_bridge_exempted))
        break;
    case 7943: /* module 31 call 7 */
        CHECK_ERROR(_readMethod_bridge_force_handle_bridge_tx(c, &method->basic.bridge_force_handle_bridge_tx))
        break;
    case 7944: /* module 31 call 8 */
        CHECK_ERROR(_readMethod_bridge_batch_propose_bridge_tx(c, &method->basic.bridge_batch_propose_bridge_tx))
        break;
    case 7945: /* module 31 call 9 */
        CHECK_ERROR(_readMethod_bridge_propose_bridge_tx(c, &method->basic.bridge_propose_bridge_tx))
        break;
    case 7946: /* module 31 call 10 */
        CHECK_ERROR(_readMethod_bridge_handle_bridge_tx(c, &method->basic.bridge_handle_bridge_tx))
        break;
    case 7947: /* module 31 call 11 */
        CHECK_ERROR(_readMethod_bridge_freeze_txs(c, &method->basic.bridge_freeze_txs))
        break;
    case 7948: /* module 31 call 12 */
        CHECK_ERROR(_readMethod_bridge_unfreeze_txs(c, &method->basic.bridge_unfreeze_txs))
        break;
    case 7949: /* module 31 call 13 */
        CHECK_ERROR(_readMethod_bridge_handle_scheduled_bridge_tx(c, &method->basic.bridge_handle_scheduled_bridge_tx))
        break;
    case 8192: /* module 32 call 0 */
        CHECK_ERROR(_readMethod_compliancemanager_add_compliance_requirement(c, &method->basic.compliancemanager_add_compliance_requirement))
        break;
    case 8193: /* module 32 call 1 */
        CHECK_ERROR(_readMethod_compliancemanager_remove_compliance_requirement(c, &method->basic.compliancemanager_remove_compliance_requirement))
        break;
    case 8194: /* module 32 call 2 */
        CHECK_ERROR(_readMethod_compliancemanager_replace_asset_compliance(c, &method->basic.compliancemanager_replace_asset_compliance))
        break;
    case 8195: /* module 32 call 3 */
        CHECK_ERROR(_readMethod_compliancemanager_reset_asset_compliance(c, &method->basic.compliancemanager_reset_asset_compliance))
        break;
    case 8196: /* module 32 call 4 */
        CHECK_ERROR(_readMethod_compliancemanager_pause_asset_compliance(c, &method->basic.compliancemanager_pause_asset_compliance))
        break;
    case 8197: /* module 32 call 5 */
        CHECK_ERROR(_readMethod_compliancemanager_resume_asset_compliance(c, &method->basic.compliancemanager_resume_asset_compliance))
        break;
    case 8198: /* module 32 call 6 */
        CHECK_ERROR(_readMethod_compliancemanager_add_default_trusted_claim_issuer(c, &method->basic.compliancemanager_add_default_trusted_claim_issuer))
        break;
    case 8199: /* module 32 call 7 */
        CHECK_ERROR(_readMethod_compliancemanager_remove_default_trusted_claim_issuer(c, &method->basic.compliancemanager_remove_default_trusted_claim_issuer))
        break;
    case 8200: /* module 32 call 8 */
        CHECK_ERROR(_readMethod_compliancemanager_change_compliance_requirement(c, &method->basic.compliancemanager_change_compliance_requirement))
        break;
    case 8448: /* module 33 call 0 */
        CHECK_ERROR(_readMethod_voting_add_ballot(c, &method->basic.voting_add_ballot))
        break;
    case 8449: /* module 33 call 1 */
        CHECK_ERROR(_readMethod_voting_vote(c, &method->basic.voting_vote))
        break;
    case 8450: /* module 33 call 2 */
        CHECK_ERROR(_readMethod_voting_cancel_ballot(c, &method->basic.voting_cancel_ballot))
        break;
    case 8704: /* module 34 call 0 */
        CHECK_ERROR(_readMethod_stocapped_launch_sto(c, &method->basic.stocapped_launch_sto))
        break;
    case 8705: /* module 34 call 1 */
        CHECK_ERROR(_readMethod_stocapped_buy_tokens(c, &method->basic.stocapped_buy_tokens))
        break;
    case 8706: /* module 34 call 2 */
        CHECK_ERROR(_readMethod_stocapped_pause_sto(c, &method->basic.stocapped_pause_sto))
        break;
    case 8707: /* module 34 call 3 */
        CHECK_ERROR(_readMethod_stocapped_unpause_sto(c, &method->basic.stocapped_unpause_sto))
        break;
    case 8960: /* module 35 call 0 */
        CHECK_ERROR(_readMethod_exemption_modify_exemption_list(c, &method->basic.exemption_modify_exemption_list))
        break;
    case 9216: /* module 36 call 0 */
        CHECK_ERROR(_readMethod_settlement_create_venue(c, &method->basic.settlement_create_venue))
        break;
    case 9217: /* module 36 call 1 */
        CHECK_ERROR(_readMethod_settlement_update_venue(c, &method->basic.settlement_update_venue))
        break;
    case 9218: /* module 36 call 2 */
        CHECK_ERROR(_readMethod_settlement_add_instruction(c, &method->basic.settlement_add_instruction))
        break;
    case 9219: /* module 36 call 3 */
        CHECK_ERROR(_readMethod_settlement_add_and_affirm_instruction(c, &method->basic.settlement_add_and_affirm_instruction))
        break;
    case 9220: /* module 36 call 4 */
        CHECK_ERROR(_readMethod_settlement_affirm_instruction(c, &method->basic.settlement_affirm_instruction))
        break;
    case 9221: /* module 36 call 5 */
        CHECK_ERROR(_readMethod_settlement_withdraw_affirmation(c, &method->basic.settlement_withdraw_affirmation))
        break;
    case 9222: /* module 36 call 6 */
        CHECK_ERROR(_readMethod_settlement_reject_instruction(c, &method->basic.settlement_reject_instruction))
        break;
    case 9223: /* module 36 call 7 */
        CHECK_ERROR(_readMethod_settlement_affirm_with_receipts(c, &method->basic.settlement_affirm_with_receipts))
        break;
    case 9224: /* module 36 call 8 */
        CHECK_ERROR(_readMethod_settlement_claim_receipt(c, &method->basic.settlement_claim_receipt))
        break;
    case 9225: /* module 36 call 9 */
        CHECK_ERROR(_readMethod_settlement_unclaim_receipt(c, &method->basic.settlement_unclaim_receipt))
        break;
    case 9226: /* module 36 call 10 */
        CHECK_ERROR(_readMethod_settlement_set_venue_filtering(c, &method->basic.settlement_set_venue_filtering))
        break;
    case 9227: /* module 36 call 11 */
        CHECK_ERROR(_readMethod_settlement_allow_venues(c, &method->basic.settlement_allow_venues))
        break;
    case 9228: /* module 36 call 12 */
        CHECK_ERROR(_readMethod_settlement_disallow_venues(c, &method->basic.settlement_disallow_venues))
        break;
    case 9229: /* module 36 call 13 */
        CHECK_ERROR(_readMethod_settlement_execute_scheduled_instruction(c, &method->basic.settlement_execute_scheduled_instruction))
        break;
    case 9472: /* module 37 call 0 */
        CHECK_ERROR(_readMethod_sto_create_fundraiser(c, &method->basic.sto_create_fundraiser))
        break;
    case 9473: /* module 37 call 1 */
        CHECK_ERROR(_readMethod_sto_invest(c, &method->basic.sto_invest))
        break;
    case 9474: /* module 37 call 2 */
        CHECK_ERROR(_readMethod_sto_freeze_fundraiser(c, &method->basic.sto_freeze_fundraiser))
        break;
    case 9475: /* module 37 call 3 */
        CHECK_ERROR(_readMethod_sto_unfreeze_fundraiser(c, &method->basic.sto_unfreeze_fundraiser))
        break;
    case 9476: /* module 37 call 4 */
        CHECK_ERROR(_readMethod_sto_modify_fundraiser_window(c, &method->basic.sto_modify_fundraiser_window))
        break;
    case 9477: /* module 37 call 5 */
        CHECK_ERROR(_readMethod_sto_stop(c, &method->basic.sto_stop))
        break;
    case 9728: /* module 38 call 0 */
        CHECK_ERROR(_readMethod_cddserviceproviders_set_active_members_limit(c, &method->basic.cddserviceproviders_set_active_members_limit))
        break;
    case 9729: /* module 38 call 1 */
        CHECK_ERROR(_readMethod_cddserviceproviders_disable_member(c, &method->basic.cddserviceproviders_disable_member))
        break;
    case 9730: /* module 38 call 2 */
        CHECK_ERROR(_readMethod_cddserviceproviders_add_member(c, &method->basic.cddserviceproviders_add_member))
        break;
    case 9731: /* module 38 call 3 */
        CHECK_ERROR(_readMethod_cddserviceproviders_remove_member(c, &method->basic.cddserviceproviders_remove_member))
        break;
    case 9732: /* module 38 call 4 */
        CHECK_ERROR(_readMethod_cddserviceproviders_swap_member(c, &method->basic.cddserviceproviders_swap_member))
        break;
    case 9733: /* module 38 call 5 */
        CHECK_ERROR(_readMethod_cddserviceproviders_reset_members(c, &method->basic.cddserviceproviders_reset_members))
        break;
    case 9734: /* module 38 call 6 */
        CHECK_ERROR(_readMethod_cddserviceproviders_abdicate_membership(c, &method->basic.cddserviceproviders_abdicate_membership))
        break;
    case 10240: /* module 40 call 0 */
        CHECK_ERROR(_readMethod_protocolfee_change_coefficient(c, &method->basic.protocolfee_change_coefficient))
        break;
    case 10241: /* module 40 call 1 */
        CHECK_ERROR(_readMethod_protocolfee_change_base_fee(c, &method->basic.protocolfee_change_base_fee))
        break;
    case 10496: /* module 41 call 0 */
        CHECK_ERROR(_readMethod_utility_batch(c, &method->basic.utility_batch))
        break;
    case 10497: /* module 41 call 1 */
        CHECK_ERROR(_readMethod_utility_batch_atomic(c, &method->basic.utility_batch_atomic))
        break;
    case 10498: /* module 41 call 2 */
        CHECK_ERROR(_readMethod_utility_batch_optimistic(c, &method->basic.utility_batch_optimistic))
        break;
    case 10499: /* module 41 call 3 */
        CHECK_ERROR(_readMethod_utility_relay_tx(c, &method->basic.utility_relay_tx))
        break;
    case 10752: /* module 42 call 0 */
        CHECK_ERROR(_readMethod_portfolio_create_portfolio(c, &method->basic.portfolio_create_portfolio))
        break;
    case 10753: /* module 42 call 1 */
        CHECK_ERROR(_readMethod_portfolio_delete_portfolio(c, &method->basic.portfolio_delete_portfolio))
        break;
    case 10754: /* module 42 call 2 */
        CHECK_ERROR(_readMethod_portfolio_move_portfolio_funds(c, &method->basic.portfolio_move_portfolio_funds))
        break;
    case 10755: /* module 42 call 3 */
        CHECK_ERROR(_readMethod_portfolio_rename_portfolio(c, &method->basic.portfolio_rename_portfolio))
        break;
    case 11008: /* module 43 call 0 */
        CHECK_ERROR(_readMethod_confidential_add_range_proof(c, &method->basic.confidential_add_range_proof))
        break;
    case 11009: /* module 43 call 1 */
        CHECK_ERROR(_readMethod_confidential_add_verify_range_proof(c, &method->basic.confidential_add_verify_range_proof))
        break;
    case 11520: /* module 45 call 0 */
    ...
    case 11525: /* module 45 call 5 */
        ...
        break;
    case 11776: /* module 46 call 0 */
        CHECK_ERROR(_readMethod_corporateaction_set_max_details_length(c, &method->basic.corporateaction_set_max_details_length))
        break;
    case 11777: /* module 46 call 1 */
        CHECK_ERROR(_readMethod_corporateaction_reset_caa(c, &method->basic.corporateaction_reset_caa))
        break;
    case 11778: /* module 46 call 2 */
        CHECK_ERROR(_readMethod_corporateaction_set_default_targets(c, &method->basic.corporateaction_set_default_targets))
        break;
    case 11779: /* module 46 call 3 */
        CHECK_ERROR(_readMethod_corporateaction_set_default_withholding_tax(c, &method->basic.corporateaction_set_default_withholding_tax))
        break;
    case 11780: /* module 46 call 4 */
        CHECK_ERROR(_readMethod_corporateaction_set_did_withholding_tax(c, &method->basic.corporateaction_set_did_withholding_tax))
        break;
    case 11781: /* module 46 call 5 */
        CHECK_ERROR(_readMethod_corporateaction_initiate_corporate_action(c, &method->basic.corporateaction_initiate_corporate_action))
        break;
    case 11782: /* module 46 call 6 */
        CHECK_ERROR(_readMethod_corporateaction_link_ca_doc(c, &method->basic.corporateaction_link_ca_doc))
        break;
    case 11783: /* module 46 call 7 */
        CHECK_ERROR(_readMethod_corporateaction_remove_ca(c, &method->basic.corporateaction_remove_ca))
        break;
    case 11784: /* module 46 call 8 */
        CHECK_ERROR(_readMethod_corporateaction_change_record_date(c, &method->basic.corporateaction_change_record_date))
        break;
    case 12032: /* module 47 call 0 */
        CHECK_ERROR(_readMethod_corporateballot_attach_ballot(c, &method->basic.corporateballot_attach_ballot))
        break;
    case 12033: /* module 47 call 1 */
        CHECK_ERROR(_readMethod_corporateballot_vote(c, &method->basic.corporateballot_vote))
        break;
    case 12034: /* module 47 call 2 */
        CHECK_ERROR(_readMethod_corporateballot_change_end(c, &method->basic.corporateballot_change_end))
        break;
    case 12035: /* module 47 call 3 */
        CHECK_ERROR(_readMethod_corporateballot_change_meta(c, &method->basic.corporateballot_change_meta))
        break;
    case 12036: /* module 47 call 4 */
        CHECK_ERROR(_readMethod_corporateballot_change_rcv(c, &method->basic.corporateballot_change_rcv))
        break;
    case 12037: /* module 47 call 5 */
        CHECK_ERROR(_readMethod_corporateballot_remove_ballot(c, &method->basic.corporateballot_remove_ballot))
        break;
    case 12288: /* module 48 call 0 */
        CHECK_ERROR(_readMethod_capitaldistribution_distribute(c, &method->basic.capitaldistribution_distribute))
        break;
    case 12289: /* module 48 call 1 */
        CHECK_ERROR(_readMethod_capitaldistribution_claim(c, &method->basic.capitaldistribution_claim))
        break;
    case 12290: /* module 48 call 2 */
        CHECK_ERROR(_readMethod_capitaldistribution_push_benefit(c, &method->basic.capitaldistribution_push_benefit))
        break;
    case 12291: /* module 48 call 3 */
        CHECK_ERROR(_readMethod_capitaldistribution_reclaim(c, &method->basic.capitaldistribution_reclaim))
        break;
    case 12292: /* module 48 call 4 */
        CHECK_ERROR(_readMethod_capitaldistribution_remove_distribution(c, &method->basic.capitaldistribution_remove_distribution))
        break;
    case 12544: /* module 49 call 0 */
        CHECK_ERROR(_readMethod_checkpoint_create_checkpoint(c, &method->basic.checkpoint_create_checkpoint))
        break;
    case 12545: /* module 49 call 1 */
        CHECK_ERROR(_readMethod_checkpoint_set_schedules_max_complexity(c, &method->basic.checkpoint_set_schedules_max_complexity))
        break;
    case 12546: /* module 49 call 2 */
        CHECK_ERROR(_readMethod_checkpoint_create_schedule(c, &method->basic.checkpoint_create_schedule))
        break;
    case 12547: /* module 49 call 3 */
        CHECK_ERROR(_readMethod_checkpoint_remove_schedule(c, &method->basic.checkpoint_remove_schedule))
        break;
    default:
        return parser_unexpected_callIndex;
    }
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 1025: /* module 4 call 1 */
        ...
        case 0: /* balances_transfer_with_memo - dest */;
            return _toStringLookupSource(
                &m->basic.balances_transfer_with_memo.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_with_memo - value */;
            return _toStringCompactBalance(
                &m->basic.balances_transfer_with_memo.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* balances_transfer_with_memo - memo */;
            return _toStringOptionMemo(
                &m->basic.balances_transfer_with_memo.memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1029: /* module 4 call 5 */
        ...
        case 0: /* balances_burn_account_balance - amount */;
            return _toStringBalance(
                &m->basic.balances_burn_account_balance.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1804: /* module 7 call 12 */
        ...
        case 0: /* staking_add_permissioned_validator - identity */;
            return _toStringIdentityId(
                &m->basic.staking_add_permissioned_validator.identity,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1805: /* module 7 call 13 */
        ...
        case 0: /* staking_remove_permissioned_validator - identity */;
            return _toStringIdentityId(
                &m->basic.staking_remove_permissioned_validator.identity,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1806: /* module 7 call 14 */
        ...
        case 0: /* staking_validate_cdd_expiry_nominators - targets */;
            return _toStringVecAccountId(
                &m->basic.staking_validate_cdd_expiry_nominators.targets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1807: /* module 7 call 15 */
        ...
        case 0: /* staking_set_commission_cap - new_cap */;
            return _toStringPerbill(
                &m->basic.staking_set_commission_cap.new_cap,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1808: /* module 7 call 16 */
        ...
        case 0: /* staking_set_min_bond_threshold - new_value */;
            return _toStringBalanceOf(
                &m->basic.staking_set_min_bond_threshold.new_value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1821: /* module 7 call 29 */
        ...
        case 0: /* staking_payout_stakers_by_system - validator_stash */;
            return _toStringAccountId(
                &m->basic.staking_payout_stakers_by_system.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_payout_stakers_by_system - era */;
            return _toStringEraIndex(
                &m->basic.staking_payout_stakers_by_system.era,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3073: /* module 12 call 1 */
        ...
        case 0: /* imonline_set_slashing_params - params */;
            return _toStringOfflineSlashingParams(
                &m->basic.imonline_set_slashing_params.params,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4352: /* module 17 call 0 */
        ...
        case 0: /* multisig_create_multisig - signers */;
            return _toStringVecSignatory(
                &m->basic.multisig_create_multisig.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_create_multisig - sigs_required */;
            return _toStringu64(
                &m->basic.multisig_create_multisig.sigs_required,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4355: /* module 17 call 3 */
        ...
        case 0: /* multisig_create_proposal_as_identity - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_create_proposal_as_identity.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_create_proposal_as_identity - proposal */;
            return _toStringProposal(
                &m->nested.multisig_create_proposal_as_identity.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* multisig_create_proposal_as_identity - expiry */;
            return _toStringOptionMoment(
                &m->nested.multisig_create_proposal_as_identity.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* multisig_create_proposal_as_identity - auto_close */;
            return _toStringbool(
                &m->nested.multisig_create_proposal_as_identity.auto_close,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4356: /* module 17 call 4 */
        ...
        case 0: /* multisig_create_proposal_as_key - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_create_proposal_as_key.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_create_proposal_as_key - proposal */;
            return _toStringProposal(
                &m->nested.multisig_create_proposal_as_key.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* multisig_create_proposal_as_key - expiry */;
            return _toStringOptionMoment(
                &m->nested.multisig_create_proposal_as_key.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* multisig_create_proposal_as_key - auto_close */;
            return _toStringbool(
                &m->nested.multisig_create_proposal_as_key.auto_close,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4357: /* module 17 call 5 */
        ...
        case 0: /* multisig_approve_as_identity - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_approve_as_identity.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_approve_as_identity - proposal_id */;
            return _toStringu64(
                &m->basic.multisig_approve_as_identity.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4358: /* module 17 call 6 */
        ...
        case 0: /* multisig_approve_as_key - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_approve_as_key.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_approve_as_key - proposal_id */;
            return _toStringu64(
                &m->basic.multisig_approve_as_key.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4359: /* module 17 call 7 */
        ...
        case 0: /* multisig_reject_as_identity - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_reject_as_identity.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_reject_as_identity - proposal_id */;
            return _toStringu64(
                &m->basic.multisig_reject_as_identity.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4360: /* module 17 call 8 */
        ...
        case 0: /* multisig_reject_as_key - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_reject_as_key.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_reject_as_key - proposal_id */;
            return _toStringu64(
                &m->basic.multisig_reject_as_key.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4362: /* module 17 call 10 */
        ...
        case 0: /* multisig_accept_multisig_signer_as_key - auth_id */;
            return _toStringu64(
                &m->basic.multisig_accept_multisig_signer_as_key.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4363: /* module 17 call 11 */
        ...
        case 0: /* multisig_add_multisig_signer - signer */;
            return _toStringSignatory(
                &m->basic.multisig_add_multisig_signer.signer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4364: /* module 17 call 12 */
        ...
        case 0: /* multisig_remove_multisig_signer - signer */;
            return _toStringSignatory(
                &m->basic.multisig_remove_multisig_signer.signer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4365: /* module 17 call 13 */
        ...
        case 1: /* multisig_add_multisig_signers_via_creator - signers */;
            return _toStringVecSignatory(
                &m->basic.multisig_add_multisig_signers_via_creator.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4367: /* module 17 call 15 */
        ...
        case 0: /* multisig_change_sigs_required - sigs_required */;
            return _toStringu64(
                &m->basic.multisig_change_sigs_required.sigs_required,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4369: /* module 17 call 17 */
        ...
        case 0: /* multisig_make_multisig_signer - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_make_multisig_signer.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4370: /* module 17 call 18 */
        ...
        case 0: /* multisig_make_multisig_primary - multisig */;
            return _toStringAccountId(
                &m->basic.multisig_make_multisig_primary.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 4864: /* module 19 call 0 */
        ...
        case 0: /* contracts_update_schedule - schedule */;
            return _toStringSchedule(
                &m->basic.contracts_update_schedule.schedule,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4865: /* module 19 call 1 */
        ...
        case 0: /* contracts_put_code - meta_info */;
            return _toStringTemplateMetadata(
                &m->basic.contracts_put_code.meta_info,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_put_code - instantiation_fee */;
            return _toStringBalanceOf(
                &m->basic.contracts_put_code.instantiation_fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_put_code - code */;
            return _toStringBytes(
                &m->basic.contracts_put_code.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4866: /* module 19 call 2 */
        ...
        case 0: /* contracts_call - dest */;
            return _toStringLookupSource(
                &m->basic.contracts_call.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_call - value */;
            return _toStringCompactBalanceOf(
                &m->basic.contracts_call.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_call - gas_limit */;
            return _toStringCompactGas(
                &m->basic.contracts_call.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_call - data */;
            return _toStringBytes(
                &m->basic.contracts_call.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4867: /* module 19 call 3 */
        ...
        case 0: /* contracts_instantiate - endowment */;
            return _toStringCompactBalanceOf(
                &m->basic.contracts_instantiate.endowment,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate - gas_limit */;
            return _toStringCompactGas(
                &m->basic.contracts_instantiate.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_instantiate.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate - data */;
            return _toStringBytes(
                &m->basic.contracts_instantiate.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate - max_fee */;
            return _toStringBalanceOf(
                &m->basic.contracts_instantiate.max_fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4868: /* module 19 call 4 */
        ...
        case 0: /* contracts_freeze_instantiation - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_freeze_instantiation.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4869: /* module 19 call 5 */
        ...
        case 0: /* contracts_unfreeze_instantiation - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_unfreeze_instantiation.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4870: /* module 19 call 6 */
        ...
        case 0: /* contracts_transfer_template_ownership - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_transfer_template_ownership.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_transfer_template_ownership - new_owner */;
            return _toStringIdentityId(
                &m->basic.contracts_transfer_template_ownership.new_owner,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4871: /* module 19 call 7 */
        ...
        case 0: /* contracts_change_template_fees - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_change_template_fees.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 2: /* contracts_change_template_fees - new_usage_fee */;
            return _toStringOptionBalanceOf(
                &m->basic.contracts_change_template_fees.new_usage_fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4872: /* module 19 call 8 */
        ...
        case 0: /* contracts_change_template_meta_url - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_change_template_meta_url.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_change_template_meta_url - new_url */;
            return _toStringOptionMetaUrl(
                &m->basic.contracts_change_template_meta_url.new_url,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5120: /* module 20 call 0 */
        ...
        case 0: /* treasury_disbursement - beneficiaries */;
            return _toStringVecBeneficiary(
                &m->basic.treasury_disbursement.beneficiaries,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5121: /* module 20 call 1 */
        ...
        case 0: /* treasury_reimbursement - amount */;
            return _toStringBalanceOf(
                &m->basic.treasury_reimbursement.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5376: /* module 21 call 0 */
        ...
        case 0: /* polymeshcommittee_set_vote_threshold - n */;
            return _toStringu32(
                &m->basic.polymeshcommittee_set_vote_threshold.n,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcommittee_set_vote_threshold - d */;
            return _toStringu32(
                &m->basic.polymeshcommittee_set_vote_threshold.d,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5377: /* module 21 call 1 */
        ...
        case 0: /* polymeshcommittee_set_release_coordinator - id */;
            return _toStringIdentityId(
                &m->basic.polymeshcommittee_set_release_coordinator.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5378: /* module 21 call 2 */
        ...
        case 0: /* polymeshcommittee_set_expires_after - expiry */;
            return _toStringMaybeBlock(
                &m->basic.polymeshcommittee_set_expires_after.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5379: /* module 21 call 3 */
        ...
        case 0: /* polymeshcommittee_close - proposal */;
            return _toStringHash(
                &m->basic.polymeshcommittee_close.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcommittee_close - index */;
            return _toStringCompactProposalIndex(
                &m->basic.polymeshcommittee_close.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5380: /* module 21 call 4 */
        ...
        case 0: /* polymeshcommittee_vote_or_propose - approve */;
            return _toStringbool(
                &m->nested.polymeshcommittee_vote_or_propose.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcommittee_vote_or_propose - call */;
            return _toStringProposal(
                &m->nested.polymeshcommittee_vote_or_propose.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5381: /* module 21 call 5 */
        ...
        case 0: /* polymeshcommittee_vote - proposal */;
            return _toStringHash(
                &m->basic.polymeshcommittee_vote.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcommittee_vote - index */;
            return _toStringProposalIndex(
                &m->basic.polymeshcommittee_vote.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polymeshcommittee_vote - approve */;
            return _toStringbool(
                &m->basic.polymeshcommittee_vote.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5633: /* module 22 call 1 */
        ...
        case 0: /* committeemembership_disable_member - who */;
            return _toStringIdentityId(
                &m->basic.committeemembership_disable_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* committeemembership_disable_member - expiry */;
            return _toStringOptionMoment(
                &m->basic.committeemembership_disable_member.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* committeemembership_disable_member - at */;
            return _toStringOptionMoment(
                &m->basic.committeemembership_disable_member.at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5634: /* module 22 call 2 */
        ...
        case 0: /* committeemembership_add_member - who */;
            return _toStringIdentityId(
                &m->basic.committeemembership_add_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5635: /* module 22 call 3 */
        ...
        case 0: /* committeemembership_remove_member - who */;
            return _toStringIdentityId(
                &m->basic.committeemembership_remove_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5636: /* module 22 call 4 */
        ...
        case 0: /* committeemembership_swap_member - remove */;
            return _toStringIdentityId(
                &m->basic.committeemembership_swap_member.remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* committeemembership_swap_member - add */;
            return _toStringIdentityId(
                &m->basic.committeemembership_swap_member.add,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5637: /* module 22 call 5 */
        ...
        case 0: /* committeemembership_reset_members - members */;
            return _toStringVecIdentityId(
                &m->basic.committeemembership_reset_members.members,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5888: /* module 23 call 0 */
        switch (itemIdx) {
        case 0: /* pips_set_prune_historical_pips - prune */;
            return _toStringbool(
                &m->basic.pips_set_prune_historical_pips.prune,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5889: /* module 23 call 1 */
        ...
        case 0: /* pips_set_min_proposal_deposit - deposit */;
            return _toStringBalanceOf(
                &m->basic.pips_set_min_proposal_deposit.deposit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5890: /* module 23 call 2 */
        ...
        case 0: /* pips_set_default_enactment_period - duration */;
            return _toStringBlockNumber(
                &m->basic.pips_set_default_enactment_period.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5891: /* module 23 call 3 */
        ...
        case 0: /* pips_set_pending_pip_expiry - expiry */;
            return _toStringMaybeBlock(
                &m->basic.pips_set_pending_pip_expiry.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5892: /* module 23 call 4 */
        switch (itemIdx) {
        case 0: /* pips_set_max_pip_skip_count - max */;
            return _toStringSkippedCount(
                &m->basic.pips_set_max_pip_skip_count.max,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5893: /* module 23 call 5 */
        switch (itemIdx) {
        case 0: /* pips_set_active_pip_limit - limit */;
            return _toStringu32(
                &m->basic.pips_set_active_pip_limit.limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5895: /* module 23 call 7 */
        ...
        case 0: /* pips_vote - id */;
            return _toStringPipId(
                &m->basic.pips_vote.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* pips_vote - aye_or_nay */;
            return _toStringbool(
                &m->basic.pips_vote.aye_or_nay,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* pips_vote - deposit */;
            return _toStringBalanceOf(
                &m->basic.pips_vote.deposit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5896: /* module 23 call 8 */
        ...
        case 0: /* pips_approve_committee_proposal - id */;
            return _toStringPipId(
                &m->basic.pips_approve_committee_proposal.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5897: /* module 23 call 9 */
        ...
        case 0: /* pips_reject_proposal - id */;
            return _toStringPipId(
                &m->basic.pips_reject_proposal.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5898: /* module 23 call 10 */
        ...
        case 0: /* pips_prune_proposal - id */;
            return _toStringPipId(
                &m->basic.pips_prune_proposal.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5899: /* module 23 call 11 */
        ...
        case 0: /* pips_reschedule_execution - id */;
            return _toStringPipId(
                &m->basic.pips_reschedule_execution.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* pips_reschedule_execution - until */;
            return _toStringOptionBlockNumber(
                &m->basic.pips_reschedule_execution.until,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5902: /* module 23 call 14 */
        ...
        case 0: /* pips_enact_snapshot_results - results */;
            return _toStringVecTuplePipIdSnapshotResult(
                &m->basic.pips_enact_snapshot_results.results,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5903: /* module 23 call 15 */
        ...
        case 0: /* pips_execute_scheduled_pip - id */;
            return _toStringPipId(
                &m->basic.pips_execute_scheduled_pip.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 5904: /* module 23 call 16 */
        ...
        case 0: /* pips_expire_scheduled_pip - did */;
            return _toStringIdentityId(
                &m->basic.pips_expire_scheduled_pip.did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* pips_expire_scheduled_pip - id */;
            return _toStringPipId(
                &m->basic.pips_expire_scheduled_pip.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6144: /* module 24 call 0 */
        ...
        case 0: /* technicalcommittee_set_vote_threshold - n */;
            return _toStringu32(
                &m->basic.technicalcommittee_set_vote_threshold.n,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommittee_set_vote_threshold - d */;
            return _toStringu32(
                &m->basic.technicalcommittee_set_vote_threshold.d,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6145: /* module 24 call 1 */
        ...
        case 0: /* technicalcommittee_set_release_coordinator - id */;
            return _toStringIdentityId(
                &m->basic.technicalcommittee_set_release_coordinator.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6146: /* module 24 call 2 */
        ...
        case 0: /* technicalcommittee_set_expires_after - expiry */;
            return _toStringMaybeBlock(
                &m->basic.technicalcommittee_set_expires_after.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6148: /* module 24 call 4 */
        ...
        case 0: /* technicalcommittee_vote_or_propose - approve */;
            return _toStringbool(
                &m->nested.technicalcommittee_vote_or_propose.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommittee_vote_or_propose - call */;
            return _toStringProposal(
                &m->nested.technicalcommittee_vote_or_propose.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6401: /* module 25 call 1 */
        ...
        case 0: /* technicalcommitteemembership_disable_member - who */;
            return _toStringIdentityId(
                &m->basic.technicalcommitteemembership_disable_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 2: /* technicalcommitteemembership_disable_member - at */;
            return _toStringOptionMoment(
                &m->basic.technicalcommitteemembership_disable_member.at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6402: /* module 25 call 2 */
        ...
        case 0: /* technicalcommitteemembership_add_member - who */;
            return _toStringIdentityId(
                &m->basic.technicalcommitteemembership_add_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6403: /* module 25 call 3 */
        ...
        case 0: /* technicalcommitteemembership_remove_member - who */;
            return _toStringIdentityId(
                &m->basic.technicalcommitteemembership_remove_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6404: /* module 25 call 4 */
        ...
        case 0: /* technicalcommitteemembership_swap_member - remove */;
            return _toStringIdentityId(
                &m->basic.technicalcommitteemembership_swap_member.remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* technicalcommitteemembership_swap_member - add */;
            return _toStringIdentityId(
                &m->basic.technicalcommitteemembership_swap_member.add,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6656: /* module 26 call 0 */
        ...
        case 0: /* upgradecommittee_set_vote_threshold - n */;
            return _toStringu32(
                &m->basic.upgradecommittee_set_vote_threshold.n,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommittee_set_vote_threshold - d */;
            return _toStringu32(
                &m->basic.upgradecommittee_set_vote_threshold.d,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6657: /* module 26 call 1 */
        ...
        case 0: /* upgradecommittee_set_release_coordinator - id */;
            return _toStringIdentityId(
                &m->basic.upgradecommittee_set_release_coordinator.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6658: /* module 26 call 2 */
        ...
        case 0: /* upgradecommittee_set_expires_after - expiry */;
            return _toStringMaybeBlock(
                &m->basic.upgradecommittee_set_expires_after.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6659: /* module 26 call 3 */
        ...
        case 0: /* upgradecommittee_close - proposal */;
            return _toStringHash(
                &m->basic.upgradecommittee_close.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommittee_close - index */;
            return _toStringCompactProposalIndex(
                &m->basic.upgradecommittee_close.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6660: /* module 26 call 4 */
        ...
        case 0: /* upgradecommittee_vote_or_propose - approve */;
            return _toStringbool(
                &m->nested.upgradecommittee_vote_or_propose.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommittee_vote_or_propose - call */;
            return _toStringProposal(
                &m->nested.upgradecommittee_vote_or_propose.call,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6661: /* module 26 call 5 */
        ...
        case 0: /* upgradecommittee_vote - proposal */;
            return _toStringHash(
                &m->basic.upgradecommittee_vote.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommittee_vote - index */;
            return _toStringProposalIndex(
                &m->basic.upgradecommittee_vote.index,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* upgradecommittee_vote - approve */;
            return _toStringbool(
                &m->basic.upgradecommittee_vote.approve,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6913: /* module 27 call 1 */
        ...
        case 0: /* upgradecommitteemembership_disable_member - who */;
            return _toStringIdentityId(
                &m->basic.upgradecommitteemembership_disable_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommitteemembership_disable_member - expiry */;
            return _toStringOptionMoment(
                &m->basic.upgradecommitteemembership_disable_member.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* upgradecommitteemembership_disable_member - at */;
            return _toStringOptionMoment(
                &m->basic.upgradecommitteemembership_disable_member.at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6914: /* module 27 call 2 */
        ...
        case 0: /* upgradecommitteemembership_add_member - who */;
            return _toStringIdentityId(
                &m->basic.upgradecommitteemembership_add_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6915: /* module 27 call 3 */
        ...
        case 0: /* upgradecommitteemembership_remove_member - who */;
            return _toStringIdentityId(
                &m->basic.upgradecommitteemembership_remove_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6916: /* module 27 call 4 */
        ...
        case 0: /* upgradecommitteemembership_swap_member - remove */;
            return _toStringIdentityId(
                &m->basic.upgradecommitteemembership_swap_member.remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* upgradecommitteemembership_swap_member - add */;
            return _toStringIdentityId(
                &m->basic.upgradecommitteemembership_swap_member.add,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6917: /* module 27 call 5 */
        ...
        case 0: /* upgradecommitteemembership_reset_members - members */;
            return _toStringVecIdentityId(
                &m->basic.upgradecommitteemembership_reset_members.members,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7168: /* module 28 call 0 */
        ...
        case 0: /* asset_register_ticker - ticker */;
            return _toStringTicker(
                &m->basic.asset_register_ticker.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7169: /* module 28 call 1 */
        ...
        case 0: /* asset_accept_ticker_transfer - auth_id */;
            return _toStringu64(
                &m->basic.asset_accept_ticker_transfer.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7171: /* module 28 call 3 */
        ...
        case 0: /* asset_accept_asset_ownership_transfer - auth_id */;
            return _toStringu64(
                &m->basic.asset_accept_asset_ownership_transfer.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7175: /* module 28 call 7 */
        ...
        case 0: /* asset_rename_asset - ticker */;
            return _toStringTicker(
                &m->basic.asset_rename_asset.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_rename_asset - name */;
            return _toStringAssetName(
                &m->basic.asset_rename_asset.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7176: /* module 28 call 8 */
        ...
        case 0: /* asset_issue - ticker */;
            return _toStringTicker(
                &m->basic.asset_issue.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_issue - value */;
            return _toStringBalance(
                &m->basic.asset_issue.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7177: /* module 28 call 9 */
        ...
        case 0: /* asset_redeem - ticker */;
            return _toStringTicker(
                &m->basic.asset_redeem.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_redeem - value */;
            return _toStringBalance(
                &m->basic.asset_redeem.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7178: /* module 28 call 10 */
        ...
        case 0: /* asset_make_divisible - ticker */;
            return _toStringTicker(
                &m->basic.asset_make_divisible.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7179: /* module 28 call 11 */
        ...
        case 0: /* asset_add_documents - docs */;
            return _toStringVecDocument(
                &m->basic.asset_add_documents.docs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_add_documents - ticker */;
            return _toStringTicker(
                &m->basic.asset_add_documents.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7180: /* module 28 call 12 */
        ...
        case 0: /* asset_remove_documents - ids */;
            return _toStringVecDocumentId(
                &m->basic.asset_remove_documents.ids,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_remove_documents - ticker */;
            return _toStringTicker(
                &m->basic.asset_remove_documents.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7181: /* module 28 call 13 */
        ...
        case 0: /* asset_set_funding_round - ticker */;
            return _toStringTicker(
                &m->basic.asset_set_funding_round.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_set_funding_round - name */;
            return _toStringFundingRoundName(
                &m->basic.asset_set_funding_round.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7182: /* module 28 call 14 */
        ...
        case 0: /* asset_update_identifiers - ticker */;
            return _toStringTicker(
                &m->basic.asset_update_identifiers.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_update_identifiers - identifiers */;
            return _toStringVecAssetIdentifier(
                &m->basic.asset_update_identifiers.identifiers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7183: /* module 28 call 15 */
        ...
        case 0: /* asset_add_extension - ticker */;
            return _toStringTicker(
                &m->basic.asset_add_extension.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_add_extension - extension_details */;
            return _toStringSmartExtension(
                &m->basic.asset_add_extension.extension_details,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7184: /* module 28 call 16 */
        ...
        case 0: /* asset_archive_extension - ticker */;
            return _toStringTicker(
                &m->basic.asset_archive_extension.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_archive_extension - extension_id */;
            return _toStringAccountId(
                &m->basic.asset_archive_extension.extension_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7185: /* module 28 call 17 */
        ...
        case 0: /* asset_unarchive_extension - ticker */;
            return _toStringTicker(
                &m->basic.asset_unarchive_extension.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_unarchive_extension - extension_id */;
            return _toStringAccountId(
                &m->basic.asset_unarchive_extension.extension_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7186: /* module 28 call 18 */
        ...
        case 0: /* asset_remove_primary_issuance_agent - ticker */;
            return _toStringTicker(
                &m->basic.asset_remove_primary_issuance_agent.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7187: /* module 28 call 19 */
        ...
        case 0: /* asset_remove_smart_extension - ticker */;
            return _toStringTicker(
                &m->basic.asset_remove_smart_extension.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_remove_smart_extension - extension_id */;
            return _toStringAccountId(
                &m->basic.asset_remove_smart_extension.extension_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7188: /* module 28 call 20 */
        ...
        case 0: /* asset_claim_classic_ticker - ticker */;
            return _toStringTicker(
                &m->basic.asset_claim_classic_ticker.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_claim_classic_ticker - ethereum_signature */;
            return _toStringEcdsaSignature(
                &m->basic.asset_claim_classic_ticker.ethereum_signature,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7189: /* module 28 call 21 */
        ...
        case 1: /* asset_reserve_classic_ticker - contract_did */;
            return _toStringIdentityId(
                &m->basic.asset_reserve_classic_ticker.contract_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_reserve_classic_ticker - config */;
            return _toStringTickerRegistrationConfig(
                &m->basic.asset_reserve_classic_ticker.config,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7424: /* module 29 call 0 */
        ...
        case 0: /* dividend_new - amount */;
            return _toStringBalance(
                &m->basic.dividend_new.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* dividend_new - ticker */;
            return _toStringTicker(
                &m->basic.dividend_new.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* dividend_new - matures_at */;
            return _toStringMoment(
                &m->basic.dividend_new.matures_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* dividend_new - expires_at */;
            return _toStringMoment(
                &m->basic.dividend_new.expires_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* dividend_new - payout_ticker */;
            return _toStringTicker(
                &m->basic.dividend_new.payout_ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* dividend_new - checkpoint_id */;
            return _toStringCheckpointId(
                &m->basic.dividend_new.checkpoint_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7425: /* module 29 call 1 */
        ...
        case 0: /* dividend_cancel - ticker */;
            return _toStringTicker(
                &m->basic.dividend_cancel.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* dividend_cancel - dividend_id */;
            return _toStringu32(
                &m->basic.dividend_cancel.dividend_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7426: /* module 29 call 2 */
        ...
        case 0: /* dividend_claim - ticker */;
            return _toStringTicker(
                &m->basic.dividend_claim.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* dividend_claim - dividend_id */;
            return _toStringu32(
                &m->basic.dividend_claim.dividend_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7427: /* module 29 call 3 */
        ...
        case 0: /* dividend_claim_unclaimed - ticker */;
            return _toStringTicker(
                &m->basic.dividend_claim_unclaimed.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* dividend_claim_unclaimed - dividend_id */;
            return _toStringu32(
                &m->basic.dividend_claim_unclaimed.dividend_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7680: /* module 30 call 0 */
        ...
        case 0: /* identity_register_did - uid */;
            return _toStringInvestorUid(
                &m->basic.identity_register_did.uid,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_register_did - secondary_keys */;
            return _toStringVecSecondaryKey(
                &m->basic.identity_register_did.secondary_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7681: /* module 30 call 1 */
        ...
        case 0: /* identity_cdd_register_did - target_account */;
            return _toStringAccountId(
                &m->basic.identity_cdd_register_did.target_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_cdd_register_did - secondary_keys */;
            return _toStringVecSecondaryKey(
                &m->basic.identity_cdd_register_did.secondary_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7682: /* module 30 call 2 */
        ...
        case 0: /* identity_mock_cdd_register_did - target_account */;
            return _toStringAccountId(
                &m->basic.identity_mock_cdd_register_did.target_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7683: /* module 30 call 3 */
        ...
        case 0: /* identity_invalidate_cdd_claims - cdd */;
            return _toStringIdentityId(
                &m->basic.identity_invalidate_cdd_claims.cdd,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_invalidate_cdd_claims - disable_from */;
            return _toStringMoment(
                &m->basic.identity_invalidate_cdd_claims.disable_from,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_invalidate_cdd_claims - expiry */;
            return _toStringOptionMoment(
                &m->basic.identity_invalidate_cdd_claims.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7684: /* module 30 call 4 */
        ...
        case 0: /* identity_remove_secondary_keys - signers_to_remove */;
            return _toStringVecSignatory(
                &m->basic.identity_remove_secondary_keys.signers_to_remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7685: /* module 30 call 5 */
        ...
        case 0: /* identity_accept_primary_key - rotation_auth_id */;
            return _toStringu64(
                &m->basic.identity_accept_primary_key.rotation_auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_accept_primary_key - optional_cdd_auth_id */;
            return _toStringOptionu64(
                &m->basic.identity_accept_primary_key.optional_cdd_auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7686: /* module 30 call 6 */
        ...
        case 0: /* identity_change_cdd_requirement_for_mk_rotation - auth_required */;
            return _toStringbool(
                &m->basic.identity_change_cdd_requirement_for_mk_rotation.auth_required,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7687: /* module 30 call 7 */
        ...
        case 0: /* identity_join_identity_as_key - auth_id */;
            return _toStringu64(
                &m->basic.identity_join_identity_as_key.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7688: /* module 30 call 8 */
        ...
        case 0: /* identity_join_identity_as_identity - auth_id */;
            return _toStringu64(
                &m->basic.identity_join_identity_as_identity.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7690: /* module 30 call 10 */
        ...
        case 0: /* identity_leave_identity_as_identity - did */;
            return _toStringIdentityId(
                &m->basic.identity_leave_identity_as_identity.did,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7691: /* module 30 call 11 */
        ...
        case 0: /* identity_add_claim - target */;
            return _toStringIdentityId(
                &m->basic.identity_add_claim.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_add_claim - claim */;
            return _toStringClaim(
                &m->basic.identity_add_claim.claim,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_add_claim - expiry */;
            return _toStringOptionMoment(
                &m->basic.identity_add_claim.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7692: /* module 30 call 12 */
        ...
        case 0: /* identity_forwarded_call - target_did */;
            return _toStringIdentityId(
                &m->nested.identity_forwarded_call.target_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_forwarded_call - proposal */;
            return _toStringProposal(
                &m->nested.identity_forwarded_call.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7693: /* module 30 call 13 */
        ...
        case 0: /* identity_revoke_claim - target */;
            return _toStringIdentityId(
                &m->basic.identity_revoke_claim.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_revoke_claim - claim */;
            return _toStringClaim(
                &m->basic.identity_revoke_claim.claim,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7694: /* module 30 call 14 */
        ...
        case 0: /* identity_set_permission_to_signer - signer */;
            return _toStringSignatory(
                &m->basic.identity_set_permission_to_signer.signer,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_set_permission_to_signer - permissions */;
            return _toStringPermissions(
                &m->basic.identity_set_permission_to_signer.permissions,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7695: /* module 30 call 15 */
        ...
        case 0: /* identity_legacy_set_permission_to_signer - signer */;
            return _toStringSignatory(
                &m->basic.identity_legacy_set_permission_to_signer.signer,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 7699: /* module 30 call 19 */
        ...
        case 0: /* identity_get_cdd_of - of */;
            return _toStringAccountId(
                &m->basic.identity_get_cdd_of.of,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7700: /* module 30 call 20 */
        ...
        case 0: /* identity_add_authorization - target */;
            return _toStringSignatory(
                &m->basic.identity_add_authorization.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_add_authorization - authorization_data */;
            return _toStringAuthorizationData(
                &m->basic.identity_add_authorization.authorization_data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_add_authorization - expiry */;
            return _toStringOptionMoment(
                &m->basic.identity_add_authorization.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7701: /* module 30 call 21 */
        ...
        case 0: /* identity_remove_authorization - target */;
            return _toStringSignatory(
                &m->basic.identity_remove_authorization.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_remove_authorization - auth_id */;
            return _toStringu64(
                &m->basic.identity_remove_authorization.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_remove_authorization - _auth_issuer_pays */;
            return _toStringbool(
                &m->basic.identity_remove_authorization._auth_issuer_pays,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7702: /* module 30 call 22 */
        ...
        case 0: /* identity_accept_authorization - auth_id */;
            return _toStringu64(
                &m->basic.identity_accept_authorization.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7703: /* module 30 call 23 */
        ...
        case 0: /* identity_add_secondary_keys_with_authorization - additional_keys */;
            return _toStringVecSecondaryKeyWithAuth(
                &m->basic.identity_add_secondary_keys_with_authorization.additional_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 7704: /* module 30 call 24 */
        ...
        case 0: /* identity_revoke_offchain_authorization - signer */;
            return _toStringSignatory(
                &m->basic.identity_revoke_offchain_authorization.signer,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_revoke_offchain_authorization - auth */;
            return _toStringTargetIdAuthorization(
                &m->basic.identity_revoke_offchain_authorization.auth,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7705: /* module 30 call 25 */
        ...
        case 0: /* identity_add_investor_uniqueness_claim - target */;
            return _toStringIdentityId(
                &m->basic.identity_add_investor_uniqueness_claim.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_add_investor_uniqueness_claim - claim */;
            return _toStringClaim(
                &m->basic.identity_add_investor_uniqueness_claim.claim,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_add_investor_uniqueness_claim - proof */;
            return _toStringInvestorZKProofData(
                &m->basic.identity_add_investor_uniqueness_claim.proof,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* identity_add_investor_uniqueness_claim - expiry */;
            return _toStringOptionMoment(
                &m->basic.identity_add_investor_uniqueness_claim.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7706: /* module 30 call 26 */
        ...
        case 0: /* identity_gc_add_cdd_claim - target */;
            return _toStringIdentityId(
                &m->basic.identity_gc_add_cdd_claim.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_gc_add_cdd_claim - expiry */;
            return _toStringOptionMoment(
                &m->basic.identity_gc_add_cdd_claim.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7707: /* module 30 call 27 */
        ...
        case 0: /* identity_gc_revoke_cdd_claim - target */;
            return _toStringIdentityId(
                &m->basic.identity_gc_revoke_cdd_claim.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7936: /* module 31 call 0 */
        ...
        case 0: /* bridge_change_controller - controller */;
            return _toStringAccountId(
                &m->basic.bridge_change_controller.controller,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7937: /* module 31 call 1 */
        ...
        case 0: /* bridge_change_admin - admin */;
            return _toStringAccountId(
                &m->basic.bridge_change_admin.admin,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7938: /* module 31 call 2 */
        ...
        case 0: /* bridge_change_timelock - timelock */;
            return _toStringBlockNumber(
                &m->basic.bridge_change_timelock.timelock,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7941: /* module 31 call 5 */
        ...
        case 0: /* bridge_change_bridge_limit - amount */;
            return _toStringBalance(
                &m->basic.bridge_change_bridge_limit.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* bridge_change_bridge_limit - duration */;
            return _toStringBlockNumber(
                &m->basic.bridge_change_bridge_limit.duration,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7942: /* module 31 call 6 */
        ...
        case 0: /* bridge_change_bridge_exempted - exempted */;
            return _toStringVecTupleIdentityIdbool(
                &m->basic.bridge_change_bridge_exempted.exempted,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7943: /* module 31 call 7 */
        ...
        case 0: /* bridge_force_handle_bridge_tx - bridge_tx */;
            return _toStringBridgeTx(
                &m->basic.bridge_force_handle_bridge_tx.bridge_tx,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7944: /* module 31 call 8 */
        ...
        case 0: /* bridge_batch_propose_bridge_tx - bridge_txs */;
            return _toStringVecBridgeTx(
                &m->basic.bridge_batch_propose_bridge_tx.bridge_txs,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7945: /* module 31 call 9 */
        ...
        case 0: /* bridge_propose_bridge_tx - bridge_tx */;
            return _toStringBridgeTx(
                &m->basic.bridge_propose_bridge_tx.bridge_tx,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7946: /* module 31 call 10 */
        ...
        case 0: /* bridge_handle_bridge_tx - bridge_tx */;
            return _toStringBridgeTx(
                &m->basic.bridge_handle_bridge_tx.bridge_tx,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7947: /* module 31 call 11 */
        ...
        case 0: /* bridge_freeze_txs - bridge_txs */;
            return _toStringVecBridgeTx(
                &m->basic.bridge_freeze_txs.bridge_txs,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7948: /* module 31 call 12 */
        ...
        case 0: /* bridge_unfreeze_txs - bridge_txs */;
            return _toStringVecBridgeTx(
                &m->basic.bridge_unfreeze_txs.bridge_txs,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7949: /* module 31 call 13 */
        ...
        case 0: /* bridge_handle_scheduled_bridge_tx - bridge_tx */;
            return _toStringBridgeTx(
                &m->basic.bridge_handle_scheduled_bridge_tx.bridge_tx,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8192: /* module 32 call 0 */
        ...
        case 1: /* compliancemanager_add_compliance_requirement - sender_conditions */;
            return _toStringVecCondition(
                &m->basic.compliancemanager_add_compliance_requirement.sender_conditions,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* compliancemanager_add_compliance_requirement - receiver_conditions */;
            return _toStringVecCondition(
                &m->basic.compliancemanager_add_compliance_requirement.receiver_conditions,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8194: /* module 32 call 2 */
        ...
        case 0: /* compliancemanager_replace_asset_compliance - ticker */;
            return _toStringTicker(
                &m->basic.compliancemanager_replace_asset_compliance.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 8195: /* module 32 call 3 */
        ...
        case 0: /* compliancemanager_reset_asset_compliance - ticker */;
            return _toStringTicker(
                &m->basic.compliancemanager_reset_asset_compliance.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8196: /* module 32 call 4 */
        ...
        case 0: /* compliancemanager_pause_asset_compliance - ticker */;
            return _toStringTicker(
                &m->basic.compliancemanager_pause_asset_compliance.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8197: /* module 32 call 5 */
        ...
        case 0: /* compliancemanager_resume_asset_compliance - ticker */;
            return _toStringTicker(
                &m->basic.compliancemanager_resume_asset_compliance.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8199: /* module 32 call 7 */
        ...
        case 0: /* compliancemanager_remove_default_trusted_claim_issuer - ticker */;
            return _toStringTicker(
                &m->basic.compliancemanager_remove_default_trusted_claim_issuer.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* compliancemanager_remove_default_trusted_claim_issuer - issuer */;
            return _toStringIdentityId(
                &m->basic.compliancemanager_remove_default_trusted_claim_issuer.issuer,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8448: /* module 33 call 0 */
        ...
        case 0: /* voting_add_ballot - ticker */;
            return _toStringTicker(
                &m->basic.voting_add_ballot.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* voting_add_ballot - ballot_name */;
            return _toStringBytes(
                &m->basic.voting_add_ballot.ballot_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* voting_add_ballot - ballot_details */;
            return _toStringBallot(
                &m->basic.voting_add_ballot.ballot_details,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8449: /* module 33 call 1 */
        ...
        case 0: /* voting_vote - ticker */;
            return _toStringTicker(
                &m->basic.voting_vote.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* voting_vote - ballot_name */;
            return _toStringBytes(
                &m->basic.voting_vote.ballot_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* voting_vote - votes */;
            return _toStringVecBalance(
                &m->basic.voting_vote.votes,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8450: /* module 33 call 2 */
        ...
        case 0: /* voting_cancel_ballot - ticker */;
            return _toStringTicker(
                &m->basic.voting_cancel_ballot.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* voting_cancel_ballot - ballot_name */;
            return _toStringBytes(
                &m->basic.voting_cancel_ballot.ballot_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8704: /* module 34 call 0 */
        ...
        case 0: /* stocapped_launch_sto - ticker */;
            return _toStringTicker(
                &m->basic.stocapped_launch_sto.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stocapped_launch_sto - beneficiary_did */;
            return _toStringIdentityId(
                &m->basic.stocapped_launch_sto.beneficiary_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* stocapped_launch_sto - cap */;
            return _toStringBalance(
                &m->basic.stocapped_launch_sto.cap,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* stocapped_launch_sto - rate */;
            return _toStringu128(
                &m->basic.stocapped_launch_sto.rate,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* stocapped_launch_sto - start_date */;
            return _toStringMoment(
                &m->basic.stocapped_launch_sto.start_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* stocapped_launch_sto - end_date */;
            return _toStringMoment(
                &m->basic.stocapped_launch_sto.end_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8705: /* module 34 call 1 */
        ...
        case 0: /* stocapped_buy_tokens - ticker */;
            return _toStringTicker(
                &m->basic.stocapped_buy_tokens.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stocapped_buy_tokens - sto_id */;
            return _toStringu32(
                &m->basic.stocapped_buy_tokens.sto_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* stocapped_buy_tokens - value */;
            return _toStringBalance(
                &m->basic.stocapped_buy_tokens.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8706: /* module 34 call 2 */
        ...
        case 0: /* stocapped_pause_sto - ticker */;
            return _toStringTicker(
                &m->basic.stocapped_pause_sto.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stocapped_pause_sto - sto_id */;
            return _toStringu32(
                &m->basic.stocapped_pause_sto.sto_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8707: /* module 34 call 3 */
        ...
        case 0: /* stocapped_unpause_sto - ticker */;
            return _toStringTicker(
                &m->basic.stocapped_unpause_sto.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* stocapped_unpause_sto - sto_id */;
            return _toStringu32(
                &m->basic.stocapped_unpause_sto.sto_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8960: /* module 35 call 0 */
        ...
        case 0: /* exemption_modify_exemption_list - ticker */;
            return _toStringTicker(
                &m->basic.exemption_modify_exemption_list.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* exemption_modify_exemption_list - _tm */;
            return _toStringu16(
                &m->basic.exemption_modify_exemption_list._tm,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* exemption_modify_exemption_list - asset_holder_did */;
            return _toStringIdentityId(
                &m->basic.exemption_modify_exemption_list.asset_holder_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* exemption_modify_exemption_list - exempted */;
            return _toStringbool(
                &m->basic.exemption_modify_exemption_list.exempted,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9216: /* module 36 call 0 */
        ...
        case 0: /* settlement_create_venue - details */;
            return _toStringVenueDetails(
                &m->basic.settlement_create_venue.details,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_create_venue - signers */;
            return _toStringVecAccountId(
                &m->basic.settlement_create_venue.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_create_venue - venue_type */;
            return _toStringVenueType(
                &m->basic.settlement_create_venue.venue_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9219: /* module 36 call 3 */
        ...
        case 0: /* settlement_add_and_affirm_instruction - venue_id */;
            return _toStringu64(
                &m->basic.settlement_add_and_affirm_instruction.venue_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 2: /* settlement_add_and_affirm_instruction - valid_from */;
            return _toStringOptionMoment(
                &m->basic.settlement_add_and_affirm_instruction.valid_from,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* settlement_add_and_affirm_instruction - legs */;
            return _toStringVecLeg(
                &m->basic.settlement_add_and_affirm_instruction.legs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* settlement_add_and_affirm_instruction - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_add_and_affirm_instruction.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9220: /* module 36 call 4 */
        ...
        case 0: /* settlement_affirm_instruction - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_affirm_instruction.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_affirm_instruction - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_affirm_instruction.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9221: /* module 36 call 5 */
        ...
        case 0: /* settlement_withdraw_affirmation - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_withdraw_affirmation.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_withdraw_affirmation - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_withdraw_affirmation.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9222: /* module 36 call 6 */
        ...
        case 0: /* settlement_reject_instruction - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_reject_instruction.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_reject_instruction - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_reject_instruction.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9223: /* module 36 call 7 */
        ...
        case 0: /* settlement_affirm_with_receipts - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_affirm_with_receipts.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_affirm_with_receipts - receipt_details */;
            return _toStringVecReceiptDetails(
                &m->basic.settlement_affirm_with_receipts.receipt_details,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_affirm_with_receipts - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_affirm_with_receipts.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9224: /* module 36 call 8 */
        ...
        case 0: /* settlement_claim_receipt - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_claim_receipt.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_claim_receipt - receipt_details */;
            return _toStringReceiptDetails(
                &m->basic.settlement_claim_receipt.receipt_details,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9225: /* module 36 call 9 */
        ...
        case 0: /* settlement_unclaim_receipt - instruction_id */;
            return _toStringu64(
                &m->basic.settlement_unclaim_receipt.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_unclaim_receipt - leg_id */;
            return _toStringu64(
                &m->basic.settlement_unclaim_receipt.leg_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9226: /* module 36 call 10 */
        ...
        case 0: /* settlement_set_venue_filtering - ticker */;
            return _toStringTicker(
                &m->basic.settlement_set_venue_filtering.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_set_venue_filtering - enabled */;
            return _toStringbool(
                &m->basic.settlement_set_venue_filtering.enabled,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9227: /* module 36 call 11 */
        ...
        case 0: /* settlement_allow_venues - ticker */;
            return _toStringTicker(
                &m->basic.settlement_allow_venues.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_allow_venues - venues */;
            return _toStringVecu64(
                &m->basic.settlement_allow_venues.venues,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9228: /* module 36 call 12 */
        ...
        case 0: /* settlement_disallow_venues - ticker */;
            return _toStringTicker(
                &m->basic.settlement_disallow_venues.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_disallow_venues - venues */;
            return _toStringVecu64(
                &m->basic.settlement_disallow_venues.venues,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9472: /* module 37 call 0 */
        ...
        case 0: /* sto_create_fundraiser - offering_portfolio */;
            return _toStringPortfolioId(
                &m->basic.sto_create_fundraiser.offering_portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* sto_create_fundraiser - offering_asset */;
            return _toStringTicker(
                &m->basic.sto_create_fundraiser.offering_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* sto_create_fundraiser - raising_portfolio */;
            return _toStringPortfolioId(
                &m->basic.sto_create_fundraiser.raising_portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* sto_create_fundraiser - raising_asset */;
            return _toStringTicker(
                &m->basic.sto_create_fundraiser.raising_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* sto_create_fundraiser - tiers */;
            return _toStringVecPriceTier(
                &m->basic.sto_create_fundraiser.tiers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* sto_create_fundraiser - venue_id */;
            return _toStringu64(
                &m->basic.sto_create_fundraiser.venue_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* sto_create_fundraiser - start */;
            return _toStringOptionMoment(
                &m->basic.sto_create_fundraiser.start,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 7: /* sto_create_fundraiser - end */;
            return _toStringOptionMoment(
                &m->basic.sto_create_fundraiser.end,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9474: /* module 37 call 2 */
        ...
        case 0: /* sto_freeze_fundraiser - offering_asset */;
            return _toStringTicker(
                &m->basic.sto_freeze_fundraiser.offering_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* sto_freeze_fundraiser - fundraiser_id */;
            return _toStringu64(
                &m->basic.sto_freeze_fundraiser.fundraiser_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9475: /* module 37 call 3 */
        ...
        case 0: /* sto_unfreeze_fundraiser - offering_asset */;
            return _toStringTicker(
                &m->basic.sto_unfreeze_fundraiser.offering_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* sto_unfreeze_fundraiser - fundraiser_id */;
            return _toStringu64(
                &m->basic.sto_unfreeze_fundraiser.fundraiser_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9476: /* module 37 call 4 */
        ...
        case 0: /* sto_modify_fundraiser_window - offering_asset */;
            return _toStringTicker(
                &m->basic.sto_modify_fundraiser_window.offering_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* sto_modify_fundraiser_window - fundraiser_id */;
            return _toStringu64(
                &m->basic.sto_modify_fundraiser_window.fundraiser_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* sto_modify_fundraiser_window - start */;
            return _toStringMoment(
                &m->basic.sto_modify_fundraiser_window.start,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* sto_modify_fundraiser_window - end */;
            return _toStringOptionMoment(
                &m->basic.sto_modify_fundraiser_window.end,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9477: /* module 37 call 5 */
        ...
        case 0: /* sto_stop - offering_asset */;
            return _toStringTicker(
                &m->basic.sto_stop.offering_asset,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* sto_stop - fundraiser_id */;
            return _toStringu64(
                &m->basic.sto_stop.fundraiser_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9729: /* module 38 call 1 */
        ...
        case 0: /* cddserviceproviders_disable_member - who */;
            return _toStringIdentityId(
                &m->basic.cddserviceproviders_disable_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* cddserviceproviders_disable_member - expiry */;
            return _toStringOptionMoment(
                &m->basic.cddserviceproviders_disable_member.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* cddserviceproviders_disable_member - at */;
            return _toStringOptionMoment(
                &m->basic.cddserviceproviders_disable_member.at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9730: /* module 38 call 2 */
        ...
        case 0: /* cddserviceproviders_add_member - who */;
            return _toStringIdentityId(
                &m->basic.cddserviceproviders_add_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9731: /* module 38 call 3 */
        ...
        case 0: /* cddserviceproviders_remove_member - who */;
            return _toStringIdentityId(
                &m->basic.cddserviceproviders_remove_member.who,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9732: /* module 38 call 4 */
        ...
        case 0: /* cddserviceproviders_swap_member - remove */;
            return _toStringIdentityId(
                &m->basic.cddserviceproviders_swap_member.remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* cddserviceproviders_swap_member - add */;
            return _toStringIdentityId(
                &m->basic.cddserviceproviders_swap_member.add,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9733: /* module 38 call 5 */
        ...
        case 0: /* cddserviceproviders_reset_members - members */;
            return _toStringVecIdentityId(
                &m->basic.cddserviceproviders_reset_members.members,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10240: /* module 40 call 0 */
        ...
        case 0: /* protocolfee_change_coefficient - coefficient */;
            return _toStringPosRatio(
                &m->basic.protocolfee_change_coefficient.coefficient,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10241: /* module 40 call 1 */
        ...
        case 0: /* protocolfee_change_base_fee - op */;
            return _toStringProtocolOp(
                &m->basic.protocolfee_change_base_fee.op,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* protocolfee_change_base_fee - base_fee */;
            return _toStringBalanceOf(
                &m->basic.protocolfee_change_base_fee.base_fee,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10497: /* module 41 call 1 */
        ...
        case 0: /* utility_batch_atomic - calls */;
            return _toStringVecCall(
                &m->basic.utility_batch_atomic.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10498: /* module 41 call 2 */
        ...
        case 0: /* utility_batch_optimistic - calls */;
            return _toStringVecCall(
                &m->basic.utility_batch_optimistic.calls,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10752: /* module 42 call 0 */
        ...
        case 0: /* portfolio_create_portfolio - name */;
            return _toStringPortfolioName(
                &m->basic.portfolio_create_portfolio.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10753: /* module 42 call 1 */
        ...
        case 0: /* portfolio_delete_portfolio - num */;
            return _toStringPortfolioNumber(
                &m->basic.portfolio_delete_portfolio.num,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10754: /* module 42 call 2 */
        ...
        case 0: /* portfolio_move_portfolio_funds - from */;
            return _toStringPortfolioId(
                &m->basic.portfolio_move_portfolio_funds.from,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* portfolio_move_portfolio_funds - to */;
            return _toStringPortfolioId(
                &m->basic.portfolio_move_portfolio_funds.to,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* portfolio_move_portfolio_funds - items */;
            return _toStringVecMovePortfolioItem(
                &m->basic.portfolio_move_portfolio_funds.items,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 10755: /* module 42 call 3 */
        ...
        case 0: /* portfolio_rename_portfolio - num */;
            return _toStringPortfolioNumber(
                &m->basic.portfolio_rename_portfolio.num,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* portfolio_rename_portfolio - to_name */;
            return _toStringPortfolioName(
                &m->basic.portfolio_rename_portfolio.to_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11008: /* module 43 call 0 */
        ...
        case 0: /* confidential_add_range_proof - target_id */;
            return _toStringIdentityId(
                &m->basic.confidential_add_range_proof.target_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* confidential_add_range_proof - ticker */;
            return _toStringTicker(
                &m->basic.confidential_add_range_proof.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* confidential_add_range_proof - secret_value */;
            return _toStringu64(
                &m->basic.confidential_add_range_proof.secret_value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11009: /* module 43 call 1 */
        ...
        case 0: /* confidential_add_verify_range_proof - target */;
            return _toStringIdentityId(
                &m->basic.confidential_add_verify_range_proof.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* confidential_add_verify_range_proof - prover */;
            return _toStringIdentityId(
                &m->basic.confidential_add_verify_range_proof.prover,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* confidential_add_verify_range_proof - ticker */;
            return _toStringTicker(
                &m->basic.confidential_add_verify_range_proof.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11776: /* module 46 call 0 */
        ...
        case 0: /* corporateaction_set_max_details_length - length */;
            return _toStringu32(
                &m->basic.corporateaction_set_max_details_length.length,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11777: /* module 46 call 1 */
        ...
        case 0: /* corporateaction_reset_caa - ticker */;
            return _toStringTicker(
                &m->basic.corporateaction_reset_caa.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11778: /* module 46 call 2 */
        ...
        case 0: /* corporateaction_set_default_targets - ticker */;
            return _toStringTicker(
                &m->basic.corporateaction_set_default_targets.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_set_default_targets - targets */;
            return _toStringTargetIdentities(
                &m->basic.corporateaction_set_default_targets.targets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11779: /* module 46 call 3 */
        ...
        case 1: /* corporateaction_set_default_withholding_tax - tax */;
            return _toStringTax(
                &m->basic.corporateaction_set_default_withholding_tax.tax,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11780: /* module 46 call 4 */
        ...
        case 0: /* corporateaction_set_did_withholding_tax - ticker */;
            return _toStringTicker(
                &m->basic.corporateaction_set_did_withholding_tax.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_set_did_withholding_tax - taxed_did */;
            return _toStringIdentityId(
                &m->basic.corporateaction_set_did_withholding_tax.taxed_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* corporateaction_set_did_withholding_tax - tax */;
            return _toStringOptionTax(
                &m->basic.corporateaction_set_did_withholding_tax.tax,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11781: /* module 46 call 5 */
        ...
        case 0: /* corporateaction_initiate_corporate_action - ticker */;
            return _toStringTicker(
                &m->basic.corporateaction_initiate_corporate_action.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_initiate_corporate_action - kind */;
            return _toStringCAKind(
                &m->basic.corporateaction_initiate_corporate_action.kind,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* corporateaction_initiate_corporate_action - decl_date */;
            return _toStringMoment(
                &m->basic.corporateaction_initiate_corporate_action.decl_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* corporateaction_initiate_corporate_action - record_date */;
            return _toStringOptionRecordDateSpec(
                &m->basic.corporateaction_initiate_corporate_action.record_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* corporateaction_initiate_corporate_action - details */;
            return _toStringCADetails(
                &m->basic.corporateaction_initiate_corporate_action.details,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* corporateaction_initiate_corporate_action - targets */;
            return _toStringOptionTargetIdentities(
                &m->basic.corporateaction_initiate_corporate_action.targets,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* corporateaction_initiate_corporate_action - default_withholding_tax */;
            return _toStringOptionTax(
                &m->basic.corporateaction_initiate_corporate_action.default_withholding_tax,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 7: /* corporateaction_initiate_corporate_action - withholding_tax */;
    ...
    case 11782: /* module 46 call 6 */
        ...
        case 0: /* corporateaction_link_ca_doc - id */;
            return _toStringCAId(
                &m->basic.corporateaction_link_ca_doc.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_link_ca_doc - docs */;
            return _toStringVecDocumentId(
                &m->basic.corporateaction_link_ca_doc.docs,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11783: /* module 46 call 7 */
        ...
        case 0: /* corporateaction_remove_ca - ca_id */;
            return _toStringCAId(
                &m->basic.corporateaction_remove_ca.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11784: /* module 46 call 8 */
        ...
        case 0: /* corporateaction_change_record_date - ca_id */;
            return _toStringCAId(
                &m->basic.corporateaction_change_record_date.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_change_record_date - record_date */;
            return _toStringOptionRecordDateSpec(
                &m->basic.corporateaction_change_record_date.record_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12033: /* module 47 call 1 */
        ...
        case 0: /* corporateballot_vote - ca_id */;
            return _toStringCAId(
                &m->basic.corporateballot_vote.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateballot_vote - votes */;
            return _toStringVecBallotVote(
                &m->basic.corporateballot_vote.votes,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12034: /* module 47 call 2 */
        ...
        case 0: /* corporateballot_change_end - ca_id */;
            return _toStringCAId(
                &m->basic.corporateballot_change_end.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateballot_change_end - end */;
            return _toStringMoment(
                &m->basic.corporateballot_change_end.end,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12035: /* module 47 call 3 */
        ...
        case 0: /* corporateballot_change_meta - ca_id */;
            return _toStringCAId(
                &m->basic.corporateballot_change_meta.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateballot_change_meta - meta */;
            return _toStringBallotMeta(
                &m->basic.corporateballot_change_meta.meta,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12036: /* module 47 call 4 */
        ...
        case 0: /* corporateballot_change_rcv - ca_id */;
            return _toStringCAId(
                &m->basic.corporateballot_change_rcv.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateballot_change_rcv - rcv */;
            return _toStringbool(
                &m->basic.corporateballot_change_rcv.rcv,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12037: /* module 47 call 5 */
        ...
        case 0: /* corporateballot_remove_ballot - ca_id */;
            return _toStringCAId(
                &m->basic.corporateballot_remove_ballot.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12288: /* module 48 call 0 */
        ...
        case 0: /* capitaldistribution_distribute - ca_id */;
            return _toStringCAId(
                &m->basic.capitaldistribution_distribute.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* capitaldistribution_distribute - portfolio */;
            return _toStringOptionPortfolioNumber(
                &m->basic.capitaldistribution_distribute.portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* capitaldistribution_distribute - currency */;
            return _toStringTicker(
                &m->basic.capitaldistribution_distribute.currency,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* capitaldistribution_distribute - amount */;
            return _toStringBalance(
                &m->basic.capitaldistribution_distribute.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* capitaldistribution_distribute - payment_at */;
            return _toStringMoment(
                &m->basic.capitaldistribution_distribute.payment_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* capitaldistribution_distribute - expires_at */;
            return _toStringOptionMoment(
                &m->basic.capitaldistribution_distribute.expires_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12289: /* module 48 call 1 */
        ...
        case 0: /* capitaldistribution_claim - ca_id */;
            return _toStringCAId(
                &m->basic.capitaldistribution_claim.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12290: /* module 48 call 2 */
        ...
        case 0: /* capitaldistribution_push_benefit - ca_id */;
            return _toStringCAId(
                &m->basic.capitaldistribution_push_benefit.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* capitaldistribution_push_benefit - holder */;
            return _toStringIdentityId(
                &m->basic.capitaldistribution_push_benefit.holder,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12291: /* module 48 call 3 */
        ...
        case 0: /* capitaldistribution_reclaim - ca_id */;
            return _toStringCAId(
                &m->basic.capitaldistribution_reclaim.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12292: /* module 48 call 4 */
        ...
        case 0: /* capitaldistribution_remove_distribution - ca_id */;
            return _toStringCAId(
                &m->basic.capitaldistribution_remove_distribution.ca_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12544: /* module 49 call 0 */
        ...
        case 0: /* checkpoint_create_checkpoint - ticker */;
            return _toStringTicker(
                &m->basic.checkpoint_create_checkpoint.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12546: /* module 49 call 2 */
        ...
        case 0: /* checkpoint_create_schedule - ticker */;
            return _toStringTicker(
                &m->basic.checkpoint_create_schedule.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* checkpoint_create_schedule - schedule */;
            return _toStringScheduleSpec(
                &m->basic.checkpoint_create_schedule.schedule,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12547: /* module 49 call 3 */
        ...
        case 0: /* checkpoint_remove_schedule - ticker */;
            return _toStringTicker(
                &m->basic.checkpoint_remove_schedule.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* checkpoint_remove_schedule - id */;
            return _toStringScheduleId(
                &m->basic.checkpoint_remove_schedule.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
