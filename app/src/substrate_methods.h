...
typedef union {
    ...
    pd_balances_deposit_block_reward_reserve_balance_t balances_deposit_block_reward_reserve_balance;
    ...
    pd_staking_remove_permissioned_validator_t staking_remove_permissioned_validator;
    pd_staking_validate_cdd_expiry_nominators_t staking_validate_cdd_expiry_nominators;
    ...
    pd_multisig_accept_multisig_signer_as_identity_t multisig_accept_multisig_signer_as_identity;
    pd_multisig_accept_multisig_signer_as_key_t multisig_accept_multisig_signer_as_key;
    ...
    pd_multisig_add_multisig_signers_via_creator_t multisig_add_multisig_signers_via_creator;
    pd_multisig_remove_multisig_signers_via_creator_t multisig_remove_multisig_signers_via_creator;
    pd_multisig_change_sigs_required_t multisig_change_sigs_required;
    pd_multisig_change_all_signers_and_sigs_required_t multisig_change_all_signers_and_sigs_required;
    ...
    pd_contracts_transfer_template_ownership_t contracts_transfer_template_ownership;
    ...
    pd_polymeshcommittee_set_vote_threshold_t polymeshcommittee_set_vote_threshold;
    pd_polymeshcommittee_set_release_coordinator_t polymeshcommittee_set_release_coordinator;
    ...
    pd_committeemembership_set_active_members_limit_t committeemembership_set_active_members_limit;
    ...
    pd_committeemembership_abdicate_membership_t committeemembership_abdicate_membership;
    ...
    pd_technicalcommittee_set_vote_threshold_t technicalcommittee_set_vote_threshold;
    pd_technicalcommittee_set_release_coordinator_t technicalcommittee_set_release_coordinator;
    pd_technicalcommittee_set_expires_after_t technicalcommittee_set_expires_after;
    pd_technicalcommittee_close_t technicalcommittee_close;
    pd_technicalcommittee_vote_t technicalcommittee_vote;
    pd_technicalcommitteemembership_set_active_members_limit_t technicalcommitteemembership_set_active_members_limit;
    pd_technicalcommitteemembership_disable_member_t technicalcommitteemembership_disable_member;
    pd_technicalcommitteemembership_add_member_t technicalcommitteemembership_add_member;
    pd_technicalcommitteemembership_remove_member_t technicalcommitteemembership_remove_member;
    pd_technicalcommitteemembership_swap_member_t technicalcommitteemembership_swap_member;
    pd_technicalcommitteemembership_reset_members_t technicalcommitteemembership_reset_members;
    pd_technicalcommitteemembership_abdicate_membership_t technicalcommitteemembership_abdicate_membership;
    pd_upgradecommittee_set_vote_threshold_t upgradecommittee_set_vote_threshold;
    pd_upgradecommittee_set_release_coordinator_t upgradecommittee_set_release_coordinator;
    ...
    pd_upgradecommitteemembership_set_active_members_limit_t upgradecommitteemembership_set_active_members_limit;
    pd_upgradecommitteemembership_disable_member_t upgradecommitteemembership_disable_member;
    pd_upgradecommitteemembership_add_member_t upgradecommitteemembership_add_member;
    pd_upgradecommitteemembership_remove_member_t upgradecommitteemembership_remove_member;
    pd_upgradecommitteemembership_swap_member_t upgradecommitteemembership_swap_member;
    pd_upgradecommitteemembership_reset_members_t upgradecommitteemembership_reset_members;
    pd_upgradecommitteemembership_abdicate_membership_t upgradecommitteemembership_abdicate_membership;
    pd_asset_register_ticker_t asset_register_ticker;
    pd_asset_accept_ticker_transfer_t asset_accept_ticker_transfer;
    pd_asset_accept_primary_issuance_agent_transfer_t asset_accept_primary_issuance_agent_transfer;
    pd_asset_accept_asset_ownership_transfer_t asset_accept_asset_ownership_transfer;
    ...
    pd_identity_change_cdd_requirement_for_mk_rotation_t identity_change_cdd_requirement_for_mk_rotation;
    ...
    pd_identity_legacy_set_permission_to_signer_t identity_legacy_set_permission_to_signer;
    ...
    pd_identity_add_secondary_keys_with_authorization_t identity_add_secondary_keys_with_authorization;
    pd_identity_revoke_offchain_authorization_t identity_revoke_offchain_authorization;
    pd_identity_add_investor_uniqueness_claim_t identity_add_investor_uniqueness_claim;
    ...
    pd_compliancemanager_add_compliance_requirement_t compliancemanager_add_compliance_requirement;
    pd_compliancemanager_remove_compliance_requirement_t compliancemanager_remove_compliance_requirement;
    pd_compliancemanager_replace_asset_compliance_t compliancemanager_replace_asset_compliance;
    pd_compliancemanager_reset_asset_compliance_t compliancemanager_reset_asset_compliance;
    pd_compliancemanager_pause_asset_compliance_t compliancemanager_pause_asset_compliance;
    pd_compliancemanager_resume_asset_compliance_t compliancemanager_resume_asset_compliance;
    pd_compliancemanager_add_default_trusted_claim_issuer_t compliancemanager_add_default_trusted_claim_issuer;
    pd_compliancemanager_remove_default_trusted_claim_issuer_t compliancemanager_remove_default_trusted_claim_issuer;
    pd_compliancemanager_change_compliance_requirement_t compliancemanager_change_compliance_requirement;
    ...
    pd_settlement_add_and_affirm_instruction_t settlement_add_and_affirm_instruction;
    ...
    pd_settlement_execute_scheduled_instruction_t settlement_execute_scheduled_instruction;
    ...
    pd_cddserviceproviders_set_active_members_limit_t cddserviceproviders_set_active_members_limit;
    ...
    pd_cddserviceproviders_abdicate_membership_t cddserviceproviders_abdicate_membership;
    ...
    pd_corporateaction_set_max_details_length_t corporateaction_set_max_details_length;
    ...
    pd_corporateaction_set_default_withholding_tax_t corporateaction_set_default_withholding_tax;
    pd_corporateaction_set_did_withholding_tax_t corporateaction_set_did_withholding_tax;
    pd_corporateaction_initiate_corporate_action_t corporateaction_initiate_corporate_action;
    ...
    pd_capitaldistribution_remove_distribution_t capitaldistribution_remove_distribution;
    pd_checkpoint_create_checkpoint_t checkpoint_create_checkpoint;
    pd_checkpoint_set_schedules_max_complexity_t checkpoint_set_schedules_max_complexity;
...
typedef union {
    pd_multisig_create_or_approve_proposal_as_identity_t multisig_create_or_approve_proposal_as_identity;
    pd_multisig_create_or_approve_proposal_as_key_t multisig_create_or_approve_proposal_as_key;
    pd_multisig_create_proposal_as_identity_t multisig_create_proposal_as_identity;
