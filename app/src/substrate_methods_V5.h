...
#define PD_CALL_IDENTITY_V5 6
#define PD_CALL_AUTHORSHIP_V5 7
#define PD_CALL_STAKING_V5 8
#define PD_CALL_OFFENCES_V5 9
#define PD_CALL_SESSION_V5 10
#define PD_CALL_FINALITYTRACKER_V5 11
#define PD_CALL_GRANDPA_V5 12
#define PD_CALL_IMONLINE_V5 13
#define PD_CALL_AUTHORITYDISCOVERY_V5 14
#define PD_CALL_RANDOMNESSCOLLECTIVEFLIP_V5 15
#define PD_CALL_SUDO_V5 17
#define PD_CALL_MULTISIG_V5 18
#define PD_CALL_CONTRACTS_V5 20
#define PD_CALL_TREASURY_V5 21
#define PD_CALL_POLYMESHCOMMITTEE_V5 22
#define PD_CALL_COMMITTEEMEMBERSHIP_V5 23
#define PD_CALL_PIPS_V5 24
#define PD_CALL_TECHNICALCOMMITTEE_V5 25
#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_V5 26
#define PD_CALL_UPGRADECOMMITTEE_V5 27
#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_V5 28
#define PD_CALL_ASSET_V5 29
#define PD_CALL_BRIDGE_V5 31
#define PD_CALL_COMPLIANCEMANAGER_V5 32
#define PD_CALL_SETTLEMENT_V5 36
#define PD_CALL_STO_V5 37
#define PD_CALL_CDDSERVICEPROVIDERS_V5 38
#define PD_CALL_STATISTICS_V5 39
#define PD_CALL_PROTOCOLFEE_V5 40
#define PD_CALL_UTILITY_V5 41
#define PD_CALL_PORTFOLIO_V5 42
#define PD_CALL_SCHEDULER_V5 45
#define PD_CALL_CORPORATEACTION_V5 46
#define PD_CALL_CORPORATEBALLOT_V5 47
...
#define PD_CALL_STO_INVEST_V5 1
typedef struct {
...
#define PD_CALL_STO_FREEZE_FUNDRAISER_V5 2
typedef struct {
    pd_Ticker_V5_t offering_asset;
    pd_u64_t fundraiser_id;
} pd_sto_freeze_fundraiser_V5_t;

#define PD_CALL_STO_UNFREEZE_FUNDRAISER_V5 3
typedef struct {
    pd_Ticker_V5_t offering_asset;
    pd_u64_t fundraiser_id;
} pd_sto_unfreeze_fundraiser_V5_t;

#define PD_CALL_STO_MODIFY_FUNDRAISER_WINDOW_V5 4
typedef struct {
    pd_Ticker_V5_t offering_asset;
    pd_u64_t fundraiser_id;
...
#define PD_CALL_IDENTITY_REVOKE_CLAIM_V5 13
typedef struct {
    pd_IdentityId_V5_t target;
    pd_Claim_V5_t claim;
} pd_identity_revoke_claim_V5_t;

#define PD_CALL_IDENTITY_SET_PERMISSION_TO_SIGNER_V5 14
typedef struct {
    pd_Signatory_V5_t signer;
    pd_Permissions_V5_t permissions;
} pd_identity_set_permission_to_signer_V5_t;

#define PD_CALL_IDENTITY_LEGACY_SET_PERMISSION_TO_SIGNER_V5 15
typedef struct {
    pd_Signatory_V5_t signer;
    pd_LegacyPermissions_V5_t permissions;
} pd_identity_legacy_set_permission_to_signer_V5_t;

#define PD_CALL_IDENTITY_FREEZE_SECONDARY_KEYS_V5 16
typedef struct {
} pd_identity_freeze_secondary_keys_V5_t;

#define PD_CALL_IDENTITY_UNFREEZE_SECONDARY_KEYS_V5 17
typedef struct {
} pd_identity_unfreeze_secondary_keys_V5_t;

#define PD_CALL_IDENTITY_ADD_AUTHORIZATION_V5 20
typedef struct {
...
#define PD_CALL_IDENTITY_REMOVE_AUTHORIZATION_V5 21
typedef struct {
    pd_Signatory_V5_t target;
    pd_u64_t auth_id;
...
#define PD_CALL_IDENTITY_ACCEPT_AUTHORIZATION_V5 22
typedef struct {
    pd_u64_t auth_id;
} pd_identity_accept_authorization_V5_t;

#define PD_CALL_IDENTITY_ADD_SECONDARY_KEYS_WITH_AUTHORIZATION_V5 23
typedef struct {
...
#define PD_CALL_IDENTITY_ADD_INVESTOR_UNIQUENESS_CLAIM_V5 25
typedef struct {
    pd_IdentityId_V5_t target;
    pd_Claim_V5_t claim;
...
#define PD_CALL_STAKING_REBOND_V5 24
typedef struct {
    pd_CompactBalanceOf_t value;
} pd_staking_rebond_V5_t;

#define PD_CALL_MULTISIG_CREATE_MULTISIG_V5 0
typedef struct {
    pd_VecSignatory_V5_t signers;
    pd_u64_t sigs_required;
} pd_multisig_create_multisig_V5_t;

#define PD_CALL_MULTISIG_CREATE_OR_APPROVE_PROPOSAL_AS_IDENTITY_V5 1
typedef struct {
...
#define PD_CALL_MULTISIG_CREATE_OR_APPROVE_PROPOSAL_AS_KEY_V5 2
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_Proposal_t proposal;
    pd_OptionMoment_V5_t expiry;
...
#define PD_CALL_MULTISIG_CREATE_PROPOSAL_AS_IDENTITY_V5 3
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_Proposal_t proposal;
    pd_OptionMoment_V5_t expiry;
...
#define PD_CALL_MULTISIG_CREATE_PROPOSAL_AS_KEY_V5 4
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_Proposal_t proposal;
    pd_OptionMoment_V5_t expiry;
...
#define PD_CALL_MULTISIG_APPROVE_AS_IDENTITY_V5 5
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_u64_t proposal_id;
} pd_multisig_approve_as_identity_V5_t;

#define PD_CALL_MULTISIG_APPROVE_AS_KEY_V5 6
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_u64_t proposal_id;
} pd_multisig_approve_as_key_V5_t;

#define PD_CALL_MULTISIG_REJECT_AS_IDENTITY_V5 7
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_u64_t proposal_id;
} pd_multisig_reject_as_identity_V5_t;

#define PD_CALL_MULTISIG_REJECT_AS_KEY_V5 8
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_u64_t proposal_id;
} pd_multisig_reject_as_key_V5_t;

#define PD_CALL_MULTISIG_ACCEPT_MULTISIG_SIGNER_AS_IDENTITY_V5 9
typedef struct {
    pd_u64_t auth_id;
} pd_multisig_accept_multisig_signer_as_identity_V5_t;

#define PD_CALL_MULTISIG_ACCEPT_MULTISIG_SIGNER_AS_KEY_V5 10
typedef struct {
    pd_u64_t auth_id;
} pd_multisig_accept_multisig_signer_as_key_V5_t;

#define PD_CALL_MULTISIG_ADD_MULTISIG_SIGNER_V5 11
typedef struct {
    pd_Signatory_V5_t signer;
} pd_multisig_add_multisig_signer_V5_t;

#define PD_CALL_MULTISIG_REMOVE_MULTISIG_SIGNER_V5 12
typedef struct {
    pd_Signatory_V5_t signer;
} pd_multisig_remove_multisig_signer_V5_t;

#define PD_CALL_MULTISIG_ADD_MULTISIG_SIGNERS_VIA_CREATOR_V5 13
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_VecSignatory_V5_t signers;
} pd_multisig_add_multisig_signers_via_creator_V5_t;

#define PD_CALL_MULTISIG_REMOVE_MULTISIG_SIGNERS_VIA_CREATOR_V5 14
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_VecSignatory_V5_t signers;
} pd_multisig_remove_multisig_signers_via_creator_V5_t;

#define PD_CALL_MULTISIG_CHANGE_SIGS_REQUIRED_V5 15
typedef struct {
    pd_u64_t sigs_required;
} pd_multisig_change_sigs_required_V5_t;

#define PD_CALL_MULTISIG_MAKE_MULTISIG_SIGNER_V5 16
typedef struct {
    pd_AccountId_V5_t multisig;
} pd_multisig_make_multisig_signer_V5_t;

#define PD_CALL_MULTISIG_MAKE_MULTISIG_PRIMARY_V5 17
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_Optionu64_t optional_cdd_auth_id;
} pd_multisig_make_multisig_primary_V5_t;

#define PD_CALL_MULTISIG_EXECUTE_SCHEDULED_PROPOSAL_V5 18
typedef struct {
    pd_AccountId_V5_t multisig;
    pd_u64_t proposal_id;
...
#define PD_CALL_PIPS_PROPOSE_V5 6
typedef struct {
    pd_Proposal_t proposal;
...
#define PD_CALL_UTILITY_BATCH_ATOMIC_V5 1
typedef struct {
    pd_VecCall_t calls;
} pd_utility_batch_atomic_V5_t;

#define PD_CALL_UTILITY_BATCH_OPTIMISTIC_V5 2
typedef struct {
    pd_VecCall_t calls;
...
#define PD_CALL_BALANCES_SET_BALANCE_V5 3
typedef struct {
...
#define PD_CALL_BALANCES_FORCE_TRANSFER_V5 4
typedef struct {
...
#define PD_CALL_BALANCES_BURN_ACCOUNT_BALANCE_V5 5
typedef struct {
    pd_Balance_t amount;
} pd_balances_burn_account_balance_V5_t;

#define PD_CALL_IDENTITY_REGISTER_DID_V5 0
typedef struct {
    pd_InvestorUid_V5_t uid;
    pd_VecSecondaryKey_V5_t secondary_keys;
} pd_identity_register_did_V5_t;

#define PD_CALL_IDENTITY_CDD_REGISTER_DID_V5 1
typedef struct {
    pd_AccountId_V5_t target_account;
    pd_VecSecondaryKey_V5_t secondary_keys;
} pd_identity_cdd_register_did_V5_t;

#define PD_CALL_IDENTITY_MOCK_CDD_REGISTER_DID_V5 2
typedef struct {
    pd_AccountId_V5_t target_account;
} pd_identity_mock_cdd_register_did_V5_t;

#define PD_CALL_IDENTITY_INVALIDATE_CDD_CLAIMS_V5 3
typedef struct {
...
#define PD_CALL_IDENTITY_CHANGE_CDD_REQUIREMENT_FOR_MK_ROTATION_V5 6
typedef struct {
    pd_bool_t auth_required;
} pd_identity_change_cdd_requirement_for_mk_rotation_V5_t;

#define PD_CALL_IDENTITY_FORWARDED_CALL_V5 12
typedef struct {
    pd_IdentityId_V5_t target_did;
    pd_Proposal_t proposal;
} pd_identity_forwarded_call_V5_t;

#define PD_CALL_IDENTITY_GET_MY_DID_V5 18
typedef struct {
} pd_identity_get_my_did_V5_t;

#define PD_CALL_IDENTITY_GET_CDD_OF_V5 19
typedef struct {
    pd_AccountId_V5_t of;
} pd_identity_get_cdd_of_V5_t;

#define PD_CALL_IDENTITY_REVOKE_OFFCHAIN_AUTHORIZATION_V5 24
typedef struct {
    pd_Signatory_V5_t signer;
    pd_TargetIdAuthorization_V5_t auth;
} pd_identity_revoke_offchain_authorization_V5_t;

#define PD_CALL_IDENTITY_GC_ADD_CDD_CLAIM_V5 26
typedef struct {
    pd_IdentityId_V5_t target;
    pd_OptionMoment_V5_t expiry;
} pd_identity_gc_add_cdd_claim_V5_t;

#define PD_CALL_IDENTITY_GC_REVOKE_CDD_CLAIM_V5 27
typedef struct {
    pd_IdentityId_V5_t target;
...
#define PD_CALL_STAKING_SUBMIT_ELECTION_SOLUTION_UNSIGNED_V5 28
typedef struct {
    pd_VecValidatorIndex_V5_t winners;
    pd_CompactAssignments_V5_t compact;
    pd_ElectionScore_V5_t score;
...
#define PD_CALL_STAKING_PAYOUT_STAKERS_BY_SYSTEM_V5 29
typedef struct {
    pd_AccountId_V5_t validator_stash;
    pd_EraIndex_V5_t era;
} pd_staking_payout_stakers_by_system_V5_t;

#define PD_CALL_STAKING_CHANGE_SLASHING_ALLOWED_FOR_V5 30
typedef struct {
    pd_SlashingSwitch_V5_t slashing_switch;
} pd_staking_change_slashing_allowed_for_V5_t;

#define PD_CALL_STAKING_UPDATE_PERMISSIONED_VALIDATOR_INTENDED_COUNT_V5 31
typedef struct {
    pd_IdentityId_V5_t identity;
...
#define PD_CALL_IMONLINE_SET_SLASHING_PARAMS_V5 1
typedef struct {
    pd_OfflineSlashingParams_V5_t params;
} pd_imonline_set_slashing_params_V5_t;

#define PD_CALL_SUDO_SUDO_V5 0
typedef struct {
    pd_Call_t call;
} pd_sudo_sudo_V5_t;

#define PD_CALL_SUDO_SUDO_UNCHECKED_WEIGHT_V5 1
typedef struct {
    pd_Call_t call;
    pd_Weight_V5_t _weight;
} pd_sudo_sudo_unchecked_weight_V5_t;

#define PD_CALL_SUDO_SET_KEY_V5 2
typedef struct {
    pd_LookupSource_V5_t new_;
} pd_sudo_set_key_V5_t;

#define PD_CALL_SUDO_SUDO_AS_V5 3
typedef struct {
    pd_LookupSource_V5_t who;
    pd_Call_t call;
} pd_sudo_sudo_as_V5_t;

#define PD_CALL_CONTRACTS_UPDATE_SCHEDULE_V5 0
typedef struct {
    pd_Schedule_V5_t schedule;
} pd_contracts_update_schedule_V5_t;

#define PD_CALL_CONTRACTS_PUT_CODE_V5 1
typedef struct {
...
#define PD_CALL_CONTRACTS_CALL_V5 2
typedef struct {
    pd_LookupSource_V5_t dest;
    pd_CompactBalanceOf_t value;
...
#define PD_CALL_CONTRACTS_INSTANTIATE_V5 3
typedef struct {
...
#define PD_CALL_CONTRACTS_FREEZE_INSTANTIATION_V5 4
typedef struct {
    pd_CodeHash_V5_t code_hash;
} pd_contracts_freeze_instantiation_V5_t;

#define PD_CALL_CONTRACTS_UNFREEZE_INSTANTIATION_V5 5
typedef struct {
    pd_CodeHash_V5_t code_hash;
} pd_contracts_unfreeze_instantiation_V5_t;

#define PD_CALL_CONTRACTS_TRANSFER_TEMPLATE_OWNERSHIP_V5 6
typedef struct {
    pd_CodeHash_V5_t code_hash;
    pd_IdentityId_V5_t new_owner;
} pd_contracts_transfer_template_ownership_V5_t;

#define PD_CALL_CONTRACTS_CHANGE_TEMPLATE_FEES_V5 7
typedef struct {
    pd_CodeHash_V5_t code_hash;
...
#define PD_CALL_COMMITTEEMEMBERSHIP_SET_ACTIVE_MEMBERS_LIMIT_V5 0
typedef struct {
    pd_MemberCount_V5_t limit;
} pd_committeemembership_set_active_members_limit_V5_t;

#define PD_CALL_COMMITTEEMEMBERSHIP_DISABLE_MEMBER_V5 1
typedef struct {
...
#define PD_CALL_COMMITTEEMEMBERSHIP_ADD_MEMBER_V5 2
typedef struct {
    pd_IdentityId_V5_t who;
} pd_committeemembership_add_member_V5_t;

#define PD_CALL_COMMITTEEMEMBERSHIP_REMOVE_MEMBER_V5 3
typedef struct {
    pd_IdentityId_V5_t who;
} pd_committeemembership_remove_member_V5_t;

#define PD_CALL_COMMITTEEMEMBERSHIP_SWAP_MEMBER_V5 4
typedef struct {
    pd_IdentityId_V5_t remove;
    pd_IdentityId_V5_t add;
} pd_committeemembership_swap_member_V5_t;

#define PD_CALL_COMMITTEEMEMBERSHIP_RESET_MEMBERS_V5 5
typedef struct {
    pd_VecIdentityId_V5_t members;
} pd_committeemembership_reset_members_V5_t;

#define PD_CALL_COMMITTEEMEMBERSHIP_ABDICATE_MEMBERSHIP_V5 6
typedef struct {
} pd_committeemembership_abdicate_membership_V5_t;

#define PD_CALL_PIPS_SET_PRUNE_HISTORICAL_PIPS_V5 0
typedef struct {
    pd_bool_t prune;
} pd_pips_set_prune_historical_pips_V5_t;

#define PD_CALL_PIPS_SET_MIN_PROPOSAL_DEPOSIT_V5 1
typedef struct {
    pd_BalanceOf_t deposit;
} pd_pips_set_min_proposal_deposit_V5_t;

#define PD_CALL_PIPS_SET_DEFAULT_ENACTMENT_PERIOD_V5 2
typedef struct {
    pd_BlockNumber_t duration;
} pd_pips_set_default_enactment_period_V5_t;

#define PD_CALL_PIPS_SET_PENDING_PIP_EXPIRY_V5 3
typedef struct {
    pd_MaybeBlock_V5_t expiry;
} pd_pips_set_pending_pip_expiry_V5_t;

#define PD_CALL_PIPS_SET_MAX_PIP_SKIP_COUNT_V5 4
typedef struct {
    pd_SkippedCount_V5_t max;
} pd_pips_set_max_pip_skip_count_V5_t;

#define PD_CALL_PIPS_SET_ACTIVE_PIP_LIMIT_V5 5
typedef struct {
    pd_u32_t limit;
} pd_pips_set_active_pip_limit_V5_t;

#define PD_CALL_PIPS_APPROVE_COMMITTEE_PROPOSAL_V5 8
typedef struct {
    pd_PipId_V5_t id;
} pd_pips_approve_committee_proposal_V5_t;

#define PD_CALL_PIPS_REJECT_PROPOSAL_V5 9
typedef struct {
    pd_PipId_V5_t id;
} pd_pips_reject_proposal_V5_t;

#define PD_CALL_PIPS_PRUNE_PROPOSAL_V5 10
typedef struct {
    pd_PipId_V5_t id;
} pd_pips_prune_proposal_V5_t;

#define PD_CALL_PIPS_RESCHEDULE_EXECUTION_V5 11
typedef struct {
    pd_PipId_V5_t id;
    pd_OptionBlockNumber_t until;
} pd_pips_reschedule_execution_V5_t;

#define PD_CALL_PIPS_CLEAR_SNAPSHOT_V5 12
typedef struct {
} pd_pips_clear_snapshot_V5_t;

#define PD_CALL_PIPS_SNAPSHOT_V5 13
typedef struct {
} pd_pips_snapshot_V5_t;

#define PD_CALL_PIPS_ENACT_SNAPSHOT_RESULTS_V5 14
typedef struct {
    pd_VecTuplePipIdSnapshotResult_V5_t results;
} pd_pips_enact_snapshot_results_V5_t;

#define PD_CALL_PIPS_EXECUTE_SCHEDULED_PIP_V5 15
typedef struct {
    pd_PipId_V5_t id;
} pd_pips_execute_scheduled_pip_V5_t;

#define PD_CALL_PIPS_EXPIRE_SCHEDULED_PIP_V5 16
typedef struct {
    pd_IdentityId_V5_t did;
    pd_PipId_V5_t id;
} pd_pips_expire_scheduled_pip_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_SET_VOTE_THRESHOLD_V5 0
typedef struct {
    pd_u32_t n;
    pd_u32_t d;
} pd_technicalcommittee_set_vote_threshold_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_SET_RELEASE_COORDINATOR_V5 1
typedef struct {
    pd_IdentityId_V5_t id;
} pd_technicalcommittee_set_release_coordinator_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_SET_EXPIRES_AFTER_V5 2
typedef struct {
    pd_MaybeBlock_V5_t expiry;
} pd_technicalcommittee_set_expires_after_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_CLOSE_V5 3
typedef struct {
    pd_Hash_t proposal;
    pd_CompactProposalIndex_V5_t index;
} pd_technicalcommittee_close_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_VOTE_OR_PROPOSE_V5 4
typedef struct {
    pd_bool_t approve;
    pd_Proposal_t call;
} pd_technicalcommittee_vote_or_propose_V5_t;

#define PD_CALL_TECHNICALCOMMITTEE_VOTE_V5 5
typedef struct {
    pd_Hash_t proposal;
    pd_ProposalIndex_V5_t index;
    pd_bool_t approve;
...
#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_SET_ACTIVE_MEMBERS_LIMIT_V5 0
typedef struct {
    pd_MemberCount_V5_t limit;
} pd_technicalcommitteemembership_set_active_members_limit_V5_t;

#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_DISABLE_MEMBER_V5 1
typedef struct {
    pd_IdentityId_V5_t who;
    pd_OptionMoment_V5_t expiry;
    pd_OptionMoment_V5_t at;
...
#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_ADD_MEMBER_V5 2
typedef struct {
    pd_IdentityId_V5_t who;
} pd_technicalcommitteemembership_add_member_V5_t;

#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_REMOVE_MEMBER_V5 3
typedef struct {
    pd_IdentityId_V5_t who;
} pd_technicalcommitteemembership_remove_member_V5_t;

#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_SWAP_MEMBER_V5 4
typedef struct {
    pd_IdentityId_V5_t remove;
    pd_IdentityId_V5_t add;
} pd_technicalcommitteemembership_swap_member_V5_t;

#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_RESET_MEMBERS_V5 5
typedef struct {
    pd_VecIdentityId_V5_t members;
} pd_technicalcommitteemembership_reset_members_V5_t;

#define PD_CALL_TECHNICALCOMMITTEEMEMBERSHIP_ABDICATE_MEMBERSHIP_V5 6
typedef struct {
} pd_technicalcommitteemembership_abdicate_membership_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_SET_VOTE_THRESHOLD_V5 0
typedef struct {
    pd_u32_t n;
    pd_u32_t d;
} pd_upgradecommittee_set_vote_threshold_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_SET_RELEASE_COORDINATOR_V5 1
typedef struct {
    pd_IdentityId_V5_t id;
} pd_upgradecommittee_set_release_coordinator_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_SET_EXPIRES_AFTER_V5 2
typedef struct {
    pd_MaybeBlock_V5_t expiry;
} pd_upgradecommittee_set_expires_after_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_CLOSE_V5 3
typedef struct {
    pd_Hash_t proposal;
    pd_CompactProposalIndex_V5_t index;
} pd_upgradecommittee_close_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_VOTE_OR_PROPOSE_V5 4
typedef struct {
    pd_bool_t approve;
    pd_Proposal_t call;
} pd_upgradecommittee_vote_or_propose_V5_t;

#define PD_CALL_UPGRADECOMMITTEE_VOTE_V5 5
typedef struct {
    pd_Hash_t proposal;
    pd_ProposalIndex_V5_t index;
    pd_bool_t approve;
...
#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_SET_ACTIVE_MEMBERS_LIMIT_V5 0
typedef struct {
    pd_MemberCount_V5_t limit;
} pd_upgradecommitteemembership_set_active_members_limit_V5_t;

#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_DISABLE_MEMBER_V5 1
typedef struct {
    pd_IdentityId_V5_t who;
    pd_OptionMoment_V5_t expiry;
    pd_OptionMoment_V5_t at;
...
#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_ADD_MEMBER_V5 2
typedef struct {
    pd_IdentityId_V5_t who;
} pd_upgradecommitteemembership_add_member_V5_t;

#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_REMOVE_MEMBER_V5 3
typedef struct {
    pd_IdentityId_V5_t who;
} pd_upgradecommitteemembership_remove_member_V5_t;

#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_SWAP_MEMBER_V5 4
typedef struct {
    pd_IdentityId_V5_t remove;
    pd_IdentityId_V5_t add;
} pd_upgradecommitteemembership_swap_member_V5_t;

#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_RESET_MEMBERS_V5 5
typedef struct {
    pd_VecIdentityId_V5_t members;
} pd_upgradecommitteemembership_reset_members_V5_t;

#define PD_CALL_UPGRADECOMMITTEEMEMBERSHIP_ABDICATE_MEMBERSHIP_V5 6
typedef struct {
} pd_upgradecommitteemembership_abdicate_membership_V5_t;

#define PD_CALL_ASSET_REGISTER_TICKER_V5 0
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_asset_register_ticker_V5_t;

#define PD_CALL_ASSET_ACCEPT_TICKER_TRANSFER_V5 1
typedef struct {
    pd_u64_t auth_id;
} pd_asset_accept_ticker_transfer_V5_t;

#define PD_CALL_ASSET_ACCEPT_PRIMARY_ISSUANCE_AGENT_TRANSFER_V5 2
typedef struct {
    pd_u64_t auth_id;
} pd_asset_accept_primary_issuance_agent_transfer_V5_t;

#define PD_CALL_ASSET_ACCEPT_ASSET_OWNERSHIP_TRANSFER_V5 3
typedef struct {
    pd_u64_t auth_id;
} pd_asset_accept_asset_ownership_transfer_V5_t;

#define PD_CALL_ASSET_CREATE_ASSET_V5 4
typedef struct {
...
#define PD_CALL_ASSET_FREEZE_V5 5
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_asset_freeze_V5_t;

#define PD_CALL_ASSET_UNFREEZE_V5 6
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_asset_unfreeze_V5_t;

#define PD_CALL_ASSET_RENAME_ASSET_V5 7
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_AssetName_V5_t name;
...
#define PD_CALL_BRIDGE_CHANGE_CONTROLLER_V5 0
typedef struct {
    pd_AccountId_V5_t controller;
} pd_bridge_change_controller_V5_t;

#define PD_CALL_BRIDGE_CHANGE_ADMIN_V5 1
typedef struct {
    pd_AccountId_V5_t admin;
} pd_bridge_change_admin_V5_t;

#define PD_CALL_BRIDGE_CHANGE_TIMELOCK_V5 2
typedef struct {
    pd_BlockNumber_t timelock;
} pd_bridge_change_timelock_V5_t;

#define PD_CALL_BRIDGE_FREEZE_V5 3
typedef struct {
} pd_bridge_freeze_V5_t;

#define PD_CALL_BRIDGE_UNFREEZE_V5 4
typedef struct {
} pd_bridge_unfreeze_V5_t;

#define PD_CALL_BRIDGE_CHANGE_BRIDGE_LIMIT_V5 5
typedef struct {
    pd_Balance_t amount;
    pd_BlockNumber_t duration;
} pd_bridge_change_bridge_limit_V5_t;

#define PD_CALL_BRIDGE_CHANGE_BRIDGE_EXEMPTED_V5 6
typedef struct {
    pd_VecTupleIdentityIdbool_V5_t exempted;
} pd_bridge_change_bridge_exempted_V5_t;

#define PD_CALL_BRIDGE_FORCE_HANDLE_BRIDGE_TX_V5 7
typedef struct {
    pd_BridgeTx_V5_t bridge_tx;
} pd_bridge_force_handle_bridge_tx_V5_t;

#define PD_CALL_BRIDGE_BATCH_PROPOSE_BRIDGE_TX_V5 8
typedef struct {
    pd_VecBridgeTx_V5_t bridge_txs;
} pd_bridge_batch_propose_bridge_tx_V5_t;

#define PD_CALL_BRIDGE_PROPOSE_BRIDGE_TX_V5 9
typedef struct {
    pd_BridgeTx_V5_t bridge_tx;
} pd_bridge_propose_bridge_tx_V5_t;

#define PD_CALL_BRIDGE_HANDLE_BRIDGE_TX_V5 10
typedef struct {
    pd_BridgeTx_V5_t bridge_tx;
} pd_bridge_handle_bridge_tx_V5_t;

#define PD_CALL_BRIDGE_FREEZE_TXS_V5 11
typedef struct {
    pd_VecBridgeTx_V5_t bridge_txs;
} pd_bridge_freeze_txs_V5_t;

#define PD_CALL_BRIDGE_UNFREEZE_TXS_V5 12
typedef struct {
    pd_VecBridgeTx_V5_t bridge_txs;
} pd_bridge_unfreeze_txs_V5_t;

#define PD_CALL_BRIDGE_HANDLE_SCHEDULED_BRIDGE_TX_V5 13
typedef struct {
    pd_BridgeTx_V5_t bridge_tx;
} pd_bridge_handle_scheduled_bridge_tx_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_ADD_COMPLIANCE_REQUIREMENT_V5 0
typedef struct {
    pd_Ticker_V5_t ticker;
...
#define PD_CALL_COMPLIANCEMANAGER_REMOVE_COMPLIANCE_REQUIREMENT_V5 1
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_u32_t id;
} pd_compliancemanager_remove_compliance_requirement_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_REPLACE_ASSET_COMPLIANCE_V5 2
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_VecComplianceRequirement_V5_t asset_compliance;
} pd_compliancemanager_replace_asset_compliance_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_RESET_ASSET_COMPLIANCE_V5 3
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_compliancemanager_reset_asset_compliance_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_PAUSE_ASSET_COMPLIANCE_V5 4
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_compliancemanager_pause_asset_compliance_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_RESUME_ASSET_COMPLIANCE_V5 5
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_compliancemanager_resume_asset_compliance_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_ADD_DEFAULT_TRUSTED_CLAIM_ISSUER_V5 6
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TrustedIssuer_V5_t issuer;
} pd_compliancemanager_add_default_trusted_claim_issuer_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_REMOVE_DEFAULT_TRUSTED_CLAIM_ISSUER_V5 7
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_IdentityId_V5_t issuer;
} pd_compliancemanager_remove_default_trusted_claim_issuer_V5_t;

#define PD_CALL_COMPLIANCEMANAGER_CHANGE_COMPLIANCE_REQUIREMENT_V5 8
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_ComplianceRequirement_V5_t new_req;
} pd_compliancemanager_change_compliance_requirement_V5_t;

#define PD_CALL_SETTLEMENT_CREATE_VENUE_V5 0
typedef struct {
...
#define PD_CALL_SETTLEMENT_UPDATE_VENUE_V5 1
typedef struct {
    pd_u64_t venue_id;
...
#define PD_CALL_SETTLEMENT_ADD_INSTRUCTION_V5 2
typedef struct {
    pd_u64_t venue_id;
...
#define PD_CALL_SETTLEMENT_ADD_AND_AFFIRM_INSTRUCTION_V5 3
typedef struct {
    pd_u64_t venue_id;
    pd_SettlementType_V5_t settlement_type;
    pd_OptionMoment_V5_t trade_date;
...
#define PD_CALL_SETTLEMENT_AFFIRM_INSTRUCTION_V5 4
typedef struct {
    pd_u64_t instruction_id;
    pd_VecPortfolioId_V5_t portfolios;
} pd_settlement_affirm_instruction_V5_t;

#define PD_CALL_SETTLEMENT_WITHDRAW_AFFIRMATION_V5 5
typedef struct {
    pd_u64_t instruction_id;
    pd_VecPortfolioId_V5_t portfolios;
} pd_settlement_withdraw_affirmation_V5_t;

#define PD_CALL_SETTLEMENT_REJECT_INSTRUCTION_V5 6
typedef struct {
    pd_u64_t instruction_id;
    pd_VecPortfolioId_V5_t portfolios;
} pd_settlement_reject_instruction_V5_t;

#define PD_CALL_SETTLEMENT_AFFIRM_WITH_RECEIPTS_V5 7
typedef struct {
    pd_u64_t instruction_id;
...
#define PD_CALL_SETTLEMENT_CLAIM_RECEIPT_V5 8
typedef struct {
    pd_u64_t instruction_id;
    pd_ReceiptDetails_V5_t receipt_details;
} pd_settlement_claim_receipt_V5_t;

#define PD_CALL_SETTLEMENT_UNCLAIM_RECEIPT_V5 9
typedef struct {
    pd_u64_t instruction_id;
    pd_u64_t leg_id;
} pd_settlement_unclaim_receipt_V5_t;

#define PD_CALL_SETTLEMENT_SET_VENUE_FILTERING_V5 10
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_bool_t enabled;
} pd_settlement_set_venue_filtering_V5_t;

#define PD_CALL_SETTLEMENT_ALLOW_VENUES_V5 11
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_Vecu64_t venues;
} pd_settlement_allow_venues_V5_t;

#define PD_CALL_SETTLEMENT_DISALLOW_VENUES_V5 12
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_Vecu64_t venues;
} pd_settlement_disallow_venues_V5_t;

#define PD_CALL_SETTLEMENT_EXECUTE_SCHEDULED_INSTRUCTION_V5 13
typedef struct {
    pd_u64_t instruction_id;
} pd_settlement_execute_scheduled_instruction_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_SET_ACTIVE_MEMBERS_LIMIT_V5 0
typedef struct {
    pd_MemberCount_V5_t limit;
} pd_cddserviceproviders_set_active_members_limit_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_DISABLE_MEMBER_V5 1
typedef struct {
    pd_IdentityId_V5_t who;
    pd_OptionMoment_V5_t expiry;
    pd_OptionMoment_V5_t at;
...
#define PD_CALL_CDDSERVICEPROVIDERS_ADD_MEMBER_V5 2
typedef struct {
    pd_IdentityId_V5_t who;
} pd_cddserviceproviders_add_member_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_REMOVE_MEMBER_V5 3
typedef struct {
    pd_IdentityId_V5_t who;
} pd_cddserviceproviders_remove_member_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_SWAP_MEMBER_V5 4
typedef struct {
    pd_IdentityId_V5_t remove;
    pd_IdentityId_V5_t add;
} pd_cddserviceproviders_swap_member_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_RESET_MEMBERS_V5 5
typedef struct {
    pd_VecIdentityId_V5_t members;
} pd_cddserviceproviders_reset_members_V5_t;

#define PD_CALL_CDDSERVICEPROVIDERS_ABDICATE_MEMBERSHIP_V5 6
typedef struct {
} pd_cddserviceproviders_abdicate_membership_V5_t;

#define PD_CALL_STATISTICS_ADD_TRANSFER_MANAGER_V5 0
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TransferManager_V5_t new_transfer_manager;
} pd_statistics_add_transfer_manager_V5_t;

#define PD_CALL_STATISTICS_REMOVE_TRANSFER_MANAGER_V5 1
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TransferManager_V5_t transfer_manager;
} pd_statistics_remove_transfer_manager_V5_t;

#define PD_CALL_STATISTICS_ADD_EXEMPTED_ENTITIES_V5 2
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TransferManager_V5_t transfer_manager;
...
#define PD_CALL_STATISTICS_REMOVE_EXEMPTED_ENTITIES_V5 3
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TransferManager_V5_t transfer_manager;
...
#define PD_CALL_PORTFOLIO_CREATE_PORTFOLIO_V5 0
typedef struct {
    pd_PortfolioName_V5_t name;
} pd_portfolio_create_portfolio_V5_t;

#define PD_CALL_PORTFOLIO_DELETE_PORTFOLIO_V5 1
typedef struct {
    pd_PortfolioNumber_V5_t num;
} pd_portfolio_delete_portfolio_V5_t;

#define PD_CALL_PORTFOLIO_MOVE_PORTFOLIO_FUNDS_V5 2
typedef struct {
...
#define PD_CALL_PORTFOLIO_RENAME_PORTFOLIO_V5 3
typedef struct {
    pd_PortfolioNumber_V5_t num;
...
#define PD_CALL_CORPORATEACTION_SET_MAX_DETAILS_LENGTH_V5 0
typedef struct {
    pd_u32_t length;
} pd_corporateaction_set_max_details_length_V5_t;

#define PD_CALL_CORPORATEACTION_RESET_CAA_V5 1
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_corporateaction_reset_caa_V5_t;

#define PD_CALL_CORPORATEACTION_SET_DEFAULT_TARGETS_V5 2
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_TargetIdentities_V5_t targets;
} pd_corporateaction_set_default_targets_V5_t;

#define PD_CALL_CORPORATEACTION_SET_DEFAULT_WITHHOLDING_TAX_V5 3
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_Tax_V5_t tax;
} pd_corporateaction_set_default_withholding_tax_V5_t;

#define PD_CALL_CORPORATEACTION_SET_DID_WITHHOLDING_TAX_V5 4
typedef struct {
    pd_Ticker_V5_t ticker;
...
#define PD_CALL_CORPORATEACTION_INITIATE_CORPORATE_ACTION_V5 5
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_CAKind_V5_t kind;
...
#define PD_CALL_CORPORATEACTION_LINK_CA_DOC_V5 6
typedef struct {
    pd_CAId_V5_t id;
    pd_VecDocumentId_V5_t docs;
} pd_corporateaction_link_ca_doc_V5_t;

#define PD_CALL_CORPORATEACTION_REMOVE_CA_V5 7
typedef struct {
    pd_CAId_V5_t ca_id;
} pd_corporateaction_remove_ca_V5_t;

#define PD_CALL_CORPORATEACTION_CHANGE_RECORD_DATE_V5 8
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_OptionRecordDateSpec_V5_t record_date;
} pd_corporateaction_change_record_date_V5_t;

#define PD_CALL_CORPORATEBALLOT_ATTACH_BALLOT_V5 0
typedef struct {
    pd_CAId_V5_t ca_id;
...
#define PD_CALL_CORPORATEBALLOT_VOTE_V5 1
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_VecBallotVote_V5_t votes;
} pd_corporateballot_vote_V5_t;

#define PD_CALL_CORPORATEBALLOT_CHANGE_END_V5 2
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_Moment_V5_t end;
} pd_corporateballot_change_end_V5_t;

#define PD_CALL_CORPORATEBALLOT_CHANGE_META_V5 3
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_BallotMeta_V5_t meta;
} pd_corporateballot_change_meta_V5_t;

#define PD_CALL_CORPORATEBALLOT_CHANGE_RCV_V5 4
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_bool_t rcv;
} pd_corporateballot_change_rcv_V5_t;

#define PD_CALL_CORPORATEBALLOT_REMOVE_BALLOT_V5 5
typedef struct {
    pd_CAId_V5_t ca_id;
} pd_corporateballot_remove_ballot_V5_t;

#define PD_CALL_CAPITALDISTRIBUTION_DISTRIBUTE_V5 0
typedef struct {
    pd_CAId_V5_t ca_id;
...
#define PD_CALL_CAPITALDISTRIBUTION_CLAIM_V5 1
typedef struct {
    pd_CAId_V5_t ca_id;
} pd_capitaldistribution_claim_V5_t;

#define PD_CALL_CAPITALDISTRIBUTION_PUSH_BENEFIT_V5 2
typedef struct {
    pd_CAId_V5_t ca_id;
    pd_IdentityId_V5_t holder;
} pd_capitaldistribution_push_benefit_V5_t;

#define PD_CALL_CAPITALDISTRIBUTION_RECLAIM_V5 3
typedef struct {
    pd_CAId_V5_t ca_id;
} pd_capitaldistribution_reclaim_V5_t;

#define PD_CALL_CAPITALDISTRIBUTION_REMOVE_DISTRIBUTION_V5 4
typedef struct {
    pd_CAId_V5_t ca_id;
} pd_capitaldistribution_remove_distribution_V5_t;

#define PD_CALL_CHECKPOINT_CREATE_CHECKPOINT_V5 0
typedef struct {
    pd_Ticker_V5_t ticker;
} pd_checkpoint_create_checkpoint_V5_t;

#define PD_CALL_CHECKPOINT_SET_SCHEDULES_MAX_COMPLEXITY_V5 1
typedef struct {
    pd_u64_t max_complexity;
} pd_checkpoint_set_schedules_max_complexity_V5_t;

#define PD_CALL_CHECKPOINT_CREATE_SCHEDULE_V5 2
typedef struct {
    pd_Ticker_V5_t ticker;
    pd_ScheduleSpec_V5_t schedule;
} pd_checkpoint_create_schedule_V5_t;

#define PD_CALL_CHECKPOINT_REMOVE_SCHEDULE_V5 3
typedef struct {
    pd_Ticker_V5_t ticker;
