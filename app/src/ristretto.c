...
unsigned char const ED25519_GEN[ED25519_SDKPOINT_BYTES] = {
    ...
    0x04,
    // x
    0x21, 0x69, 0x36, 0xd3, 0xcd, 0x6e, 0x53, 0xfe, 0xc0, 0xa4, 0xe2, 0x31, 0xfd, 0xd6, 0xdc, 0x5c, 0x69, 0x2c, 0xc7, 0x60,
    0x95, 0x25, 0xa7, 0xb2, 0xc9, 0x56, 0x2d, 0x60, 0x8f, 0x25, 0xd5, 0x1a,
    // y
    0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
    0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x58};
...
const fe25519_sdk fe25519_sqrtm1_sdk = {0x2b, 0x83, 0x24, 0x80, 0x4f, 0xc1, 0xdf, 0x0b, 0x2b, 0x4d, 0x00,
                                        0x99, 0x3d, 0xfb, 0xd7, 0xa7, 0x2f, 0x43, 0x18, 0x06, 0xad, 0x2f,
                                        0xe4, 0x78, 0xc4, 0xee, 0x1b, 0x27, 0x4a, 0x0e, 0xa0, 0xb0};

const fe25519_sdk ed25519_invsqrtamd_sdk = {0x78, 0x6c, 0x89, 0x05, 0xcf, 0xaf, 0xfc, 0xa2, 0x16, 0xc2, 0x7b,
                                            0x91, 0xfe, 0x01, 0xd8, 0x40, 0x9d, 0x2f, 0x16, 0x17, 0x5a, 0x41,
                                            0x72, 0xbe, 0x99, 0xc8, 0xfd, 0xaa, 0x80, 0x5d, 0x40, 0xea};
...
int fe25519_iszero_sdk(fe25519_sdk h) { return cx_math_is_zero(h, ED25519_SCALAR_BYTES); }

int fe25519_isnegative_sdk(const fe25519_sdk f) { return f[ED25519_SCALAR_BYTES - 1] & 1; }
...
void fe25519_copy_sdk(const fe25519_sdk h, const fe25519_sdk f) { memcpy((void *)h, f, sizeof(fe25519_sdk)); }
