...
///////////////////////////////////
///////////////////////////////////
parser_error_t _readCompactu16(parser_context_t *c, pd_Compactu16_t *v) { return _readCompactInt(c, v); }
...
parser_error_t _readIdentityId(parser_context_t *c, pd_IdentityId_t *v){GEN_DEF_READARRAY(32)}
...
parser_error_t _readCddId(parser_context_t *c, pd_CddId_t *v){GEN_DEF_READARRAY(32)}
...
parser_error_t _readScopeId(parser_context_t *c, pd_ScopeId_t *v){GEN_DEF_READARRAY(32)}
...
parser_error_t _readBalanceNoSymbol(parser_context_t *c, pd_BalanceNoSymbol_t *v){GEN_DEF_READARRAY(16)}
...
parser_error_t _readEd25519Signature(parser_context_t *c, pd_Ed25519Signature_t *v){GEN_DEF_READARRAY(64)}
...
parser_error_t _readSr25519Signature(parser_context_t *c, pd_Sr25519Signature_t *v){GEN_DEF_READARRAY(64)}
...
parser_error_t _readCheckpointId(parser_context_t *c, pd_CheckpointId_t *v) { return _readUInt64(c, &v->value); }
...
parser_error_t _readReceiptMetadata(parser_context_t *c, pd_ReceiptMetadata_t *v){GEN_DEF_READARRAY(32)}
...
parser_error_t _readTupleAccountId32SpNposElectionsSupport(parser_context_t *c,
                                                           pd_TupleAccountId32SpNposElectionsSupport_t *v) {
    CHECK_INPUT()
    CHECK_ERROR(_readAccountId(c, &v->accountId))
...
parser_error_t _readu8_array_32(parser_context_t *c, pd_u8_array_32_t *v){GEN_DEF_READARRAY(32)}
...
parser_error_t _readCompactPerBill(parser_context_t *c, pd_CompactPerBill_t *v) { return _readCompactInt(c, &v->value); }
...
parser_error_t _readVenueId(parser_context_t *c, pd_VenueId_t *v) { return _readUInt64(c, &v->value); }
...
parser_error_t _readu8_array_4(parser_context_t *c, pd_u8_array_4_t *v){GEN_DEF_READARRAY(4)}
...
parser_error_t _readBoundedBTreeSetIdentityIdMaxAssetMediators(parser_context_t *c,
                                                               pd_BoundedBTreeSetIdentityIdMaxAssetMediators_t *v) {
    CHECK_INPUT()
    CHECK_ERROR(_readVecIdentityId(c, &v->identities))
    return parser_ok;
}

parser_error_t _readBoundedBTreeSetIdentityIdMaxInstructionMediators(
    parser_context_t *c, pd_BoundedBTreeSetIdentityIdMaxInstructionMediators_t *v) {
    CHECK_INPUT()
    CHECK_ERROR(_readVecIdentityId(c, &v->identities))
    return parser_ok;
}
...
parser_error_t _readFundraiserId(parser_context_t *c, pd_FundraiserId_t *v) { return _readUInt64(c, &v->value); }
...
parser_error_t _readInstructionId(parser_context_t *c, pd_InstructionId_t *v) { return _readUInt64(c, &v->value); }
...
parser_error_t _readVecClaimType(parser_context_t *c, pd_VecClaimType_t *v){GEN_DEF_READVECTOR(ClaimType)}

parser_error_t
    _readVecDispatchableName(parser_context_t *c, pd_VecDispatchableName_t *v){GEN_DEF_READVECTOR(DispatchableName)}

parser_error_t _readVecClaim(parser_context_t *c, pd_VecClaim_t *v){GEN_DEF_READVECTOR(Claim)}

parser_error_t _readVecAssetId(parser_context_t *c, pd_VecAssetId_t *v){GEN_DEF_READVECTOR(AssetId)}

parser_error_t
    _readVecPalletPermissions(parser_context_t *c, pd_VecPalletPermissions_t *v){GEN_DEF_READVECTOR(PalletPermissions)}

parser_error_t _readVecPortfolioId(parser_context_t *c, pd_VecPortfolioId_t *v){GEN_DEF_READVECTOR(PortfolioId)}

parser_error_t _readVecTrustedIssuer(parser_context_t *c, pd_VecTrustedIssuer_t *v){GEN_DEF_READVECTOR(TrustedIssuer)}

parser_error_t _readVecTupleAccountId32u128(parser_context_t *c,
                                            pd_VecTupleAccountId32u128_t *v){GEN_DEF_READVECTOR(TupleAccountId32u128)}

parser_error_t _readVecChoiceTitle(parser_context_t *c, pd_VecChoiceTitle_t *v){GEN_DEF_READVECTOR(ChoiceTitle)}

parser_error_t _readVecIdentityId(parser_context_t *c, pd_VecIdentityId_t *v){GEN_DEF_READVECTOR(IdentityId)}

parser_error_t _readVecu64(parser_context_t *c, pd_Vecu64_t *v){GEN_DEF_READVECTOR(u64)}

parser_error_t _readVecCondition(parser_context_t *c, pd_VecCondition_t *v){GEN_DEF_READVECTOR(Condition)}

parser_error_t
    _readVecTupleIdentityIdTax(parser_context_t *c, pd_VecTupleIdentityIdTax_t *v){GEN_DEF_READVECTOR(TupleIdentityIdTax)}

parser_error_t _readVecVoteEight(parser_context_t *c, pd_VecVoteEight_t *v){GEN_DEF_READVECTOR(VoteEight)}

parser_error_t _readVecVoteEleven(parser_context_t *c, pd_VecVoteEleven_t *v){GEN_DEF_READVECTOR(VoteEleven)}

parser_error_t _readVecVoteFifteen(parser_context_t *c, pd_VecVoteFifteen_t *v){GEN_DEF_READVECTOR(VoteFifteen)}

parser_error_t _readVecVoteFive(parser_context_t *c, pd_VecVoteFive_t *v){GEN_DEF_READVECTOR(VoteFive)}

parser_error_t _readVecVoteFour(parser_context_t *c, pd_VecVoteFour_t *v){GEN_DEF_READVECTOR(VoteFour)}

parser_error_t _readVecVoteFourteen(parser_context_t *c, pd_VecVoteFourteen_t *v){GEN_DEF_READVECTOR(VoteFourteen)}

parser_error_t _readVecVoteNine(parser_context_t *c, pd_VecVoteNine_t *v){GEN_DEF_READVECTOR(VoteNine)}

parser_error_t _readVecVoteOne(parser_context_t *c, pd_VecVoteOne_t *v){GEN_DEF_READVECTOR(VoteOne)}

parser_error_t _readVecVoteSeven(parser_context_t *c, pd_VecVoteSeven_t *v){GEN_DEF_READVECTOR(VoteSeven)}

parser_error_t _readVecVoteSix(parser_context_t *c, pd_VecVoteSix_t *v){GEN_DEF_READVECTOR(VoteSix)}

parser_error_t _readVecVoteSixteen(parser_context_t *c, pd_VecVoteSixteen_t *v){GEN_DEF_READVECTOR(VoteSixteen)}

parser_error_t _readVecVoteTen(parser_context_t *c, pd_VecVoteTen_t *v){GEN_DEF_READVECTOR(VoteTen)}

parser_error_t _readVecVoteThirteen(parser_context_t *c, pd_VecVoteThirteen_t *v){GEN_DEF_READVECTOR(VoteThirteen)}

parser_error_t _readVecVoteThree(parser_context_t *c, pd_VecVoteThree_t *v){GEN_DEF_READVECTOR(VoteThree)}

parser_error_t _readVecVoteTwelve(parser_context_t *c, pd_VecVoteTwelve_t *v){GEN_DEF_READVECTOR(VoteTwelve)}

parser_error_t _readVecVoteTwo(parser_context_t *c, pd_VecVoteTwo_t *v){GEN_DEF_READVECTOR(VoteTwo)}

parser_error_t _readVecAccountId(parser_context_t *c, pd_VecAccountId_t *v){GEN_DEF_READVECTOR(AccountId)}

parser_error_t _readVecMotion(parser_context_t *c, pd_VecMotion_t *v){GEN_DEF_READVECTOR(Motion)}

parser_error_t _readVecNFTId(parser_context_t *c, pd_VecNFTId_t *v){GEN_DEF_READVECTOR(NFTId)}

parser_error_t
    _readVecTupleAccountId32SpNposElectionsSupport(parser_context_t *c, pd_VecTupleAccountId32SpNposElectionsSupport_t *v){
        GEN_DEF_READVECTOR(TupleAccountId32SpNposElectionsSupport)}

parser_error_t
    _readVecAccountIdLookupOfT(parser_context_t *c, pd_VecAccountIdLookupOfT_t *v){GEN_DEF_READVECTOR(AccountIdLookupOfT)}

parser_error_t _readVecBallotVote(parser_context_t *c, pd_VecBallotVote_t *v){GEN_DEF_READVECTOR(BallotVote)}

parser_error_t _readVecBeneficiary(parser_context_t *c, pd_VecBeneficiary_t *v){GEN_DEF_READVECTOR(Beneficiary)}

parser_error_t _readVecComplianceRequirement(parser_context_t *c,
                                             pd_VecComplianceRequirement_t *v){GEN_DEF_READVECTOR(ComplianceRequirement)}

parser_error_t
    _readVecCreateChildIdentityWithAuthAccountId(parser_context_t *c, pd_VecCreateChildIdentityWithAuthAccountId_t *v){
        GEN_DEF_READVECTOR(CreateChildIdentityWithAuthAccountId)}

parser_error_t _readVecDocument(parser_context_t *c, pd_VecDocument_t *v){GEN_DEF_READVECTOR(Document)}

parser_error_t _readVecFund(parser_context_t *c, pd_VecFund_t *v){GEN_DEF_READVECTOR(Fund)}

parser_error_t _readVecLeg(parser_context_t *c, pd_VecLeg_t *v){GEN_DEF_READVECTOR(Leg)}

parser_error_t _readVecNFTMetadataAttribute(parser_context_t *c,
                                            pd_VecNFTMetadataAttribute_t *v){GEN_DEF_READVECTOR(NFTMetadataAttribute)}

parser_error_t _readVecPriceTier(parser_context_t *c, pd_VecPriceTier_t *v){GEN_DEF_READVECTOR(PriceTier)}

parser_error_t _readVecReceiptDetails(parser_context_t *c, pd_VecReceiptDetails_t *v){GEN_DEF_READVECTOR(ReceiptDetails)}

parser_error_t _readVecSecondaryKeyAccountId(parser_context_t *c,
                                             pd_VecSecondaryKeyAccountId_t *v){GEN_DEF_READVECTOR(SecondaryKeyAccountId)}
...
parser_error_t _readVecTupleExtrinsicIdbool(parser_context_t *c,
                                            pd_VecTupleExtrinsicIdbool_t *v){GEN_DEF_READVECTOR(TupleExtrinsicIdbool)}
...
parser_error_t _readVecAssetIdentifier(parser_context_t *c, pd_VecAssetIdentifier_t *v){GEN_DEF_READVECTOR(AssetIdentifier)}

parser_error_t
    _readVecAssetMetadataKey(parser_context_t *c, pd_VecAssetMetadataKey_t *v){GEN_DEF_READVECTOR(AssetMetadataKey)}

parser_error_t _readVecDocumentId(parser_context_t *c, pd_VecDocumentId_t *v){GEN_DEF_READVECTOR(DocumentId)}

parser_error_t _readVecVenueId(parser_context_t *c, pd_VecVenueId_t *v){GEN_DEF_READVECTOR(VenueId)}
...
parser_error_t _toStringCompactu16(const pd_Compactu16_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    return _toStringCompactInt(v, 0, false, "", "", outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringAssetId(const pd_AssetId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringIdentityId(const pd_IdentityId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(32)}

parser_error_t
    _toStringScope(const pd_Scope_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:
...
parser_error_t _toStringCddId(const pd_CddId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                              uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(32)}

parser_error_t
    _toStringClaimType(const pd_ClaimType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringCountryCode(const pd_CountryCode_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
...
parser_error_t _toStringDispatchableName(const pd_DispatchableName_t *v, char *outValue, uint16_t outValueLen,
...
parser_error_t _toStringScopeId(const pd_ScopeId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(32)}

parser_error_t _toStringPortfolioNumber(const pd_PortfolioNumber_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringTupleCountryCodeScope(const pd_TupleCountryCodeScope_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTupleScopeScopeIdCddId(const pd_TupleScopeScopeIdCddId_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTupleU32Scope(const pd_TupleU32Scope_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBalanceNoSymbol(const pd_BalanceNoSymbol_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringClaim(const pd_Claim_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                              uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringDispatchableNames(const pd_DispatchableNames_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringPalletName(const pd_PalletName_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringPortfolioKind(const pd_PortfolioKind_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringTrustedFor(const pd_TrustedFor_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // Any
...
parser_error_t _toStringPalletPermissions(const pd_PalletPermissions_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringPermill(const pd_Permill_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    char bufferUI[100];
    char ratioBuffer[80];
    memset(outValue, 0, outValueLen);
...
parser_error_t _toStringPortfolioId(const pd_PortfolioId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTargetIdentity(const pd_TargetIdentity_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringTrustedIssuer(const pd_TrustedIssuer_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTupleAccountId32u128(const pd_TupleAccountId32u128_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringChoiceTitle(const pd_ChoiceTitle_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringConditionType(const pd_ConditionType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringEcdsaSignature(const pd_EcdsaSignature_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(65)}

parser_error_t _toStringEd25519Signature(const pd_Ed25519Signature_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(64)}

parser_error_t _toStringMemo(const pd_Memo_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSr25519Signature(const pd_Sr25519Signature_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(64)}

parser_error_t _toStringTax(const pd_Tax_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    CHECK_ERROR(_toStringPermill(&v->value, outValue, outValueLen, pageIdx, pageCount))
    return parser_ok;
}

parser_error_t _toStringTupleCompactu16Compactu16(const pd_TupleCompactu16Compactu16_t *v, char *outValue,
...
parser_error_t _toStringAssetPermissions(const pd_AssetPermissions_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringCheckpointId(const pd_CheckpointId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringCondition(const pd_Condition_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringDocumentType(const pd_DocumentType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringExtrinsicPermissions(const pd_ExtrinsicPermissions_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringMoment(const pd_Moment_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringMotionInfoLink(const pd_MotionInfoLink_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringMotionTitle(const pd_MotionTitle_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringMultiSignature(const pd_MultiSignature_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // Ed25519
...
parser_error_t _toStringPortfolioPermissions(const pd_PortfolioPermissions_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringReceiptMetadata(const pd_ReceiptMetadata_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(32)}

parser_error_t _toStringScheduleId(const pd_ScheduleId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringSpNposElectionsSupport(const pd_SpNposElectionsSupport_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTargetTreatment(const pd_TargetTreatment_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringTicker(const pd_Ticker_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringTupleIdentityIdTax(const pd_TupleIdentityIdTax_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteEight(const pd_VoteEight_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteEleven(const pd_VoteEleven_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteFifteen(const pd_VoteFifteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteFive(const pd_VoteFive_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteFour(const pd_VoteFour_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteFourteen(const pd_VoteFourteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteNine(const pd_VoteNine_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteOne(const pd_VoteOne_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteSeven(const pd_VoteSeven_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteSix(const pd_VoteSix_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteSixteen(const pd_VoteSixteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteTen(const pd_VoteTen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteThirteen(const pd_VoteThirteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteThree(const pd_VoteThree_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteTwelve(const pd_VoteTwelve_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringVoteTwo(const pd_VoteTwo_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAgentGroup(const pd_AgentGroup_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringAssetCount(const pd_AssetCount_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAssetMetadataKey(const pd_AssetMetadataKey_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->value < 2) {
...
parser_error_t _toStringAssetMetadataLockStatusMoment(const pd_AssetMetadataLockStatusMoment_t *v, char *outValue,
                                                      uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringDocumentHash(const pd_DocumentHash_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(v -> _len)}

parser_error_t _toStringDocumentName(const pd_DocumentName_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringDocumentUri(const pd_DocumentUri_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringFundFungible(const pd_FundFungible_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringFundNonFungible(const pd_FundNonFungible_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringLegFungible(const pd_LegFungible_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringLegNonFungible(const pd_LegNonFungible_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringLegOffChain(const pd_LegOffChain_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringMotion(const pd_Motion_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringNFTId(const pd_NFTId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                              uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringOffChainSignature(const pd_OffChainSignature_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CHECK_ERROR(_toStringMultiSignature(&v->value, outValue, outValueLen, pageIdx, pageCount));
    return parser_ok;
}

parser_error_t _toStringPermissions(const pd_Permissions_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringPipId(const pd_PipId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                              uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringRecordDateSpec(const pd_RecordDateSpec_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // Scheduled
...
parser_error_t _toStringSnapshotResult(const pd_SnapshotResult_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringTargetIdentities(const pd_TargetIdentities_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTupleAccountId32SpNposElectionsSupport(const pd_TupleAccountId32SpNposElectionsSupport_t *v,
...
parser_error_t _toStringu8_array_32(const pd_u8_array_32_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(32)}
...
parser_error_t _toStringAddRelayerPayingKey(const pd_AddRelayerPayingKey_t *v, char *outValue, uint16_t outValueLen,
                                            uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAffirmationCount(const pd_AffirmationCount_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringApiCodeHash(const pd_ApiCodeHash_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAssetIdentifier(const pd_AssetIdentifier_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringAssetMetadataValueDetailMoment(const pd_AssetMetadataValueDetailMoment_t *v, char *outValue,
                                                       uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBallotTitle(const pd_BallotTitle_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringBallotVote(const pd_BallotVote_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBecomeAgent(const pd_BecomeAgent_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBeneficiary(const pd_Beneficiary_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringCAKind(const pd_CAKind_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringChainVersion(const pd_ChainVersion_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringCompactPerBill(const pd_CompactPerBill_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    // 9 but shift 2 to show as percentage
    return _toStringCompactInt(&v->value, 7, false, "%", "", outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringComplianceRequirement(const pd_ComplianceRequirement_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringCreateChildIdentityWithAuthAccountId(const pd_CreateChildIdentityWithAuthAccountId_t *v,
                                                             char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                             uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringCustomAssetTypeId(const pd_CustomAssetTypeId_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringDocumentId(const pd_DocumentId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringDocument(const pd_Document_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringElectionScore(const pd_ElectionScore_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringFund(const pd_Fund_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // Fungible
...
parser_error_t _toStringFundingRoundName(const pd_FundingRoundName_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringLeg(const pd_Leg_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // Fungible
...
parser_error_t _toStringLocalCAId(const pd_LocalCAId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringNFTMetadataAttribute(const pd_NFTMetadataAttribute_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringNonFungibleType(const pd_NonFungibleType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringPipDescription(const pd_PipDescription_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringPriceTier(const pd_PriceTier_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringReceiptDetails(const pd_ReceiptDetails_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSecondaryKeyAccountId(const pd_SecondaryKeyAccountId_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSecondaryKeyWithAuthAccountId(const pd_SecondaryKeyWithAuthAccountId_t *v, char *outValue,
                                                      uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSolution(const pd_Solution_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSystemOrigin(const pd_SystemOrigin_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringTupleExtrinsicIdbool(const pd_TupleExtrinsicIdbool_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringTuplePipIdSnapshotResult(const pd_TuplePipIdSnapshotResult_t *v, char *outValue,
                                                 uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringUrl(const pd_Url_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
    }
...
parser_error_t _toStringVenueId(const pd_VenueId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}
...
parser_error_t _toStringu8_array_4(const pd_u8_array_4_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount){GEN_DEF_TOSTRING_ARRAY(4)}

parser_error_t _toStringApi(const pd_Api_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAssetMetadataName(const pd_AssetMetadataName_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAssetMetadataSpec(const pd_AssetMetadataSpec_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAssetMetadataValue(const pd_AssetMetadataValue_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    CHECK_ERROR(_toStringBytes(&v->value, outValue, outValueLen, pageIdx, pageCount))
    return parser_ok;
...
parser_error_t _toStringAssetType(const pd_AssetType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringAuthorizationDataAccountId(const pd_AuthorizationDataAccountId_t *v, char *outValue,
                                                   uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 0;
    uint8_t _dummy = 0;
...
parser_error_t _toStringBallotMeta(const pd_BallotMeta_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBallotTimeRange(const pd_BallotTimeRange_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBoundedBTreeSetIdentityIdMaxAssetMediators(const pd_BoundedBTreeSetIdentityIdMaxAssetMediators_t *v,
                                                                   char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBoundedBTreeSetIdentityIdMaxInstructionMediators(
    const pd_BoundedBTreeSetIdentityIdMaxInstructionMediators_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBoundedVecAccountIdMaxSigners(const pd_BoundedVecAccountIdMaxSigners_t *v, char *outValue,
                                                      uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBoxPalletsOrigin(const pd_BoxPalletsOrigin_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
        ...
        case 4:  // Void
            ...
            break;
        case 9:  // PolymeshCommittee
            if (v->committee != 0) return parser_unexpected_value;
...
parser_error_t _toStringBoxRawSolutionSolutionOfMinerConfig(const pd_BoxRawSolutionSolutionOfMinerConfig_t *v,
                                                            char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                            uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringBoxTasConfigProposal(const pd_BoxTasConfigProposal_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    return _toStringCall(&v->call, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringCAId(const pd_CAId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringCodeHash(const pd_CodeHash_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    return _toStringHash(&v->hash, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringConfigOpBalanceOfT(const pd_ConfigOpBalanceOfT_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringConfigOpPerbill(const pd_ConfigOpPerbill_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringConfigOpPercent(const pd_ConfigOpPercent_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringInitiateCorporateActionArgs(const pd_InitiateCorporateActionArgs_t *v, char *outValue,
                                                    uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringMaybeBlockBlockNumber(const pd_MaybeBlockBlockNumber_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringNFTs(const pd_NFTs_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringNextUpgradeT(const pd_NextUpgradeT_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringScheduleCheckpoints(const pd_ScheduleCheckpoints_t *v, char *outValue, uint16_t outValueLen,
                                            uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSettlementTypeBlockNumber(const pd_SettlementTypeBlockNumber_t *v, char *outValue,
                                                  uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:  // SettleOnAffirmation
...
parser_error_t _toStringSignatoryAccountId(const pd_SignatoryAccountId_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    switch (v->value) {
        case 0:
...
parser_error_t _toStringSolutionOrSnapshotSize(const pd_SolutionOrSnapshotSize_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringSupportsAccountId(const pd_SupportsAccountId_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    ...
    *pageCount = 0;
    ...
    if (pageIdx < pages[0]) {
        CHECK_ERROR(_toStringVecTupleAccountId32SpNposElectionsSupport(&v->tupleAccSupport, outValue, outValueLen, pageIdx,
                                                                       &pages[0]))
        return parser_ok;
    }
...
parser_error_t _toStringUniqueCall(const pd_UniqueCall_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringValidatorPrefs(const pd_ValidatorPrefs_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringAGId(const pd_AGId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}
...
parser_error_t _toStringAssetMetadataLocalKey(const pd_AssetMetadataLocalKey_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringAssetName(const pd_AssetName_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringCADetails(const pd_CADetails_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringConfigOpu32(const pd_ConfigOpu32_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    *pageCount = 1;
    switch (v->value) {
...
parser_error_t _toStringDeterminism(const pd_Determinism_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringFundraiserId(const pd_FundraiserId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringFundraiserName(const pd_FundraiserName_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringInstructionId(const pd_InstructionId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    return _toStringu64(&v->value, outValue, outValueLen, pageIdx, pageCount);
}
...
parser_error_t _toStringOptionAssetId(const pd_OptionAssetId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringPortfolioName(const pd_PortfolioName_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringPosRatio(const pd_PosRatio_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringProposalIndex(const pd_ProposalIndex_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    return _toStringu32(&v->value, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringSkippedCount(const pd_SkippedCount_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    uint16_t valu16 = (uint16_t)v->value;
    return _toStringu16(&valu16, outValue, outValueLen, pageIdx, pageCount);
}

parser_error_t _toStringSlashingSwitch(const pd_SlashingSwitch_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringVenueDetails(const pd_VenueDetails_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    if (v->_len > UINT16_MAX) {
        return parser_value_out_of_range;
...
parser_error_t _toStringVenueType(const pd_VenueType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    UNUSED(pageIdx);
    switch (v->value) {
...
parser_error_t _toStringVecClaimType(const pd_VecClaimType_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(ClaimType);
}

parser_error_t _toStringVecDispatchableName(const pd_VecDispatchableName_t *v, char *outValue, uint16_t outValueLen,
                                            uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(DispatchableName);
}

parser_error_t _toStringVecClaim(const pd_VecClaim_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Claim);
}

parser_error_t _toStringVecAssetId(const pd_VecAssetId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(AssetId);
}

parser_error_t _toStringVecPalletPermissions(const pd_VecPalletPermissions_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(PalletPermissions);
}

parser_error_t _toStringVecPortfolioId(const pd_VecPortfolioId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(PortfolioId);
}

parser_error_t _toStringVecTrustedIssuer(const pd_VecTrustedIssuer_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TrustedIssuer);
}

parser_error_t _toStringVecTupleAccountId32u128(const pd_VecTupleAccountId32u128_t *v, char *outValue, uint16_t outValueLen,
                                                uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TupleAccountId32u128);
}

parser_error_t _toStringVecChoiceTitle(const pd_VecChoiceTitle_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(ChoiceTitle);
}

parser_error_t _toStringVecIdentityId(const pd_VecIdentityId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(IdentityId);
}

parser_error_t _toStringVecu64(const pd_Vecu64_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(u64);
}

parser_error_t _toStringVecCondition(const pd_VecCondition_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Condition);
}

parser_error_t _toStringVecTupleIdentityIdTax(const pd_VecTupleIdentityIdTax_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TupleIdentityIdTax);
}

parser_error_t _toStringVecVoteEight(const pd_VecVoteEight_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteEight);
}

parser_error_t _toStringVecVoteEleven(const pd_VecVoteEleven_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteEleven);
}

parser_error_t _toStringVecVoteFifteen(const pd_VecVoteFifteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteFifteen);
}

parser_error_t _toStringVecVoteFive(const pd_VecVoteFive_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteFive);
}

parser_error_t _toStringVecVoteFour(const pd_VecVoteFour_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteFour);
}

parser_error_t _toStringVecVoteFourteen(const pd_VecVoteFourteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteFourteen);
}

parser_error_t _toStringVecVoteNine(const pd_VecVoteNine_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteNine);
}

parser_error_t _toStringVecVoteOne(const pd_VecVoteOne_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteOne);
}

parser_error_t _toStringVecVoteSeven(const pd_VecVoteSeven_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteSeven);
}

parser_error_t _toStringVecVoteSix(const pd_VecVoteSix_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteSix);
}

parser_error_t _toStringVecVoteSixteen(const pd_VecVoteSixteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteSixteen);
}

parser_error_t _toStringVecVoteTen(const pd_VecVoteTen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteTen);
}

parser_error_t _toStringVecVoteThirteen(const pd_VecVoteThirteen_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                        uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteThirteen);
}

parser_error_t _toStringVecVoteThree(const pd_VecVoteThree_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteThree);
}

parser_error_t _toStringVecVoteTwelve(const pd_VecVoteTwelve_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(VoteTwelve);
}

parser_error_t _toStringVecVoteTwo(const pd_VecVoteTwo_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
...
parser_error_t _toStringVecMotion(const pd_VecMotion_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Motion);
}

parser_error_t _toStringVecNFTId(const pd_VecNFTId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(NFTId);
}

parser_error_t _toStringVecTupleAccountId32SpNposElectionsSupport(const pd_VecTupleAccountId32SpNposElectionsSupport_t *v,
                                                                  char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                                  uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TupleAccountId32SpNposElectionsSupport);
}

parser_error_t _toStringVecAccountIdLookupOfT(const pd_VecAccountIdLookupOfT_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(AccountIdLookupOfT);
}

parser_error_t _toStringVecBallotVote(const pd_VecBallotVote_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(BallotVote);
}

parser_error_t _toStringVecBeneficiary(const pd_VecBeneficiary_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                       uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Beneficiary);
}

parser_error_t _toStringVecComplianceRequirement(const pd_VecComplianceRequirement_t *v, char *outValue,
                                                 uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(ComplianceRequirement);
}

parser_error_t _toStringVecCreateChildIdentityWithAuthAccountId(const pd_VecCreateChildIdentityWithAuthAccountId_t *v,
                                                                char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                                uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(CreateChildIdentityWithAuthAccountId);
}

parser_error_t _toStringVecDocument(const pd_VecDocument_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Document);
}

parser_error_t _toStringVecFund(const pd_VecFund_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Fund);
}

parser_error_t _toStringVecLeg(const pd_VecLeg_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                               uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(Leg);
}

parser_error_t _toStringVecNFTMetadataAttribute(const pd_VecNFTMetadataAttribute_t *v, char *outValue, uint16_t outValueLen,
                                                uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(NFTMetadataAttribute);
}

parser_error_t _toStringVecPriceTier(const pd_VecPriceTier_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(PriceTier);
}

parser_error_t _toStringVecReceiptDetails(const pd_VecReceiptDetails_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(ReceiptDetails);
}

parser_error_t _toStringVecSecondaryKeyAccountId(const pd_VecSecondaryKeyAccountId_t *v, char *outValue,
                                                 uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(SecondaryKeyAccountId);
}

parser_error_t _toStringVecSecondaryKeyWithAuthAccountId(const pd_VecSecondaryKeyWithAuthAccountId_t *v, char *outValue,
                                                         uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(SecondaryKeyWithAuthAccountId);
}

parser_error_t _toStringVecTupleExtrinsicIdbool(const pd_VecTupleExtrinsicIdbool_t *v, char *outValue, uint16_t outValueLen,
                                                uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TupleExtrinsicIdbool);
}

parser_error_t _toStringVecTuplePipIdSnapshotResult(const pd_VecTuplePipIdSnapshotResult_t *v, char *outValue,
                                                    uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(TuplePipIdSnapshotResult);
}

parser_error_t _toStringVecAssetIdentifier(const pd_VecAssetIdentifier_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(AssetIdentifier);
}

parser_error_t _toStringVecAssetMetadataKey(const pd_VecAssetMetadataKey_t *v, char *outValue, uint16_t outValueLen,
                                            uint8_t pageIdx, uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(AssetMetadataKey);
}

parser_error_t _toStringVecDocumentId(const pd_VecDocumentId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(DocumentId);
}

parser_error_t _toStringVecVenueId(const pd_VecVenueId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
...
parser_error_t _toStringVecu8(const pd_Vecu8_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                              uint8_t *pageCount) {
    GEN_DEF_TOSTRING_VECTOR(u8);
}

parser_error_t _toStringOptionScope(const pd_OptionScope_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringScope(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionMemo(const pd_OptionMemo_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                   uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringMemo(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionDocumentType(const pd_OptionDocumentType_t *v, char *outValue, uint16_t outValueLen,
                                           uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringDocumentType(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionMoment(const pd_OptionMoment_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringMoment(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionReceiptMetadata(const pd_OptionReceiptMetadata_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringReceiptMetadata(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionu16(const pd_Optionu16_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringu16(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionBytes(const pd_OptionBytes_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                    uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringBytes(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionPermill(const pd_OptionPermill_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringPermill(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionRecordDateSpec(const pd_OptionRecordDateSpec_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringRecordDateSpec(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionTargetIdentities(const pd_OptionTargetIdentities_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringTargetIdentities(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionVecTupleIdentityIdTax(const pd_OptionVecTupleIdentityIdTax_t *v, char *outValue,
                                                    uint16_t outValueLen, uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringVecTupleIdentityIdTax(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionAffirmationCount(const pd_OptionAffirmationCount_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringAffirmationCount(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionAssetMetadataValueDetailMoment(const pd_OptionAssetMetadataValueDetailMoment_t *v,
                                                             char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                                             uint8_t *pageCount) {
    CLEAN_AND_CHECK()
    ...
    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringAssetMetadataValueDetailMoment(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionElectionScore(const pd_OptionElectionScore_t *v, char *outValue, uint16_t outValueLen,
                                            uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringElectionScore(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionPermissions(const pd_OptionPermissions_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringPermissions(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionPortfolioId(const pd_OptionPortfolioId_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringPortfolioId(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionReceiptDetails(const pd_OptionReceiptDetails_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringReceiptDetails(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionTax(const pd_OptionTax_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringTax(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionWeight(const pd_OptionWeight_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                     uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringWeight(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionAssetCount(const pd_OptionAssetCount_t *v, char *outValue, uint16_t outValueLen,
                                         uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringAssetCount(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionBalance(const pd_OptionBalance_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()
...
parser_error_t _toStringOptionBlockNumber(const pd_OptionBlockNumber_t *v, char *outValue, uint16_t outValueLen,
                                          uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringBlockNumber(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionCompactBalanceOf(const pd_OptionCompactBalanceOf_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringCompactBalanceOf(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionFundingRoundName(const pd_OptionFundingRoundName_t *v, char *outValue, uint16_t outValueLen,
                                               uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringFundingRoundName(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionNonFungibleType(const pd_OptionNonFungibleType_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringNonFungibleType(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionPipDescription(const pd_OptionPipDescription_t *v, char *outValue, uint16_t outValueLen,
                                             uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringPipDescription(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionPortfolioNumber(const pd_OptionPortfolioNumber_t *v, char *outValue, uint16_t outValueLen,
                                              uint8_t pageIdx, uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringPortfolioNumber(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionUrl(const pd_OptionUrl_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringUrl(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionVenueId(const pd_OptionVenueId_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                      uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringVenueId(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionu64(const pd_Optionu64_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                  uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringu64(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
...
parser_error_t _toStringOptionu8(const pd_Optionu8_t *v, char *outValue, uint16_t outValueLen, uint8_t pageIdx,
                                 uint8_t *pageCount) {
    CLEAN_AND_CHECK()

    *pageCount = 1;
    if (v->some > 0) {
        CHECK_ERROR(_toStringu8(&v->contained, outValue, outValueLen, pageIdx, pageCount));
    } else {
        snprintf(outValue, outValueLen, "None");
    }
    return parser_ok;
