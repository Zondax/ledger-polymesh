...
__Z_INLINE parser_error_t _readMethod_portfolio_create_custody_portfolio_V7(
    parser_context_t* c, pd_portfolio_create_custody_portfolio_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_nft_controller_transfer_V7(
    parser_context_t* c, pd_nft_controller_transfer_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_identity_register_custom_claim_type_V7(
    parser_context_t* c, pd_identity_register_custom_claim_type_V7_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->ty))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_identity_cdd_register_did_with_cdd_V7(
    parser_context_t* c, pd_identity_cdd_register_did_with_cdd_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->target_account))
    CHECK_ERROR(_readVecSecondaryKeyAccountId(c, &m->secondary_keys))
    CHECK_ERROR(_readOptionMoment(c, &m->expiry))
...
__Z_INLINE parser_error_t _readMethod_identity_create_child_identity_V7(
    parser_context_t* c, pd_identity_create_child_identity_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->secondary_key))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_identity_create_child_identities_V7(
    parser_context_t* c, pd_identity_create_child_identities_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_identity_unlink_child_identity_V7(
    parser_context_t* c, pd_identity_unlink_child_identity_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_multisig_create_proposal_V7(
    parser_context_t* c, pd_multisig_create_proposal_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_multisig_approve_V7(
    parser_context_t* c, pd_multisig_approve_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->multisig))
...
__Z_INLINE parser_error_t _readMethod_multisig_reject_V7(
    parser_context_t* c, pd_multisig_reject_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->multisig))
    CHECK_ERROR(_readu64(c, &m->proposal_id))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_multisig_accept_multisig_signer_V7(
    parser_context_t* c, pd_multisig_accept_multisig_signer_V7_t* m)
{
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_multisig_add_multisig_signers_V7(
    parser_context_t* c, pd_multisig_add_multisig_signers_V7_t* m)
{
    CHECK_ERROR(_readBoundedVecAccountIdMaxSigners(c, &m->signers))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_multisig_remove_multisig_signers_V7(
    parser_context_t* c, pd_multisig_remove_multisig_signers_V7_t* m)
{
    CHECK_ERROR(_readBoundedVecAccountIdMaxSigners(c, &m->signers))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_multisig_add_admin_V7(
    parser_context_t* c, pd_multisig_add_admin_V7_t* m)
{
    CHECK_ERROR(_readIdentityId(c, &m->admin_did))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_multisig_remove_admin_via_admin_V7(
    parser_context_t* c, pd_multisig_remove_admin_via_admin_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->multisig))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_multisig_remove_payer_V7(
    parser_context_t* c, pd_multisig_remove_payer_V7_t* m)
{
    UNUSED(c);
    UNUSED(m);
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_multisig_remove_payer_via_payer_V7(
    parser_context_t* c, pd_multisig_remove_payer_via_payer_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->multisig))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_multisig_approve_join_identity_V7(
    parser_context_t* c, pd_multisig_approve_join_identity_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->multisig))
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_multisig_join_identity_V7(
    parser_context_t* c, pd_multisig_join_identity_V7_t* m)
{
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_staking_chill_from_governance_V7(
    parser_context_t* c, pd_staking_chill_from_governance_V7_t* m)
{
    CHECK_ERROR(_readIdentityId(c, &m->identity))
...
__Z_INLINE parser_error_t _readMethod_asset_register_unique_ticker_V7(
    parser_context_t* c, pd_asset_register_unique_ticker_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_asset_register_custom_asset_type_V7(
    parser_context_t* c, pd_asset_register_custom_asset_type_V7_t* m)
{
    CHECK_ERROR(_readVecu8(c, &m->ty))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_asset_create_asset_with_custom_type_V7(
    parser_context_t* c, pd_asset_create_asset_with_custom_type_V7_t* m)
{
    CHECK_ERROR(_readAssetName(c, &m->asset_name))
    CHECK_ERROR(_readbool(c, &m->divisible))
...
__Z_INLINE parser_error_t _readMethod_asset_link_ticker_to_asset_id_V7(
...
__Z_INLINE parser_error_t _readMethod_portfolio_quit_portfolio_custody_V7(
    parser_context_t* c, pd_portfolio_quit_portfolio_custody_V7_t* m)
{
    CHECK_ERROR(_readPortfolioId(c, &m->pid))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_portfolio_accept_portfolio_custody_V7(
    parser_context_t* c, pd_portfolio_accept_portfolio_custody_V7_t* m)
{
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_settlement_update_venue_details_V7(
    parser_context_t* c, pd_settlement_update_venue_details_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_settlement_update_venue_type_V7(
    parser_context_t* c, pd_settlement_update_venue_type_V7_t* m)
{
    CHECK_ERROR(_readVenueId(c, &m->id))
    CHECK_ERROR(_readVenueType(c, &m->typ))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_settlement_update_venue_signers_V7(
    parser_context_t* c, pd_settlement_update_venue_signers_V7_t* m)
{
    CHECK_ERROR(_readVenueId(c, &m->id))
    CHECK_ERROR(_readVecAccountId(c, &m->signers))
...
__Z_INLINE parser_error_t _readMethod_settlement_execute_manual_instruction_V7(
    parser_context_t* c, pd_settlement_execute_manual_instruction_V7_t* m)
{
    CHECK_ERROR(_readInstructionId(c, &m->id))
...
__Z_INLINE parser_error_t _readMethod_externalagents_accept_become_agent_V7(
    parser_context_t* c, pd_externalagents_accept_become_agent_V7_t* m)
{
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_relayer_set_paying_key_V7(
    parser_context_t* c, pd_relayer_set_paying_key_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_relayer_accept_paying_key_V7(
    parser_context_t* c, pd_relayer_accept_paying_key_V7_t* m)
{
    CHECK_ERROR(_readu64(c, &m->auth_id))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_relayer_remove_paying_key_V7(
    parser_context_t* c, pd_relayer_remove_paying_key_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->user_key))
...
__Z_INLINE parser_error_t _readMethod_relayer_update_polyx_limit_V7(
    parser_context_t* c, pd_relayer_update_polyx_limit_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->user_key))
    CHECK_ERROR(_readBalance(c, &m->polyx_limit))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_relayer_increase_polyx_limit_V7(
    parser_context_t* c, pd_relayer_increase_polyx_limit_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->user_key))
    CHECK_ERROR(_readBalance(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_relayer_decrease_polyx_limit_V7(
    parser_context_t* c, pd_relayer_decrease_polyx_limit_V7_t* m)
{
    CHECK_ERROR(_readAccountId(c, &m->user_key))
    CHECK_ERROR(_readBalance(c, &m->amount))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_contracts_call_old_weight_V7(
    parser_context_t* c, pd_contracts_call_old_weight_V7_t* m)
{
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_old_weight_V7(
    parser_context_t* c, pd_contracts_instantiate_old_weight_V7_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readCompactu64(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_upload_code_V7(
    parser_context_t* c, pd_contracts_upload_code_V7_t* m)
{
    CHECK_ERROR(_readBytes(c, &m->code))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_contracts_remove_code_V7(
    parser_context_t* c, pd_contracts_remove_code_V7_t* m)
{
    CHECK_ERROR(_readCodeHash(c, &m->code_hash))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_contracts_set_code_V7(
    parser_context_t* c, pd_contracts_set_code_V7_t* m)
{
    CHECK_ERROR(_readAccountIdLookupOfT(c, &m->dest))
    CHECK_ERROR(_readCodeHash(c, &m->code_hash))
    return parser_ok;
...
__Z_INLINE parser_error_t _readMethod_contracts_instantiate_with_code_V7(
    parser_context_t* c, pd_contracts_instantiate_with_code_V7_t* m)
{
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    CHECK_ERROR(_readWeight(c, &m->gas_limit))
    CHECK_ERROR(_readOptionCompactBalanceOf(c, &m->storage_deposit_limit))
...
__Z_INLINE parser_error_t _readMethod_polymeshcontracts_upgrade_api_V7(
    parser_context_t* c, pd_polymeshcontracts_upgrade_api_V7_t* m)
{
    ...
    pd_Method_V7_t* method)
{
    ...
    case 6686: /* module 26 call 30 */
        CHECK_ERROR(_readMethod_asset_remove_mandatory_mediators_V7(c, &method->basic.asset_remove_mandatory_mediators_V7))
        break;
    ...
    case 7688: /* module 30 call 8 */
        CHECK_ERROR(_readMethod_corporateaction_initiate_corporate_action_and_distribute_V7(c, &method->nested.corporateaction_initiate_corporate_action_and_distribute_V7))
        break;
    ...
    case 8713: /* module 34 call 9 */
        CHECK_ERROR(_readMethod_portfolio_revoke_create_portfolios_permission_V7(c, &method->basic.portfolio_revoke_create_portfolios_permission_V7))
        break;
    case 8714: /* module 34 call 10 */
        CHECK_ERROR(_readMethod_portfolio_create_custody_portfolio_V7(c, &method->basic.portfolio_create_custody_portfolio_V7))
        break;
    case 9487: /* module 37 call 15 */
        CHECK_ERROR(_readMethod_settlement_affirm_with_receipts_with_count_V7(c, &method->basic.settlement_affirm_with_receipts_with_count_V7))
        break;
    case 9488: /* module 37 call 16 */
        CHECK_ERROR(_readMethod_settlement_affirm_instruction_with_count_V7(c, &method->basic.settlement_affirm_instruction_with_count_V7))
        break;
    case 9489: /* module 37 call 17 */
        CHECK_ERROR(_readMethod_settlement_reject_instruction_with_count_V7(c, &method->basic.settlement_reject_instruction_with_count_V7))
        break;
    case 9490: /* module 37 call 18 */
        CHECK_ERROR(_readMethod_settlement_withdraw_affirmation_with_count_V7(c, &method->basic.settlement_withdraw_affirmation_with_count_V7))
        break;
    case 9491: /* module 37 call 19 */
        CHECK_ERROR(_readMethod_settlement_add_instruction_with_mediators_V7(c, &method->basic.settlement_add_instruction_with_mediators_V7))
        break;
    case 9492: /* module 37 call 20 */
        CHECK_ERROR(_readMethod_settlement_add_and_affirm_with_mediators_V7(c, &method->basic.settlement_add_and_affirm_with_mediators_V7))
        break;
    case 9493: /* module 37 call 21 */
        CHECK_ERROR(_readMethod_settlement_affirm_instruction_as_mediator_V7(c, &method->basic.settlement_affirm_instruction_as_mediator_V7))
        break;
    case 9494: /* module 37 call 22 */
        CHECK_ERROR(_readMethod_settlement_withdraw_affirmation_as_mediator_V7(c, &method->basic.settlement_withdraw_affirmation_as_mediator_V7))
        break;
    case 9495: /* module 37 call 23 */
        CHECK_ERROR(_readMethod_settlement_reject_instruction_as_mediator_V7(c, &method->basic.settlement_reject_instruction_as_mediator_V7))
        break;
    ...
    case 1807: /* module 7 call 15 */
        CHECK_ERROR(_readMethod_identity_rotate_primary_key_to_secondary_V7(c, &method->nested.identity_rotate_primary_key_to_secondary_V7))
        break;
    ...
    case 1809: /* module 7 call 17 */
        CHECK_ERROR(_readMethod_identity_set_secondary_key_permissions_V7(c, &method->nested.identity_set_secondary_key_permissions_V7))
        break;
    ...
    case 1811: /* module 7 call 19 */
        CHECK_ERROR(_readMethod_identity_register_custom_claim_type_V7(c, &method->nested.identity_register_custom_claim_type_V7))
        break;
    case 1812: /* module 7 call 20 */
        CHECK_ERROR(_readMethod_identity_cdd_register_did_with_cdd_V7(c, &method->nested.identity_cdd_register_did_with_cdd_V7))
        break;
    ...
    case 1814: /* module 7 call 22 */
        CHECK_ERROR(_readMethod_identity_create_child_identities_V7(c, &method->nested.identity_create_child_identities_V7))
        break;
    ...
    case 3844: /* module 15 call 4 */
        CHECK_ERROR(_readMethod_multisig_accept_multisig_signer_V7(c, &method->nested.multisig_accept_multisig_signer_V7))
        break;
    ...
    case 3846: /* module 15 call 6 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signers_V7(c, &method->nested.multisig_remove_multisig_signers_V7))
        break;
    case 3847: /* module 15 call 7 */
        CHECK_ERROR(_readMethod_multisig_add_multisig_signers_via_admin_V7(c, &method->nested.multisig_add_multisig_signers_via_admin_V7))
        break;
    case 3848: /* module 15 call 8 */
        CHECK_ERROR(_readMethod_multisig_remove_multisig_signers_via_admin_V7(c, &method->nested.multisig_remove_multisig_signers_via_admin_V7))
        break;
    case 3850: /* module 15 call 10 */
        CHECK_ERROR(_readMethod_multisig_change_sigs_required_via_admin_V7(c, &method->nested.multisig_change_sigs_required_via_admin_V7))
        break;
    ...
    case 3852: /* module 15 call 12 */
        CHECK_ERROR(_readMethod_multisig_remove_admin_via_admin_V7(c, &method->nested.multisig_remove_admin_via_admin_V7))
        break;
    ...
    case 3854: /* module 15 call 14 */
        CHECK_ERROR(_readMethod_multisig_remove_payer_via_payer_V7(c, &method->nested.multisig_remove_payer_via_payer_V7))
        break;
    ...
    case 4376: /* module 17 call 24 */
        CHECK_ERROR(_readMethod_staking_force_apply_min_commission_V7(c, &method->nested.staking_force_apply_min_commission_V7))
        break;
    ...
    case 6671: /* module 26 call 15 */
        CHECK_ERROR(_readMethod_asset_register_custom_asset_type_V7(c, &method->basic.asset_register_custom_asset_type_V7))
        break;
    case 6672: /* module 26 call 16 */
        CHECK_ERROR(_readMethod_asset_create_asset_with_custom_type_V7(c, &method->basic.asset_create_asset_with_custom_type_V7))
        break;
    ...
    case 6674: /* module 26 call 18 */
        CHECK_ERROR(_readMethod_asset_set_asset_metadata_details_V7(c, &method->basic.asset_set_asset_metadata_details_V7))
        break;
    case 6675: /* module 26 call 19 */
        CHECK_ERROR(_readMethod_asset_register_and_set_local_asset_metadata_V7(c, &method->basic.asset_register_and_set_local_asset_metadata_V7))
        break;
    case 6676: /* module 26 call 20 */
        CHECK_ERROR(_readMethod_asset_register_asset_metadata_local_type_V7(c, &method->basic.asset_register_asset_metadata_local_type_V7))
        break;
    case 6677: /* module 26 call 21 */
        CHECK_ERROR(_readMethod_asset_register_asset_metadata_global_type_V7(c, &method->basic.asset_register_asset_metadata_global_type_V7))
        break;
    ...
    case 6682: /* module 26 call 26 */
        CHECK_ERROR(_readMethod_asset_remove_asset_affirmation_exemption_V7(c, &method->basic.asset_remove_asset_affirmation_exemption_V7))
        break;
    ...
    case 8707: /* module 34 call 3 */
        CHECK_ERROR(_readMethod_portfolio_quit_portfolio_custody_V7(c, &method->basic.portfolio_quit_portfolio_custody_V7))
        break;
    case 8708: /* module 34 call 4 */
        CHECK_ERROR(_readMethod_portfolio_accept_portfolio_custody_V7(c, &method->basic.portfolio_accept_portfolio_custody_V7))
        break;
    ...
    case 8711: /* module 34 call 7 */
        CHECK_ERROR(_readMethod_portfolio_remove_portfolio_pre_approval_V7(c, &method->basic.portfolio_remove_portfolio_pre_approval_V7))
        break;
    ...
    case 9480: /* module 37 call 8 */
        CHECK_ERROR(_readMethod_settlement_execute_manual_instruction_V7(c, &method->basic.settlement_execute_manual_instruction_V7))
        break;
    ...
    case 11009: /* module 43 call 1 */
        CHECK_ERROR(_readMethod_externalagents_set_group_permissions_V7(c, &method->basic.externalagents_set_group_permissions_V7))
        break;
    ...
    case 11014: /* module 43 call 6 */
        CHECK_ERROR(_readMethod_externalagents_create_group_and_add_auth_V7(c, &method->basic.externalagents_create_group_and_add_auth_V7))
        break;
    ...
    case 11777: /* module 46 call 1 */
        CHECK_ERROR(_readMethod_contracts_instantiate_with_code_old_weight_V7(c, &method->basic.contracts_instantiate_with_code_old_weight_V7))
        break;
    case 11778: /* module 46 call 2 */
        CHECK_ERROR(_readMethod_contracts_instantiate_old_weight_V7(c, &method->basic.contracts_instantiate_old_weight_V7))
        break;
    ...
    case 12032: /* module 47 call 0 */
        CHECK_ERROR(_readMethod_polymeshcontracts_instantiate_with_code_perms_V7(c, &method->basic.polymeshcontracts_instantiate_with_code_perms_V7))
        break;
    ...
    case 12034: /* module 47 call 2 */
        CHECK_ERROR(_readMethod_polymeshcontracts_update_call_runtime_whitelist_V7(c, &method->basic.polymeshcontracts_update_call_runtime_whitelist_V7))
        break;
    case 12035: /* module 47 call 3 */
        CHECK_ERROR(_readMethod_polymeshcontracts_instantiate_with_code_as_primary_key_V7(c, &method->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7))
        break;
    case 12036: /* module 47 call 4 */
        CHECK_ERROR(_readMethod_polymeshcontracts_instantiate_with_hash_as_primary_key_V7(c, &method->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 1281: /* module 5 call 1 */
        ...
        case 1: /* balances_transfer_with_memo_V7 - amount */;
            return _toStringCompactBalance(
                &m->nested.balances_transfer_with_memo_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 1802: /* module 7 call 10 */
        ...
        case 1: /* identity_add_authorization_V7 - data */;
            return _toStringAuthorizationDataAccountId(
                &m->nested.identity_add_authorization_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 3840: /* module 15 call 0 */
        ...
        case 2: /* multisig_create_multisig_V7 - permissions */;
            return _toStringOptionPermissions(
                &m->nested.multisig_create_multisig_V7.permissions,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6685: /* module 26 call 29 */
        ...
        case 1: /* asset_add_mandatory_mediators_V7 - mediators */;
            return _toStringBoundedBTreeSetIdentityIdMaxAssetMediators(
                &m->basic.asset_add_mandatory_mediators_V7.mediators,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6686: /* module 26 call 30 */
        ...
        case 1: /* asset_remove_mandatory_mediators_V7 - mediators */;
            return _toStringBoundedBTreeSetIdentityIdMaxAssetMediators(
                &m->basic.asset_remove_mandatory_mediators_V7.mediators,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 7688: /* module 30 call 8 */
        ...
        case 0: /* corporateaction_initiate_corporate_action_and_distribute_V7 - ca_args */;
            return _toStringInitiateCorporateActionArgs(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.ca_args,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* corporateaction_initiate_corporate_action_and_distribute_V7 - portfolio */;
            return _toStringOptionPortfolioNumber(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 3: /* corporateaction_initiate_corporate_action_and_distribute_V7 - per_share */;
            return _toStringBalance(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.per_share,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* corporateaction_initiate_corporate_action_and_distribute_V7 - amount */;
            return _toStringBalance(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* corporateaction_initiate_corporate_action_and_distribute_V7 - payment_at */;
            return _toStringMoment(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.payment_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* corporateaction_initiate_corporate_action_and_distribute_V7 - expires_at */;
            return _toStringOptionMoment(
                &m->nested.corporateaction_initiate_corporate_action_and_distribute_V7.expires_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8712: /* module 34 call 8 */
        ...
        case 0: /* portfolio_allow_identity_to_create_portfolios_V7 - trusted_identity */;
            return _toStringIdentityId(
                &m->basic.portfolio_allow_identity_to_create_portfolios_V7.trusted_identity,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8713: /* module 34 call 9 */
        ...
        case 0: /* portfolio_revoke_create_portfolios_permission_V7 - identity */;
            return _toStringIdentityId(
                &m->basic.portfolio_revoke_create_portfolios_permission_V7.identity,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8714: /* module 34 call 10 */
        ...
        case 0: /* portfolio_create_custody_portfolio_V7 - portfolio_owner_id */;
            return _toStringIdentityId(
                &m->basic.portfolio_create_custody_portfolio_V7.portfolio_owner_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* portfolio_create_custody_portfolio_V7 - portfolio_name */;
            return _toStringPortfolioName(
                &m->basic.portfolio_create_custody_portfolio_V7.portfolio_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9488: /* module 37 call 16 */
        ...
        case 0: /* settlement_affirm_instruction_with_count_V7 - id */;
            return _toStringInstructionId(
                &m->basic.settlement_affirm_instruction_with_count_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_affirm_instruction_with_count_V7 - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_affirm_instruction_with_count_V7.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_affirm_instruction_with_count_V7 - number_of_assets */;
            return _toStringOptionAffirmationCount(
                &m->basic.settlement_affirm_instruction_with_count_V7.number_of_assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9490: /* module 37 call 18 */
        ...
        case 0: /* settlement_withdraw_affirmation_with_count_V7 - id */;
            return _toStringInstructionId(
                &m->basic.settlement_withdraw_affirmation_with_count_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_withdraw_affirmation_with_count_V7 - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_withdraw_affirmation_with_count_V7.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_withdraw_affirmation_with_count_V7 - number_of_assets */;
            return _toStringOptionAffirmationCount(
                &m->basic.settlement_withdraw_affirmation_with_count_V7.number_of_assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9491: /* module 37 call 19 */
        ...
        case 0: /* settlement_add_instruction_with_mediators_V7 - venue_id */;
            return _toStringOptionVenueId(
                &m->basic.settlement_add_instruction_with_mediators_V7.venue_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 2: /* settlement_add_instruction_with_mediators_V7 - trade_date */;
            return _toStringOptionMoment(
                &m->basic.settlement_add_instruction_with_mediators_V7.trade_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* settlement_add_instruction_with_mediators_V7 - value_date */;
            return _toStringOptionMoment(
                &m->basic.settlement_add_instruction_with_mediators_V7.value_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* settlement_add_instruction_with_mediators_V7 - legs */;
            return _toStringVecLeg(
                &m->basic.settlement_add_instruction_with_mediators_V7.legs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* settlement_add_instruction_with_mediators_V7 - instruction_memo */;
            return _toStringOptionMemo(
                &m->basic.settlement_add_instruction_with_mediators_V7.instruction_memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* settlement_add_instruction_with_mediators_V7 - mediators */;
            return _toStringBoundedBTreeSetIdentityIdMaxInstructionMediators(
                &m->basic.settlement_add_instruction_with_mediators_V7.mediators,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9492: /* module 37 call 20 */
        ...
        case 0: /* settlement_add_and_affirm_with_mediators_V7 - venue_id */;
            return _toStringOptionVenueId(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.venue_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_add_and_affirm_with_mediators_V7 - settlement_type */;
            return _toStringSettlementTypeBlockNumber(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.settlement_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_add_and_affirm_with_mediators_V7 - trade_date */;
            return _toStringOptionMoment(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.trade_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* settlement_add_and_affirm_with_mediators_V7 - value_date */;
            return _toStringOptionMoment(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.value_date,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* settlement_add_and_affirm_with_mediators_V7 - legs */;
            return _toStringVecLeg(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.legs,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* settlement_add_and_affirm_with_mediators_V7 - portfolios */;
            return _toStringVecPortfolioId(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.portfolios,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* settlement_add_and_affirm_with_mediators_V7 - instruction_memo */;
            return _toStringOptionMemo(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.instruction_memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 7: /* settlement_add_and_affirm_with_mediators_V7 - mediators */;
            return _toStringBoundedBTreeSetIdentityIdMaxInstructionMediators(
                &m->basic.settlement_add_and_affirm_with_mediators_V7.mediators,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9493: /* module 37 call 21 */
        ...
        case 0: /* settlement_affirm_instruction_as_mediator_V7 - instruction_id */;
            return _toStringInstructionId(
                &m->basic.settlement_affirm_instruction_as_mediator_V7.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_affirm_instruction_as_mediator_V7 - expiry */;
            return _toStringOptionMoment(
                &m->basic.settlement_affirm_instruction_as_mediator_V7.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9494: /* module 37 call 22 */
        ...
        case 0: /* settlement_withdraw_affirmation_as_mediator_V7 - instruction_id */;
            return _toStringInstructionId(
                &m->basic.settlement_withdraw_affirmation_as_mediator_V7.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9495: /* module 37 call 23 */
        ...
        case 0: /* settlement_reject_instruction_as_mediator_V7 - instruction_id */;
            return _toStringInstructionId(
                &m->basic.settlement_reject_instruction_as_mediator_V7.instruction_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_reject_instruction_as_mediator_V7 - number_of_assets */;
            return _toStringOptionAssetCount(
                &m->basic.settlement_reject_instruction_as_mediator_V7.number_of_assets,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12547: /* module 49 call 3 */
        ...
        case 0: /* nft_controller_transfer_V7 - nfts */;
            return _toStringNFTs(
                &m->basic.nft_controller_transfer_V7.nfts,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* nft_controller_transfer_V7 - source_portfolio */;
            return _toStringPortfolioId(
                &m->basic.nft_controller_transfer_V7.source_portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 1282: /* module 5 call 2 */
        ...
        case 0: /* balances_deposit_block_reward_reserve_balance_V7 - amount */;
            return _toStringCompactBalance(
                &m->nested.balances_deposit_block_reward_reserve_balance_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1806: /* module 7 call 14 */
        ...
        case 0: /* identity_revoke_claim_by_index_V7 - target */;
            return _toStringIdentityId(
                &m->nested.identity_revoke_claim_by_index_V7.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_revoke_claim_by_index_V7 - claim_type */;
            return _toStringClaimType(
                &m->nested.identity_revoke_claim_by_index_V7.claim_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_revoke_claim_by_index_V7 - scope */;
            return _toStringOptionScope(
                &m->nested.identity_revoke_claim_by_index_V7.scope,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1807: /* module 7 call 15 */
        ...
        case 0: /* identity_rotate_primary_key_to_secondary_V7 - auth_id */;
            return _toStringu64(
                &m->nested.identity_rotate_primary_key_to_secondary_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_rotate_primary_key_to_secondary_V7 - optional_cdd_auth_id */;
            return _toStringOptionu64(
                &m->nested.identity_rotate_primary_key_to_secondary_V7.optional_cdd_auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1809: /* module 7 call 17 */
        ...
        case 0: /* identity_set_secondary_key_permissions_V7 - key */;
            return _toStringAccountId(
                &m->nested.identity_set_secondary_key_permissions_V7.key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_set_secondary_key_permissions_V7 - perms */;
            return _toStringPermissions(
                &m->nested.identity_set_secondary_key_permissions_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1810: /* module 7 call 18 */
        ...
        case 0: /* identity_remove_secondary_keys_V7 - keys_to_remove */;
            return _toStringVecAccountId(
                &m->nested.identity_remove_secondary_keys_V7.keys_to_remove,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1811: /* module 7 call 19 */
        ...
        case 0: /* identity_register_custom_claim_type_V7 - ty */;
            return _toStringVecu8(
                &m->nested.identity_register_custom_claim_type_V7.ty,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1812: /* module 7 call 20 */
        ...
        case 0: /* identity_cdd_register_did_with_cdd_V7 - target_account */;
            return _toStringAccountId(
                &m->nested.identity_cdd_register_did_with_cdd_V7.target_account,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_cdd_register_did_with_cdd_V7 - secondary_keys */;
            return _toStringVecSecondaryKeyAccountId(
                &m->nested.identity_cdd_register_did_with_cdd_V7.secondary_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* identity_cdd_register_did_with_cdd_V7 - expiry */;
            return _toStringOptionMoment(
                &m->nested.identity_cdd_register_did_with_cdd_V7.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1813: /* module 7 call 21 */
        ...
        case 0: /* identity_create_child_identity_V7 - secondary_key */;
            return _toStringAccountId(
                &m->nested.identity_create_child_identity_V7.secondary_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1814: /* module 7 call 22 */
        ...
        case 0: /* identity_create_child_identities_V7 - child_keys */;
            return _toStringVecCreateChildIdentityWithAuthAccountId(
                &m->nested.identity_create_child_identities_V7.child_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* identity_create_child_identities_V7 - expires_at */;
            return _toStringMoment(
                &m->nested.identity_create_child_identities_V7.expires_at,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 1815: /* module 7 call 23 */
        ...
        case 0: /* identity_unlink_child_identity_V7 - child_did */;
            return _toStringIdentityId(
                &m->nested.identity_unlink_child_identity_V7.child_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3841: /* module 15 call 1 */
        ...
        case 0: /* multisig_create_proposal_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_create_proposal_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_create_proposal_V7 - proposal */;
            return _toStringBoxTasConfigProposal(
                &m->nested.multisig_create_proposal_V7.proposal,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* multisig_create_proposal_V7 - expiry */;
            return _toStringOptionMoment(
                &m->nested.multisig_create_proposal_V7.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3842: /* module 15 call 2 */
        ...
        case 0: /* multisig_approve_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_approve_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_approve_V7 - proposal_id */;
            return _toStringu64(
                &m->nested.multisig_approve_V7.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* multisig_approve_V7 - max_weight */;
            return _toStringOptionWeight(
                &m->nested.multisig_approve_V7.max_weight,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3843: /* module 15 call 3 */
        ...
        case 0: /* multisig_reject_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_reject_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_reject_V7 - proposal_id */;
            return _toStringu64(
                &m->nested.multisig_reject_V7.proposal_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3844: /* module 15 call 4 */
        ...
        case 0: /* multisig_accept_multisig_signer_V7 - auth_id */;
            return _toStringu64(
                &m->nested.multisig_accept_multisig_signer_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3845: /* module 15 call 5 */
        ...
        case 0: /* multisig_add_multisig_signers_V7 - signers */;
            return _toStringBoundedVecAccountIdMaxSigners(
                &m->nested.multisig_add_multisig_signers_V7.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3846: /* module 15 call 6 */
        ...
        case 0: /* multisig_remove_multisig_signers_V7 - signers */;
            return _toStringBoundedVecAccountIdMaxSigners(
                &m->nested.multisig_remove_multisig_signers_V7.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3847: /* module 15 call 7 */
        ...
        case 0: /* multisig_add_multisig_signers_via_admin_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_add_multisig_signers_via_admin_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_add_multisig_signers_via_admin_V7 - signers */;
            return _toStringBoundedVecAccountIdMaxSigners(
                &m->nested.multisig_add_multisig_signers_via_admin_V7.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3848: /* module 15 call 8 */
        ...
        case 0: /* multisig_remove_multisig_signers_via_admin_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_remove_multisig_signers_via_admin_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_remove_multisig_signers_via_admin_V7 - signers */;
            return _toStringBoundedVecAccountIdMaxSigners(
                &m->nested.multisig_remove_multisig_signers_via_admin_V7.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3850: /* module 15 call 10 */
        ...
        case 0: /* multisig_change_sigs_required_via_admin_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_change_sigs_required_via_admin_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_change_sigs_required_via_admin_V7 - signatures_required */;
            return _toStringu64(
                &m->nested.multisig_change_sigs_required_via_admin_V7.signatures_required,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3851: /* module 15 call 11 */
        ...
        case 0: /* multisig_add_admin_V7 - admin_did */;
            return _toStringIdentityId(
                &m->nested.multisig_add_admin_V7.admin_did,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3852: /* module 15 call 12 */
        ...
        case 0: /* multisig_remove_admin_via_admin_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_remove_admin_via_admin_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3854: /* module 15 call 14 */
        ...
        case 0: /* multisig_remove_payer_via_payer_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_remove_payer_via_payer_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3855: /* module 15 call 15 */
        ...
        case 0: /* multisig_approve_join_identity_V7 - multisig */;
            return _toStringAccountId(
                &m->nested.multisig_approve_join_identity_V7.multisig,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* multisig_approve_join_identity_V7 - auth_id */;
            return _toStringu64(
                &m->nested.multisig_approve_join_identity_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 3856: /* module 15 call 16 */
        ...
        case 0: /* multisig_join_identity_V7 - auth_id */;
            return _toStringu64(
                &m->nested.multisig_join_identity_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4366: /* module 17 call 14 */
        ...
        case 0: /* staking_set_invulnerables_V7 - invulnerables */;
            return _toStringVecAccountId(
                &m->nested.staking_set_invulnerables_V7.invulnerables,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4375: /* module 17 call 23 */
        ...
        case 0: /* staking_chill_other_V7 - controller */;
            return _toStringAccountId(
                &m->nested.staking_chill_other_V7.controller,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4376: /* module 17 call 24 */
        ...
        case 0: /* staking_force_apply_min_commission_V7 - validator_stash */;
            return _toStringAccountId(
                &m->nested.staking_force_apply_min_commission_V7.validator_stash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4377: /* module 17 call 25 */
        ...
        case 0: /* staking_set_min_commission_V7 - new_ */;
            return _toStringPerbill(
                &m->nested.staking_set_min_commission_V7.new_,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 4384: /* module 17 call 32 */
        ...
        case 0: /* staking_chill_from_governance_V7 - identity */;
            return _toStringIdentityId(
                &m->nested.staking_chill_from_governance_V7.identity,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* staking_chill_from_governance_V7 - stash_keys */;
            return _toStringVecAccountId(
                &m->nested.staking_chill_from_governance_V7.stash_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6656: /* module 26 call 0 */
        ...
        case 0: /* asset_register_unique_ticker_V7 - ticker */;
            return _toStringTicker(
                &m->basic.asset_register_unique_ticker_V7.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6659: /* module 26 call 3 */
        ...
        case 0: /* asset_create_asset_V7 - asset_name */;
            return _toStringAssetName(
                &m->nested.asset_create_asset_V7.asset_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 3: /* asset_create_asset_V7 - asset_identifiers */;
            return _toStringVecAssetIdentifier(
                &m->nested.asset_create_asset_V7.asset_identifiers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* asset_create_asset_V7 - funding_round_name */;
            return _toStringOptionFundingRoundName(
                &m->nested.asset_create_asset_V7.funding_round_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6662: /* module 26 call 6 */
        ...
        case 1: /* asset_rename_asset_V7 - asset_name */;
            return _toStringAssetName(
                &m->nested.asset_rename_asset_V7.asset_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6663: /* module 26 call 7 */
        ...
        case 1: /* asset_issue_V7 - amount */;
            return _toStringBalanceNoSymbol(
                &m->nested.asset_issue_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_issue_V7 - portfolio_kind */;
            return _toStringPortfolioKind(
                &m->nested.asset_issue_V7.portfolio_kind,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6664: /* module 26 call 8 */
        ...
        case 1: /* asset_redeem_V7 - amount */;
            return _toStringBalanceNoSymbol(
                &m->nested.asset_redeem_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_redeem_V7 - portfolio_kind */;
            return _toStringPortfolioKind(
                &m->nested.asset_redeem_V7.portfolio_kind,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6667: /* module 26 call 11 */
        ...
        case 0: /* asset_remove_documents_V7 - docs_id */;
            return _toStringVecDocumentId(
                &m->nested.asset_remove_documents_V7.docs_id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 6668: /* module 26 call 12 */
        ...
        case 1: /* asset_set_funding_round_V7 - founding_round_name */;
            return _toStringFundingRoundName(
                &m->nested.asset_set_funding_round_V7.founding_round_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6669: /* module 26 call 13 */
        ...
        case 1: /* asset_update_identifiers_V7 - asset_identifiers */;
            return _toStringVecAssetIdentifier(
                &m->nested.asset_update_identifiers_V7.asset_identifiers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6670: /* module 26 call 14 */
        ...
        case 1: /* asset_controller_transfer_V7 - amount */;
            return _toStringBalanceNoSymbol(
                &m->basic.asset_controller_transfer_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 6671: /* module 26 call 15 */
        ...
        case 0: /* asset_register_custom_asset_type_V7 - ty */;
            return _toStringVecu8(
                &m->basic.asset_register_custom_asset_type_V7.ty,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6672: /* module 26 call 16 */
        ...
        case 0: /* asset_create_asset_with_custom_type_V7 - asset_name */;
            return _toStringAssetName(
                &m->basic.asset_create_asset_with_custom_type_V7.asset_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_create_asset_with_custom_type_V7 - divisible */;
            return _toStringbool(
                &m->basic.asset_create_asset_with_custom_type_V7.divisible,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_create_asset_with_custom_type_V7 - custom_asset_type */;
            return _toStringVecu8(
                &m->basic.asset_create_asset_with_custom_type_V7.custom_asset_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* asset_create_asset_with_custom_type_V7 - asset_identifiers */;
            return _toStringVecAssetIdentifier(
                &m->basic.asset_create_asset_with_custom_type_V7.asset_identifiers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* asset_create_asset_with_custom_type_V7 - funding_round_name */;
            return _toStringOptionFundingRoundName(
                &m->basic.asset_create_asset_with_custom_type_V7.funding_round_name,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6674: /* module 26 call 18 */
        ...
        case 1: /* asset_set_asset_metadata_details_V7 - key */;
            return _toStringAssetMetadataKey(
                &m->basic.asset_set_asset_metadata_details_V7.key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_set_asset_metadata_details_V7 - detail */;
            return _toStringAssetMetadataValueDetailMoment(
                &m->basic.asset_set_asset_metadata_details_V7.detail,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6675: /* module 26 call 19 */
        ...
        case 1: /* asset_register_and_set_local_asset_metadata_V7 - name */;
            return _toStringAssetMetadataName(
                &m->basic.asset_register_and_set_local_asset_metadata_V7.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_register_and_set_local_asset_metadata_V7 - spec */;
            return _toStringAssetMetadataSpec(
                &m->basic.asset_register_and_set_local_asset_metadata_V7.spec,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* asset_register_and_set_local_asset_metadata_V7 - value */;
            return _toStringAssetMetadataValue(
                &m->basic.asset_register_and_set_local_asset_metadata_V7.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* asset_register_and_set_local_asset_metadata_V7 - detail */;
            return _toStringOptionAssetMetadataValueDetailMoment(
                &m->basic.asset_register_and_set_local_asset_metadata_V7.detail,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6676: /* module 26 call 20 */
        ...
        case 1: /* asset_register_asset_metadata_local_type_V7 - name */;
            return _toStringAssetMetadataName(
                &m->basic.asset_register_asset_metadata_local_type_V7.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* asset_register_asset_metadata_local_type_V7 - spec */;
            return _toStringAssetMetadataSpec(
                &m->basic.asset_register_asset_metadata_local_type_V7.spec,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6677: /* module 26 call 21 */
        ...
        case 0: /* asset_register_asset_metadata_global_type_V7 - name */;
            return _toStringAssetMetadataName(
                &m->basic.asset_register_asset_metadata_global_type_V7.name,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* asset_register_asset_metadata_global_type_V7 - spec */;
            return _toStringAssetMetadataSpec(
                &m->basic.asset_register_asset_metadata_global_type_V7.spec,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6678: /* module 26 call 22 */
        ...
        case 1: /* asset_update_asset_type_V7 - asset_type */;
            return _toStringAssetType(
                &m->basic.asset_update_asset_type_V7.asset_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6679: /* module 26 call 23 */
        ...
        case 1: /* asset_remove_local_metadata_key_V7 - local_key */;
            return _toStringAssetMetadataLocalKey(
                &m->basic.asset_remove_local_metadata_key_V7.local_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6680: /* module 26 call 24 */
        ...
        case 1: /* asset_remove_metadata_value_V7 - metadata_key */;
            return _toStringAssetMetadataKey(
                &m->basic.asset_remove_metadata_value_V7.metadata_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 6687: /* module 26 call 31 */
        ...
        case 0: /* asset_link_ticker_to_asset_id_V7 - ticker */;
            return _toStringTicker(
                &m->basic.asset_link_ticker_to_asset_id_V7.ticker,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 8707: /* module 34 call 3 */
        ...
        case 0: /* portfolio_quit_portfolio_custody_V7 - pid */;
            return _toStringPortfolioId(
                &m->basic.portfolio_quit_portfolio_custody_V7.pid,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8708: /* module 34 call 4 */
        ...
        case 0: /* portfolio_accept_portfolio_custody_V7 - auth_id */;
            return _toStringu64(
                &m->basic.portfolio_accept_portfolio_custody_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8709: /* module 34 call 5 */
        ...
        case 2: /* portfolio_move_portfolio_funds_V7 - funds */;
            return _toStringVecFund(
                &m->nested.portfolio_move_portfolio_funds_V7.funds,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8710: /* module 34 call 6 */
        ...
        case 1: /* portfolio_pre_approve_portfolio_V7 - portfolio_id */;
            return _toStringPortfolioId(
                &m->basic.portfolio_pre_approve_portfolio_V7.portfolio_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 8711: /* module 34 call 7 */
        ...
        case 1: /* portfolio_remove_portfolio_pre_approval_V7 - portfolio_id */;
            return _toStringPortfolioId(
                &m->basic.portfolio_remove_portfolio_pre_approval_V7.portfolio_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9472: /* module 37 call 0 */
        ...
        case 2: /* settlement_create_venue_V7 - typ */;
            return _toStringVenueType(
                &m->nested.settlement_create_venue_V7.typ,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9473: /* module 37 call 1 */
        ...
        case 0: /* settlement_update_venue_details_V7 - id */;
            return _toStringVenueId(
                &m->basic.settlement_update_venue_details_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_update_venue_details_V7 - details */;
            return _toStringVenueDetails(
                &m->basic.settlement_update_venue_details_V7.details,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9474: /* module 37 call 2 */
        ...
        case 0: /* settlement_update_venue_type_V7 - id */;
            return _toStringVenueId(
                &m->basic.settlement_update_venue_type_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_update_venue_type_V7 - typ */;
            return _toStringVenueType(
                &m->basic.settlement_update_venue_type_V7.typ,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9475: /* module 37 call 3 */
        ...
        case 0: /* settlement_affirm_with_receipts_V7 - id */;
            return _toStringInstructionId(
                &m->nested.settlement_affirm_with_receipts_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 9479: /* module 37 call 7 */
        ...
        case 0: /* settlement_update_venue_signers_V7 - id */;
            return _toStringVenueId(
                &m->basic.settlement_update_venue_signers_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_update_venue_signers_V7 - signers */;
            return _toStringVecAccountId(
                &m->basic.settlement_update_venue_signers_V7.signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_update_venue_signers_V7 - add_signers */;
            return _toStringbool(
                &m->basic.settlement_update_venue_signers_V7.add_signers,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9480: /* module 37 call 8 */
        ...
        case 0: /* settlement_execute_manual_instruction_V7 - id */;
            return _toStringInstructionId(
                &m->basic.settlement_execute_manual_instruction_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_execute_manual_instruction_V7 - portfolio */;
            return _toStringOptionPortfolioId(
                &m->basic.settlement_execute_manual_instruction_V7.portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* settlement_execute_manual_instruction_V7 - fungible_transfers */;
            return _toStringu32(
                &m->basic.settlement_execute_manual_instruction_V7.fungible_transfers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* settlement_execute_manual_instruction_V7 - nfts_transfers */;
            return _toStringu32(
                &m->basic.settlement_execute_manual_instruction_V7.nfts_transfers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* settlement_execute_manual_instruction_V7 - offchain_transfers */;
            return _toStringu32(
                &m->basic.settlement_execute_manual_instruction_V7.offchain_transfers,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* settlement_execute_manual_instruction_V7 - weight_limit */;
            return _toStringOptionWeight(
                &m->basic.settlement_execute_manual_instruction_V7.weight_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9481: /* module 37 call 9 */
        ...
        case 5: /* settlement_add_instruction_V7 - instruction_memo */;
            return _toStringOptionMemo(
                &m->nested.settlement_add_instruction_V7.instruction_memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9482: /* module 37 call 10 */
        ...
        case 6: /* settlement_add_and_affirm_instruction_V7 - instruction_memo */;
            return _toStringOptionMemo(
                &m->nested.settlement_add_and_affirm_instruction_V7.instruction_memo,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9483: /* module 37 call 11 */
        ...
        case 0: /* settlement_affirm_instruction_V7 - id */;
            return _toStringInstructionId(
                &m->nested.settlement_affirm_instruction_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 9484: /* module 37 call 12 */
        ...
        case 0: /* settlement_withdraw_affirmation_V7 - id */;
            return _toStringInstructionId(
                &m->nested.settlement_withdraw_affirmation_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 9485: /* module 37 call 13 */
        ...
        case 0: /* settlement_reject_instruction_V7 - id */;
            return _toStringInstructionId(
                &m->nested.settlement_reject_instruction_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* settlement_reject_instruction_V7 - portfolio */;
            return _toStringPortfolioId(
                &m->nested.settlement_reject_instruction_V7.portfolio,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9486: /* module 37 call 14 */
        ...
        case 0: /* settlement_execute_scheduled_instruction_V7 - id */;
            return _toStringInstructionId(
                &m->nested.settlement_execute_scheduled_instruction_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 9986: /* module 39 call 2 */
        ...
        case 1: /* sto_freeze_fundraiser_V7 - id */;
            return _toStringFundraiserId(
                &m->basic.sto_freeze_fundraiser_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9987: /* module 39 call 3 */
        ...
        case 1: /* sto_unfreeze_fundraiser_V7 - id */;
            return _toStringFundraiserId(
                &m->basic.sto_unfreeze_fundraiser_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 9988: /* module 39 call 4 */
        ...
        case 1: /* sto_modify_fundraiser_window_V7 - id */;
            return _toStringFundraiserId(
                &m->basic.sto_modify_fundraiser_window_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 11008: /* module 43 call 0 */
        ...
        case 1: /* externalagents_create_group_V7 - perms */;
            return _toStringExtrinsicPermissions(
                &m->basic.externalagents_create_group_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11009: /* module 43 call 1 */
        ...
        case 1: /* externalagents_set_group_permissions_V7 - id */;
            return _toStringAGId(
                &m->basic.externalagents_set_group_permissions_V7.id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* externalagents_set_group_permissions_V7 - perms */;
            return _toStringExtrinsicPermissions(
                &m->basic.externalagents_set_group_permissions_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11010: /* module 43 call 2 */
        ...
        case 1: /* externalagents_remove_agent_V7 - agent */;
            return _toStringIdentityId(
                &m->basic.externalagents_remove_agent_V7.agent,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11012: /* module 43 call 4 */
        ...
        case 1: /* externalagents_change_group_V7 - agent */;
            return _toStringIdentityId(
                &m->basic.externalagents_change_group_V7.agent,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* externalagents_change_group_V7 - group */;
            return _toStringAgentGroup(
                &m->basic.externalagents_change_group_V7.group,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11013: /* module 43 call 5 */
        ...
        case 0: /* externalagents_accept_become_agent_V7 - auth_id */;
            return _toStringu64(
                &m->basic.externalagents_accept_become_agent_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11014: /* module 43 call 6 */
        ...
        case 1: /* externalagents_create_group_and_add_auth_V7 - perms */;
            return _toStringExtrinsicPermissions(
                &m->basic.externalagents_create_group_and_add_auth_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* externalagents_create_group_and_add_auth_V7 - target */;
            return _toStringIdentityId(
                &m->basic.externalagents_create_group_and_add_auth_V7.target,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* externalagents_create_group_and_add_auth_V7 - expiry */;
            return _toStringOptionMoment(
                &m->basic.externalagents_create_group_and_add_auth_V7.expiry,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11015: /* module 43 call 7 */
        ...
        case 1: /* externalagents_create_and_change_custom_group_V7 - perms */;
            return _toStringExtrinsicPermissions(
                &m->basic.externalagents_create_and_change_custom_group_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* externalagents_create_and_change_custom_group_V7 - agent */;
            return _toStringIdentityId(
                &m->basic.externalagents_create_and_change_custom_group_V7.agent,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11264: /* module 44 call 0 */
        ...
        case 0: /* relayer_set_paying_key_V7 - user_key */;
            return _toStringAccountId(
                &m->basic.relayer_set_paying_key_V7.user_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* relayer_set_paying_key_V7 - polyx_limit */;
            return _toStringBalance(
                &m->basic.relayer_set_paying_key_V7.polyx_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11265: /* module 44 call 1 */
        ...
        case 0: /* relayer_accept_paying_key_V7 - auth_id */;
            return _toStringu64(
                &m->basic.relayer_accept_paying_key_V7.auth_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11266: /* module 44 call 2 */
        ...
        case 0: /* relayer_remove_paying_key_V7 - user_key */;
            return _toStringAccountId(
                &m->basic.relayer_remove_paying_key_V7.user_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* relayer_remove_paying_key_V7 - paying_key */;
            return _toStringAccountId(
                &m->basic.relayer_remove_paying_key_V7.paying_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11267: /* module 44 call 3 */
        ...
        case 0: /* relayer_update_polyx_limit_V7 - user_key */;
            return _toStringAccountId(
                &m->basic.relayer_update_polyx_limit_V7.user_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* relayer_update_polyx_limit_V7 - polyx_limit */;
            return _toStringBalance(
                &m->basic.relayer_update_polyx_limit_V7.polyx_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11268: /* module 44 call 4 */
        ...
        case 0: /* relayer_increase_polyx_limit_V7 - user_key */;
            return _toStringAccountId(
                &m->basic.relayer_increase_polyx_limit_V7.user_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* relayer_increase_polyx_limit_V7 - amount */;
            return _toStringBalance(
                &m->basic.relayer_increase_polyx_limit_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11269: /* module 44 call 5 */
        ...
        case 0: /* relayer_decrease_polyx_limit_V7 - user_key */;
            return _toStringAccountId(
                &m->basic.relayer_decrease_polyx_limit_V7.user_key,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* relayer_decrease_polyx_limit_V7 - amount */;
            return _toStringBalance(
                &m->basic.relayer_decrease_polyx_limit_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11776: /* module 46 call 0 */
        ...
        case 0: /* contracts_call_old_weight_V7 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.contracts_call_old_weight_V7.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_call_old_weight_V7 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_call_old_weight_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_call_old_weight_V7 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_call_old_weight_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_call_old_weight_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_call_old_weight_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_call_old_weight_V7 - data */;
            return _toStringBytes(
                &m->basic.contracts_call_old_weight_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11777: /* module 46 call 1 */
        ...
        case 0: /* contracts_instantiate_with_code_old_weight_V7 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_with_code_old_weight_V7 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_with_code_old_weight_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_with_code_old_weight_V7 - code */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_with_code_old_weight_V7 - data */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_with_code_old_weight_V7 - salt */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_old_weight_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11778: /* module 46 call 2 */
        ...
        case 0: /* contracts_instantiate_old_weight_V7 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_old_weight_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_old_weight_V7 - gas_limit */;
            return _toStringCompactu64(
                &m->basic.contracts_instantiate_old_weight_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_old_weight_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_old_weight_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_old_weight_V7 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_instantiate_old_weight_V7.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_old_weight_V7 - data */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_old_weight_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_old_weight_V7 - salt */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_old_weight_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11779: /* module 46 call 3 */
        ...
        case 0: /* contracts_upload_code_V7 - code */;
            return _toStringBytes(
                &m->basic.contracts_upload_code_V7.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_upload_code_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_upload_code_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_upload_code_V7 - determinism */;
            return _toStringDeterminism(
                &m->basic.contracts_upload_code_V7.determinism,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11780: /* module 46 call 4 */
        ...
        case 0: /* contracts_remove_code_V7 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_remove_code_V7.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11781: /* module 46 call 5 */
        ...
        case 0: /* contracts_set_code_V7 - dest */;
            return _toStringAccountIdLookupOfT(
                &m->basic.contracts_set_code_V7.dest,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_set_code_V7 - code_hash */;
            return _toStringCodeHash(
                &m->basic.contracts_set_code_V7.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11782: /* module 46 call 6 */
        ...
        case 1: /* contracts_call_V7 - amount */;
            return _toStringCompactBalance(
                &m->nested.contracts_call_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
    ...
    case 11783: /* module 46 call 7 */
        ...
        case 0: /* contracts_instantiate_with_code_V7 - amount */;
            return _toStringCompactBalance(
                &m->basic.contracts_instantiate_with_code_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* contracts_instantiate_with_code_V7 - gas_limit */;
            return _toStringWeight(
                &m->basic.contracts_instantiate_with_code_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* contracts_instantiate_with_code_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->basic.contracts_instantiate_with_code_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* contracts_instantiate_with_code_V7 - code */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_V7.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* contracts_instantiate_with_code_V7 - data */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* contracts_instantiate_with_code_V7 - salt */;
            return _toStringBytes(
                &m->basic.contracts_instantiate_with_code_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 11784: /* module 46 call 8 */
        ...
        case 0: /* contracts_instantiate_V7 - amount */;
            return _toStringCompactBalance(
                &m->nested.contracts_instantiate_V7.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 2: /* contracts_instantiate_V7 - storage_deposit_limit */;
            return _toStringOptionCompactBalanceOf(
                &m->nested.contracts_instantiate_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        ...
        case 5: /* contracts_instantiate_V7 - salt */;
            return _toStringBytes(
                &m->nested.contracts_instantiate_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12032: /* module 47 call 0 */
        ...
        case 0: /* polymeshcontracts_instantiate_with_code_perms_V7 - endowment */;
            return _toStringBalance(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.endowment,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcontracts_instantiate_with_code_perms_V7 - gas_limit */;
            return _toStringWeight(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polymeshcontracts_instantiate_with_code_perms_V7 - storage_deposit_limit */;
            return _toStringOptionBalance(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polymeshcontracts_instantiate_with_code_perms_V7 - code */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* polymeshcontracts_instantiate_with_code_perms_V7 - data */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* polymeshcontracts_instantiate_with_code_perms_V7 - salt */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* polymeshcontracts_instantiate_with_code_perms_V7 - perms */;
            return _toStringPermissions(
                &m->basic.polymeshcontracts_instantiate_with_code_perms_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12033: /* module 47 call 1 */
        ...
        case 0: /* polymeshcontracts_instantiate_with_hash_perms_V7 - endowment */;
            return _toStringBalance(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.endowment,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcontracts_instantiate_with_hash_perms_V7 - gas_limit */;
            return _toStringWeight(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polymeshcontracts_instantiate_with_hash_perms_V7 - storage_deposit_limit */;
            return _toStringOptionBalance(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polymeshcontracts_instantiate_with_hash_perms_V7 - code_hash */;
            return _toStringCodeHash(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* polymeshcontracts_instantiate_with_hash_perms_V7 - data */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* polymeshcontracts_instantiate_with_hash_perms_V7 - salt */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 6: /* polymeshcontracts_instantiate_with_hash_perms_V7 - perms */;
            return _toStringPermissions(
                &m->basic.polymeshcontracts_instantiate_with_hash_perms_V7.perms,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12034: /* module 47 call 2 */
        ...
        case 0: /* polymeshcontracts_update_call_runtime_whitelist_V7 - updates */;
            return _toStringVecTupleExtrinsicIdbool(
                &m->basic.polymeshcontracts_update_call_runtime_whitelist_V7.updates,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12035: /* module 47 call 3 */
        ...
        case 0: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - endowment */;
            return _toStringBalance(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.endowment,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - gas_limit */;
            return _toStringWeight(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - storage_deposit_limit */;
            return _toStringOptionBalance(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - code */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.code,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - data */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* polymeshcontracts_instantiate_with_code_as_primary_key_V7 - salt */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_code_as_primary_key_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12036: /* module 47 call 4 */
        ...
        case 0: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - endowment */;
            return _toStringBalance(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.endowment,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - gas_limit */;
            return _toStringWeight(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.gas_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - storage_deposit_limit */;
            return _toStringOptionBalance(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.storage_deposit_limit,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - code_hash */;
            return _toStringCodeHash(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.code_hash,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 4: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - data */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.data,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 5: /* polymeshcontracts_instantiate_with_hash_as_primary_key_V7 - salt */;
            return _toStringVecu8(
                &m->basic.polymeshcontracts_instantiate_with_hash_as_primary_key_V7.salt,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12037: /* module 47 call 5 */
        ...
        case 0: /* polymeshcontracts_upgrade_api_V7 - api */;
            return _toStringApi(
                &m->basic.polymeshcontracts_upgrade_api_V7.api,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* polymeshcontracts_upgrade_api_V7 - next_upgrade */;
            return _toStringNextUpgradeT(
                &m->basic.polymeshcontracts_upgrade_api_V7.next_upgrade,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12544: /* module 49 call 0 */
        ...
        case 1: /* nft_create_nft_collection_V7 - nft_type */;
            return _toStringOptionNonFungibleType(
                &m->basic.nft_create_nft_collection_V7.nft_type,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nft_create_nft_collection_V7 - collection_keys */;
            return _toStringVecAssetMetadataKey(
                &m->basic.nft_create_nft_collection_V7.collection_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12545: /* module 49 call 1 */
        ...
        case 1: /* nft_issue_nft_V7 - nft_metadata_attributes */;
            return _toStringVecNFTMetadataAttribute(
                &m->basic.nft_issue_nft_V7.nft_metadata_attributes,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nft_issue_nft_V7 - portfolio_kind */;
            return _toStringPortfolioKind(
                &m->basic.nft_issue_nft_V7.portfolio_kind,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 12546: /* module 49 call 2 */
        ...
        case 1: /* nft_redeem_nft_V7 - nft_id */;
            return _toStringNFTId(
                &m->basic.nft_redeem_nft_V7.nft_id,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 2: /* nft_redeem_nft_V7 - portfolio_kind */;
            return _toStringPortfolioKind(
                &m->basic.nft_redeem_nft_V7.portfolio_kind,
                outValue, outValueLen,
                pageIdx, pageCount);
        case 3: /* nft_redeem_nft_V7 - number_of_keys */;
            return _toStringOptionu8(
                &m->basic.nft_redeem_nft_V7.number_of_keys,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
