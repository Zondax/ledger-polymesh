...
#define PD_CALL_IDENTITY_REGISTER_CUSTOM_CLAIM_TYPE_V3 25
typedef struct {
    pd_Vecu8_t ty;
} pd_identity_register_custom_claim_type_V3_t;
...
#define PD_CALL_ASSET_REDEEM_FROM_PORTFOLIO_V3 24
typedef struct {
    pd_Ticker_t ticker;
    pd_BalanceNoSymbol_t amount;
    pd_PortfolioKind_t portfolio;
} pd_asset_redeem_from_portfolio_V3_t;
...
#define PD_CALL_SETTLEMENT_UPDATE_VENUE_SIGNERS_V3 17
typedef struct {
    pd_VenueId_t id;
    pd_VecAccountId_t signers;
    pd_bool_t add_signers;
} pd_settlement_update_venue_signers_V3_t;

#define PD_CALL_SETTLEMENT_ADD_INSTRUCTION_WITH_MEMO_V3 18
typedef struct {
    ...
    pd_VecLeg_t legs;
    pd_OptionInstructionMemo_t instruction_memo;
} pd_settlement_add_instruction_with_memo_V3_t;

#define PD_CALL_SETTLEMENT_ADD_AND_AFFIRM_INSTRUCTION_WITH_MEMO_V3 19
typedef struct {
    pd_VenueId_t venue_id;
    pd_SettlementTypeBlockNumber_t settlement_type;
    pd_OptionMoment_t trade_date;
    ...
    pd_OptionInstructionMemo_t instruction_memo;
} pd_settlement_add_and_affirm_instruction_with_memo_V3_t;
...
typedef union {
    ...
    pd_identity_register_custom_claim_type_V3_t identity_register_custom_claim_type_V3;
    ...
    pd_asset_redeem_from_portfolio_V3_t asset_redeem_from_portfolio_V3;
    ...
    pd_settlement_update_venue_signers_V3_t settlement_update_venue_signers_V3;
    pd_settlement_add_instruction_with_memo_V3_t settlement_add_instruction_with_memo_V3;
    pd_settlement_add_and_affirm_instruction_with_memo_V3_t settlement_add_and_affirm_instruction_with_memo_V3;
...
typedef struct {
    ...
    pd_TickerRegistrationConfigMoment_t config;
