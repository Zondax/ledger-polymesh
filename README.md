...
This project contains the Polymath app (https://polymath.network/) for Ledger Nano S and X.
...
Download a release from here (https://github.com/Zondax/ledger-polymath/releases). You only need `zxtool.sh`
