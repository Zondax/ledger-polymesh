...
INSTANTIATE_TEST_SUITE_P
    ...
    (CompactPrintTestcases, CompactPrintTests,
     ::testing::ValuesIn({
         // number of decimals, input, expected
         testcase_bytesPrint_t{0, "0b00204aa9d101", "2000000000000"},
         testcase_bytesPrint_t{0, "57d20a3fce96f1cf8c9cb4378c37a4873f17621ebce404f5aa13",
                               "123456789012345678901234567890123456789012345678901234567890"},
         testcase_bytesPrint_t{12, "04", "0.000000000001"},
         testcase_bytesPrint_t{1, "04", "0.1"},
         testcase_bytesPrint_t{1, "28", "1.0"},
         testcase_bytesPrint_t{2, "28", "0.10"},
         testcase_bytesPrint_t{0, "28", "10"},
         testcase_bytesPrint_t{12, "02890700", "0.000000123456"},
         testcase_bytesPrint_t{12, "131581e97df4102211", "1234567.890123456789"},
     }));
